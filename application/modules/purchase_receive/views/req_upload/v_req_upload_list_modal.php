...
<?php
    $dynamicColumns = '[{"data": null},{"data": "upload_no"},{"data": "manual_no"},{"data": "fiscalyear"},{"data": "valid_datebs"},{"data": "upload_datebs" }]';
    $columnsize = '5';
?>  
                ...
                <table class="table table-striped dt_alt dataTable serverDatatable" id="myitemListTable" tabindex="1" data-tableid="#myitemListTable" data-type="<?php echo $this->input->post('type');?>">
                    <thead>
                        <tr>
                            ...
                            <th width="10%"><?php echo $this->lang->line('upload_no'); ?></th>
...
<div class="white-box pad-5" id="detailListBox">
    <?php $this->load->view('req_upload/v_req_upload_detail_modal');?>
</div> 
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        // var fiscalyear = '<?php echo $fiscal_yrs; ?>';
        ...
        var dataurl = base_url+"purchase_receive/req_upload/get_req_upload_list_for_modal";
