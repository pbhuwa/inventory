...
<div class="row wb_form">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title"><?php echo $this->lang->line('mrn_book'); ?></h3>
...
<!--                     <div class="self-tabs">
    <ul class="nav nav-tabs form-tabs">
        <li class="tab-selector <?php if($mrn_type=='all') echo 'active';?>"><a href="<?php echo base_url('purchase_receive/mrn_book'); ?>" <?php if($mrn_type=='all') echo' aria-expanded="true"';?>" ><?php echo $this->lang->line('mrn_details'); ?></a></li>
         <li class="tab-selector <?php if($mrn_type=='supplierwise') echo 'active';?>"><a href="<?php echo base_url('purchase_receive/mrn_book/supplierwise_mrn'); ?>"><?php echo $this->lang->line('supplier_summary'); ?></a></li>
    </ul>
</div> -->
</div>
</div>
<div class="ov_report_tabs page-tabs margin-top-40 pad-5 tabbable">
     <?php if($mrn_type=='all'): ?>      
<div id="dtl_rpt" class="tab-pane fade in  <?php if($mrn_type=='all') echo "active"; ?>">
            <div  id="FormDiv_mrnbook" class="formdiv frm_bdy">
                <?php $this->load->view('mrn_book/v_mrn_book_list');?>
            </div>
</div>
<?php endif; ?>
     <?php if($mrn_type=='supplierwise'): ?>         
<div id="dtl_supplier" class="tab-pane fade in <?php if($mrn_type=='supplierwise') echo "active"; ?>">
