...
<div class="searchWrapper">
 ...
 -->
    ...
    <div class="pull-right" style="margin-top:15px;">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="purchase_receive/mrn_book/mrn_book_list_supplier" data-location="purchase_receive/mrn_book/exportToExcelSupplierwise" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="purchase_receive/mrn_book_list_supplier/mrn_book_list_supplier_list" data-location="purchase_receive/mrn_book/generateSupplierwisePdf" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
...
<script type="text/javascript">
  $(document).ready(function(){
    var dataurl = base_url+"purchase_receive/mrn_book/mrn_book_list_supplier";
