<div class="searchWrapper">
    ...
    <div class="pull-right" style="margin-top:15px;">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="purchase_receive/purchase_return/get_purchase_return_item_detail_list" data-location="purchase_receive/purchase_return/exportToExcelsDetails" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="purchase_receive/purchase_return/get_purchase_return_item_detail_list" data-location="purchase_receive/purchase_return/generate_pdfsDetails" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
    <div class="clear"></div>
</div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataurl = base_url + "purchase_receive/purchase_return/get_purchase_return_item_detail_list";
        var message = '';
