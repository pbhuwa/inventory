...
<div class="searchWrapper">
            ...
            <div class="row">
                <div class="col-xs-12 ">
                    ...
                    <div class="col-md-2">
                        ...
                        <select  class="form-control required_field" id="dateSearch">
                    ...
                    <div class="white-box pad-5">
                        <ul class="index_chart xx">
                            <li>
                                ...
                                <a href="javascript:void(0)" data-approvedtype='pending' class="approvetype"><?php echo $this->lang->line('pending'); ?></a> 
                                <span id="pending"><?php echo !empty($status_count[0]->pending)?$status_count[0]->pending:'';?></span>
                            </li>
                            <li>
                                <div class="approved"></div>
                                <a href="javascript:void(0)" data-approvedtype='approved' class="approvetype" ><?php echo $this->lang->line('approved'); ?> </a>
                                <span id="approved"><?php echo !empty($status_count[0]->approved)?$status_count[0]->approved:'';?></span>
                            </li>
                            <li>
                                <div class="n_approved"></div>
                                <a href="javascript:void(0)" data-approvedtype='finalapproved' class="approvetype"><?php echo $this->lang->line('verified'); ?> </a>
                                <span id="unapproved"><?php echo !empty($status_count[0]->unapproved)?$status_count[0]->unapproved:'';?></span>
                            </li>
                            <li>
                                <div class="cancel"></div>
                                <a href="javascript:void(0)" data-approvedtype='rejected' class="approvetype"><?php echo $this->lang->line('rejected'); ?> </a>
                                <span id="cancel"><?php echo !empty($status_count[0]->rejected)?$status_count[0]->rejected:'';?></span>
                            </li>
                            <li>
                                <div class="expired"></div>
                                <a href="javascript:void(0)" data-approvedtype='expired' class="approvetype"><?php echo $this->lang->line('expired'); ?> </a>
                                <span id="expired"><?php echo !empty($status_count[0]->expired)?$status_count[0]->expired:'';?></span>
                            </li>
    ...
    <div class="pull-right" style="position: relative;top: -34px;">
    ...
    <div class="table-responsive">
        <table id="myTable" class="table table-striped ">
            <thead>
                ...
                <th width="13%"><?php echo $this->lang->line('item_name'); ?></th>
