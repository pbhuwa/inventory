<style>
    ...
    .purchaserecive-table tr th {
        border-bottom: 1px solid #ddd;
        padding: 4px;
    }

    .purchaserecive-table tr td {
        border-bottom: 1px solid #ddd;
        padding: 4px;
    }

    .purchaserecive-table tr:last-child td {
        border-bottom: 0px;
    }

    .jo_table tr.total-amount td {
        border-bottom: 0px !important;
    }

    .jo_table tr.total-amount td:last-child {
        border-left: 0px;
    }

    .jo_table tr.total-amount td:nth-child(2) {
        border: 0px;
    }
                    ...
                    <td style="padding: 10px;">
                        ...
                        <span class="bb">
                            ...
                            if ($req_detail_list) {
                                ...
                                $supname = $this->general->get_tbl_data('*', 'dist_distributors', array('dist_distributorid' => $supid), 'dist_distributor', 'ASC');
                                echo  !empty($supname[0]->dist_distributor) ? $supname[0]->dist_distributor : '';
                            }
                            ?> 
                        </span> को बिल न. 
                        <span class="bb">
