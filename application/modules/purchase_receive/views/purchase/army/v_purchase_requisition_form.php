...
<form method="post" id="FormpPurchaseRequisition" action="<?php echo base_url('purchase_receive/purchase_requisition/save_requisition'); ?>" data-reloadurl='<?php echo base_url('purchase_receive/purchase_requisition/index/reload'); ?>' data-refresh="<?php echo base_url('purchase_receive/purchase_requisition/form_purchase_requisition'); ?>" class="form-material form-horizontal form" >
    ...
    <?php $reqmasterid=!empty($reqmasterid)?$reqmasterid:''; ?>
    <input type="hidden" name="pure_reqmasterid" value="<?php echo !empty($requisition_approved[0]->pure_reqmasterid)?$requisition_approved[0]->pure_reqmasterid:$reqmasterid; ?>" id="pure_reqmasterid">
    <div class="form-group">
     <div class="col-md-3 col-sm-4">
        <label for="example-text"><?php echo $this->lang->line('fiscal_year'); ?><span class="required">*</span> :</label>
       <select name="sama_fyear" class="form-control required_field" id="fyear1">
           <?php
             if($fiscal_year): 
      ...
      <div class="col-md-3">
                <label for="example-text">Choose Material Type   : </label><br>
                 <?php
                    ...
                    $rema_mattype = !empty($pure_reqdatebs[0]->pure_mattypeid)?$pure_reqdatebs[0]->pure_mattypeid:1;   
                    if(!empty($default_material_typeid)){
                        $rema_mattype=$default_material_typeid;
                    }
    ...
    <div class="col-md-3 col-sm-4">
        ...
        <div class="dis_tab">
            <input type="text" class="form-control number enterinput" name="pure_streqno"  value="<?php echo !empty($req_num_from_dmd)?$req_num_from_dmd:''; ?>" placeholder="Enter Req No." id="req_no" data-targetbtn="SrchReq">
    ...
    <div class="form-group">
        <div class="col-md-3 col-sm-4">
            ...
            <input type="text" name="rema_reqdatead" class="form-control <?php echo DATEPICKER_CLASS; ?> date"  placeholder="Service Start Date" value="<?php echo !empty($requisition_approved[0]->pure_reqdatebs)?$requisition_approved[0]->pure_reqdatebs:DISPLAY_DATE; ?>" id="requisition_date">
            <span class="errmsg"></span>
        </div>
        
        <div class="col-md-3 col-sm-4">
            <?php $reqby=!empty($requisition_approved[0]->pure_requser)?$requisition_approved[0]->pure_requser:''; ?>
            <label for="example-text"><?php echo $this->lang->line('requested_by'); ?> <span class="required">*</span>:</label>
            <input type="text" class="form-control required_field" name="rema_reqby" value="<?php echo !empty($reqby)?$reqby:$current_user; ?>" placeholder="Enter Requested By ">
        </div>
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <input type="text" class="form-control required_field" name="rema_reqno"  value="<?php echo $reqno; ?>" id="rema_reqno" placeholder="Enter Requisition Number" readonly>
        </div>
  
    
    <div class="col-md-3 col-sm-4">
        <?php $pure_fyear = !empty($requisition_approved[0]->pure_fyear)?$requisition_approved[0]->pure_fyear:CUR_FISCALYEAR; ?>
        <label for="example-text"><?php echo $this->lang->line('fiscal_year'); ?><span class="required">*</span> :</label>
       <!--  <input type="text" class="form-control" name="pure_fyear" id="fiscal_year" value="<?php echo $pure_fyear; ?>" placeholder="Fiscal Year" > -->
       <select name="pure_fyear" class="form-control required_field" id="fyear">
           <?php
             if($fiscal_year): 
             foreach ($fiscal_year as $kf => $fyrs):
             ?>
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <?php $requested_to=!empty($requisition_approved[0]->pure_requestto)?$requisition_approved[0]->pure_requestto:''; ?>
            <input type="text" class="form-control" name="requested_to"  value="<?php echo !empty($requested_to)?$requested_to:PURCHASE_REQUESTED_TO; ?>" placeholder="Requested To " >
        </div>
     
      <div class="col-md-3 col-sm-4">
        <label>&nbsp;</label>
        <div id="view_req" style="margin-top: 5px;">
            <?php if(!empty($reqmasterid)): ?>
            <a href="javascript:void(0)" data-id="<?php echo $reqmasterid; ?>" data-displaydiv="orderDetails" data-viewurl="<?php echo base_url() ?>issue_consumption/stock_requisition/stock_requisition_views_details" title="View" class="view " data-heading="View Demand Detail">View Demand</a>
        <?php endif; ?>
                    ...
                    <tr class="orderrow" id="orderrow_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>">
                        ...
                        <td>
                            <div class="dis_tab"> 
                                ...
                                <a href="javascript:void(0)" class="btnitem btn btn-sm btn-default table-cell width_30 view" data-heading='Item List' data-viewurl='<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>' data-id='<?php echo $key+1; ?>' id="view_<?php echo $key+1; ?>" data-storeid=
                                    '<?php echo $storeid; ?>'><strong>...</strong></a>
                                    &nbsp
                        ...
                        <td>  
                            ...
                            ?> 
                            <input type="text" class="form-control itemname" id="itemname_<?php echo $key+1; ?>" name="itemname[]" value="<?php echo htmlspecialchars($req_itemname, ENT_QUOTES); ?>"  data-id='<?php echo $key+1; ?>' placeholder="Item name">
                        </td>
                        <td> 
                            <input type="text" class="form-control float stock" name="stock[]"   id="stock_<?php echo $key+1; ?>" value="<?php echo sprintf('%g',$reqv->purd_stock); ?>" data-id='<?php echo $key+1; ?>' placeholder="Stock Qty." readonly="true"> 
                        </td>
                        <td> 
                        ...
                        <td> 
                                <input type="text" class="form-control required_field float rede_qty calculateamt rede_qty" name="rede_qty[]"  value="<?php echo sprintf('%g',$reqv->purd_qty); ?>"  id="rede_qty_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>' placeholder="Qty."> 
                        </td>
                        <td> 
                    ...
                    <tr class="orderrow" id="orderrow_<?php echo $z; ?>" data-id='<?php echo $z; ?>'>
                        ...
                        <td>
                            <div class="dis_tab"> 
                                ...
                                <a href="javascript:void(0)" class="btnitem btn btn-sm btn-default table-cell width_30 view" data-heading='Item List' data-viewurl='<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>' data-id='<?php echo $z; ?>' id="view_<?php echo $z; ?>" data-storeid='<?php echo $storeid; ?>'><strong>...</strong></a>
                                &nbsp
                                <a href="javascript:void(0)" class="btn btn-sm btn-default table-cell width_30 view" data-heading='Item Entry' data-viewurl='<?php echo base_url('stock_inventory/item/item_entry/modal'); ?>' data-id='<?php echo $z; ?>' id="view_<?php echo $z; ?>" data-storeid='<?php echo $storeid; ?>' >+</a>
                            </div>
                        </td>
                        <td>  
                            <input type="text" class="form-control required_field itemname" id="itemname_<?php echo $z; ?>" name="itemname[]"  data-id='<?php echo $z; ?>' placeholder="Item name" value="<?php echo htmlspecialchars($plist->itli_itemname, ENT_QUOTES); ?>">
                          
                        </td>
                        <td> 
                            <input type="text" class="form-control float stock" name="stock[]"   id="stock_<?php echo $z; ?>" data-id='<?php echo $z; ?>'  value="<?php echo !empty($plist->cur_stock_qty)? sprintf('%g',$plist->cur_stock_qty):'0'; ?>" placeholder="Stock Qty." readonly="true"> 
                        </td>
                        <td> 
                        ...
                        <td> 
                                <input type="text" class="form-control required_field float rede_qty calculateamt rede_qty" name="rede_qty[]"   id="rede_qty_<?php echo $z; ?>" data-id='<?php echo $z; ?>' placeholder="Qty." value="<?php echo  sprintf('%g',$plist->rede_remqty); ;?>"> 
                        </td>
                        <td> 
                    ...
                    <tr class="orderrow" id="orderrow_1" data-id='1'>
                        ...
                        <td>
                            <div class="dis_tab"> 
                                ...
                                <a href="javascript:void(0)" class="btnitem btn btn-sm btn-default table-cell width_30 view" data-heading='Item List' data-viewurl='<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>' data-id='1' id="view_1" data-storeid='<?php echo $storeid; ?>' data-type="1"><strong>...</strong></a>
                                &nbsp
                        ...
                        <td> 
                            <input type="text" class="form-control float stock" name="stock[]"   id="stock_1" data-id='1' placeholder="Stock Qty." readonly="true"> 
                        </td>
                        <td> 
...
$(document).ready(function(e){
    ...
    $('#reqload').attr('data-id',matType);
     $('#reqload').data('id',matType);
})
            ...
            $.ajax({
                ...
                success: function(jsons){
                    ...
                    if(main_form == 'main_form'){
                        ...
                        if(data.status == 'success'){
                            $(displaydiv).empty().html(data.tempform);
                            $('#pure_reqmasterid').val(req_masterid);
                            $('#view_req').html('<a href="javascript:void(0)" data-id="'+req_masterid+'" data-displaydiv="orderDetails" data-viewurl="'+base_url+'issue_consumption/stock_requisition/stock_requisition_views_details" title="View" class="view " data-heading="View Demand Detail">View Demand</a>')
                        }
...
function ajax_search_requistion()
{
    ...
    var fyear=$('#fyear1').val();
    var mattypeid=$('#mattypeid').val();
    var submitdata = {req_no:req_no,fyear:fyear,mattypeid:mattypeid};
    ...
    function onSuccess(jsons){
        ...
        if(data.status=='success')
        {
            ...
            $('#pure_reqmasterid').val(data.masterid);
            ...
            $('#view_req').html('<a href="javascript:void(0)" data-id="'+data.masterid+'" data-displaydiv="orderDetails" data-viewurl="'+base_url+'issue_consumption/stock_requisition/stock_requisition_views_details" title="View" class="view " data-heading="View Demand Detail">View Demand</a>')
        } 
        else{
            alert(data.message);
             $('#orderBody').html('');
...
<script>
    ...
    $(document).off('change','#fyear1');
    $(document).on('change','#fyear1',function(e){
        var cur_fyrs=$('#fyear1').val();
        $('#fyear').val(cur_fyrs);
        $('#fyear').change();
    });
...
<script type="text/javascript">
      $(document).off('change','.chooseMatType,#fyear');
        $(document).on('change','.chooseMatType,#fyear',function(){
        var matType = $('.chooseMatType').val();
        var fyear=$('#fyear').val();
        var reqmasterid=$('#pure_reqmasterid').val();
          var orderlen=$('.orderrow').length;
          // alert(orderlen);
          // return false;
         var itemid      =$('#itemid_1').val();
        if(orderlen >= 1 && itemid){
            
              var trplusOne=1;
            template='<tr class="orderrow" id="orderrow_'+trplusOne+'" data-id="'+trplusOne+'"><td><input type="text" class="form-control sno" id="s_no_'+trplusOne+'" value="'+trplusOne+'" readonly/></td><td><div class="dis_tab"><input type="text" class="form-control itemcode enterinput " id="itemcode_'+trplusOne+'" name="rede_code[]" data-id="'+trplusOne+'" data-targetbtn="view" placeholder="Item Code"><input type="hidden" class="rede_itemsid" name="rede_itemsid[]" data-id="'+trplusOne+'" value="" id="itemid_'+trplusOne+'"><input type="hidden" class="itemsid" name="quotationmasterid[]" data-id="'+trplusOne+'" value="" id="quotationmasterid_'+trplusOne+'"><input type="hidden" class="controlno" name="controlno[]" data-id="'+trplusOne+'" value="" id="controlno_'+trplusOne+'"><a href="javascript:void(0)" class="btnitem btn btn-sm btn-default table-cell width_30 view" data-heading="Item List" data-viewurl="<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>" data-storeid='+storeid+' data-id="'+trplusOne+'" id="view_'+trplusOne+'"><strong>...</strong></a>&nbsp<a href="javascript:void(0)" class="btn btn-sm btn-default table-cell width_30 view" data-heading="Item Entry" data-viewurl="<?php echo base_url('stock_inventory/item/item_entry/modal'); ?>" data-storeid='+storeid+' data-id="'+trplusOne+'" id="view_'+trplusOne+'">+</a></div></td><td><input type="text" class="form-control itemname" id="itemname_'+trplusOne+'" name="itemname[]" data-id="'+trplusOne+'" placeholder="Item name"></td><td> <input type="text" class="form-control float stock" name="stock[]" id="stock_'+trplusOne+'" data-id="'+trplusOne+'" placeholder="Stock Qty." readonly></td><td><input type="text" class="form-control float rede_unit calculateamt rede_unit" name="rede_unit[]" id="rede_unit_'+trplusOne+'" data-id="'+trplusOne+'" placeholder="Unit" ></td><td><input type="text" class="form-control required_field  float rede_qty calculateamt" name="rede_qty[]" id="rede_qty_'+trplusOne+'" data-id="'+trplusOne+'" placeholder="Qty."></td><td><input type="text" class="form-control  rede_remarks jump_to_add" id="rede_remarks'+trplusOne+'" name="rede_remarks[]"  data-id="'+trplusOne+'" placeholder="Enter Remarks"> </td> <td><input type="text" name="required_date[]" class="form-control nepali <?php echo DATEPICKER_CLASS; ?> date required_date"  placeholder="Required Date" id="Required_date_'+trplusOne+'" data-id="'+trplusOne+'" autocomplete="off" /></td><td><div class="actionDiv"></td></tr>';
                $('#orderBody').html(template);
          }
        ...
        var submiturl = base_url+'purchase_receive/purchase_requisition/get_purchase_req_no_by_mat_type';
        ajaxPostSubmit(submiturl,submitdata,beforeSend,onSuccess);
        function beforeSend(){
                    // $('.overlay').modal('show');
