    ...
    <div id="orderData">
        ...
        <div class="form-group"> -->
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <?php 
                // echo "<pre>";
                // print_r($purchased_data);
                // die();
                $db_budget_headid=!empty($purchased_data[0]->recm_budgetid) ? $purchased_data[0]->recm_budgetid:0;
                ?><input type="hidden" id="db_budget_headid" value="<?php echo $db_budget_headid ?>">
                <select class="table-cell form-control required_field select2 " name="bugetid" id="budgetid">
                    ...
                    ?>
                            <option value="<?php echo $buget->budg_budgetid; ?>" <?php if($db_budget_headid== $buget->budg_budgetid) echo "selected=selected"; ?>><?php echo $buget->budg_budgetname; ?></option>
                    <?php
                        endforeach;
                    endif;
                    ?>
            ...
            <div class="col-sm-3 col-md-3 departmentdiv" style="display:none">
                <label>Department</label>
                <select name="recm_departmentid" id="rema_reqfromdepid" class="form-control">
                    <option value="">---select---</option>
                    <?php
                    if ($department) :
                ...
                <tbody id="purchaseDataBody">
                    ...
                    ?>
                            <tr class="orderrow" id="orderrow_<?php echo $key + 1; ?>" data-id='<?php echo $key + 1; ?>'>
                                ...
                                <td><input type="text" class="form-control float calamt arrow_keypress" name="puit_qty[]" value="<?php echo !empty($pd->recd_purchasedqty) ? sprintf('%g',$pd->recd_purchasedqty) : '0'; ?>" data-fieldid='puit_qty' data-id='<?php echo $key + 1; ?>' id="puit_qty_<?php echo $key + 1; ?>" placeholder="Qty">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="text" class="form-control vat float calamt idfornot arrow_keypress" data-fieldid="vat" name="vat[]" id="vat_<?php echo $key + 1; ?>" value="<?php echo !empty($pd->recd_vatpc) ? sprintf('%g',$pd->recd_vatpc) : '0'; ?> " data-id='<?php echo $key + 1; ?>' placeholder="Vat">
                                ...
                                <td>
                                   <a href="javascript:void(0)" class="btn btn-danger btnRemove" data-id="<?php echo $key + 1; ?>" id="addRequistion_<?php echo $key + 1; ?>"><span class="btnChange" id="btnChange_<?php echo $key + 1; ?>"><i class="fa fa-trash-o" aria-hidden="true"></i></span></a> <div class="actionDiv"></div></td>
...
<?php if(!empty($purchased_data)): ?>
<script type="text/javascript">
     $('.calamt').change();
       setTimeout(function() {
         var db_bheadid= $('#db_budget_headid').val();
            $("#budgetid").select2("val", db_bheadid);
        }, 1000);
