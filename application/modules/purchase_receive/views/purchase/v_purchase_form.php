...
<form method="post" id="FormDirectReceive" action="<?php echo base_url('purchase_receive/direct_receive/save_direct'); ?>" class="form-material form-horizontal form" >
    <input type="hidden" name="id" value="<?php //echo!empty($item_data[0]->itli_itemlistid)?$item_data[0]->itli_itemlistid:'';  ?>">
        <div class="form-group">
            <div class="col-md-3 col-sm-4">
                ...
                <label for="example-text"><?php echo $this->lang->line('receive_no'); ?> :<span class="required">*</span>:</label>
                <input type="text" class="form-control" name=""  value="<?php echo $reqno; ?>" readonly="true" disabled>
            </div>
            <div class="col-md-3 col-sm-4">
                <label for="example-text"><?php echo $this->lang->line('manual'); ?> :<span class="required">*</span>:</label>
                <input type="text" class="form-control" name=""  value="" readonly="true" disabled>
            </div>
            <div class="col-md-3 col-sm-4">
              <label for="example-text"><?php echo $this->lang->line('date'); ?> : </label>
              <input type="text" name="trma_transactiondatead" class="form-control <?php echo DATEPICKER_CLASS; ?> date"  placeholder="Service Start Date" value="<?php echo !empty($equip_data[0]->trma_transactiondatead)?$equip_data[0]->trma_transactiondatead:DISPLAY_DATE; ?>" id="ServiceStart">
              <span class="errmsg"></span>
            </div>
            <div class="col-md-3 col-sm-4">
                <?php $depid=!empty($item_data[0]->trma_fromdepartmentid)?$item_data[0]->trma_fromdepartmentid:''; ?>
                <label for="example-text">FROM :<span class="required">*</span>:</label>
                <select name="trma_fromdepartmentid" class="form-control select2" >
            ...
            <div class="col-md-4 col-sm-6">
                <?php $depid=!empty($item_data[0]->trma_todepartmentid)?$item_data[0]->trma_todepartmentid:''; ?>
                <label for="example-text">TO :<span class="required">*</span>:</label>
                <select name="trma_todepartmentid" class="form-control select2">
                    <option value="">---select---</option>
                    <?php
                        if($depatrment):
                            foreach ($depatrment as $km => $dep):
            ...
            <div class="col-md-4 col-sm-6">
                ...
                <textarea rows="3" cols="40" class="form-control" name="trma_remarks" placeholder="Describe yourself Remarks here..." ></textarea> 
            </div> 
            <div class="col-md-4 col-sm-6">
                ...
                <input type="text" class="form-control" name="trma_fromby" value="<?php echo $reorderlevel; ?>" placeholder="Enter Posted BY ">
            </div>
        </div>
        <div class="form-group">
                ...
                <table style="width:100%;" class="table dataTable dt_alt purs_table">
                    <thead>
                        <tr>
                            ...
                            <th width="20%"> <?php echo $this->lang->line('qty'); ?> </th>
