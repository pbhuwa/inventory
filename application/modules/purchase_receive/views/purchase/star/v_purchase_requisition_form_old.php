...
<form method="post" id="FormpPurchaseRequisition" action="<?php echo base_url('purchase_receive/purchase_requisition/save_requisition'); ?>" data-reloadurl='<?php echo base_url('purchase_receive/purchase_requisition/index/reload'); ?>' data-refresh="<?php echo base_url('purchase_receive/purchase_requisition/form_purchase_requisition'); ?>" class="form-material form-horizontal form">
    ...
    <div class="form-group">
        ...
        ?>
            <div class="col-md-3 col-sm-4">
                ...
                <div class="dis_tab">
                    <input type="text" class="form-control number enterinput" name="sama_requisitionno" value="<?php echo !empty($req_num_from_dmd) ? $req_num_from_dmd : ''; ?>" placeholder="Enter Req No." id="req_no" data-targetbtn="SrchReq">
    ...
    <div class="form-group">
        <div class="col-md-3 col-sm-4">
            ...
            <input type="text" class="form-control" name="requested_to" value="<?php echo !empty($requested_to) ? $requested_to : $pur_req_to; ?>" placeholder="Requested To ">
        </div>
    </div>
                            ...
                            <tr class="orderrow" id="orderrow_<?php echo $key + 1; ?>" data-id="<?php echo $key + 1; ?>">
                                ...
                                <td>
                                    <div class="dis_tab">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm btn-default table-cell width_30 view" data-heading='Item List' data-viewurl='<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>' data-id='<?php echo $key + 1; ?>' id="view_<?php echo $key + 1; ?>" data-storeid='<?php echo $storeid; ?>'><strong>...</strong></a>
                                        &nbsp
                            ...
                            <tr class="orderrow" id="orderrow_<?php echo $z; ?>" data-id='<?php echo $z; ?>'>
                                ...
                                <td>
                                    <div class="dis_tab">
                                        ...
                                        <a href="javascript:void(0)" class="btn btn-sm btn-default table-cell width_30 view" data-heading='Item List' data-viewurl='<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>' data-id='<?php echo $z; ?>' id="view_<?php echo $z; ?>" data-storeid='<?php echo $storeid; ?>'><strong>...</strong></a>
                                        &nbsp
                                ...
                                <td>
                                   <input type="text" class="form-control float stock" name="stock[]"   id="stock_<?php echo $z; ?>" data-id='<?php echo $z; ?>'  value="<?php echo !empty($plist->cur_stock_qty)?$plist->cur_stock_qty:'0.00'; ?>" placeholder="Stock Qty." readonly="true"> 
                                </td>
                                <td>
                        ...
                        <tr class="orderrow" id="orderrow_1" data-id='1'>
                            ...
                            <td>
                                <div class="dis_tab">
                                    ...
                                    <a href="javascript:void(0)" class="btn btn-sm btn-default table-cell width_30 view" data-heading='Item List' data-viewurl='<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>' data-id='1' id="view_1" data-storeid='<?php echo $storeid; ?>'><strong>...</strong></a>
                                    &nbsp
