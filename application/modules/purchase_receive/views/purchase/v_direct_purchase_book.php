...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $(document).on('click', '#searchByDate', function() {
            ...
            dtablelist.fnDraw();
            get_other_ajax_data(otherlinkdata,frmDate,toDate,false,false,locationid,srchtext);  
        });
       ...
       $(document).on('change', '#searchDateType', function() {
        ...
        $(document).on('click','.approvetype',function(){
            ...
            dtablelist.fnDraw();  
            get_other_ajax_data(otherlinkdata,frmDate,toDate,apptype,type,locationid,srchtext);   
        });
        ...
        function get_other_ajax_data(action,frmdate=false,todate=false,apptype = false, type=false,locationid = false){
            ...
            $.ajax({
                ...
                dataType: 'html',
                data:{frmdate:frmdate,todate:todate,apptype:apptype,type:type,locationid:locationid,srchtext:srchtext} ,
