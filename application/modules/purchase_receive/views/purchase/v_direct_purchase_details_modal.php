<div class="form-group white-box pad-5 bg-gray clearfix">
    ...
    <div class="col-md-3">
        ...
        <span><?php echo $direct_purchase_master[0]->recm_fyear; ?></span>
    </div>
    <div class="col-md-3">
    ...
    <?php if(!empty($direct_purchase_master[0]->recm_reqno)):?>
     <div class="col-md-6">
        <label><?php echo $this->lang->line('req_no'); ?> : </label>
         <span><?php echo  !empty($direct_purchase_master[0]->recm_reqno)?$direct_purchase_master[0]->recm_reqno:''; ?></span>
         <span><?php echo $this->lang->line('direct_purchase_by_req_no'); ?></span>
    </div>
    <?php endif; ?>
       <div class="col-md-3">
        <label><?php echo $this->lang->line('to_branch'); ?> : </label>
        <span><?php echo !empty($direct_purchase_master[0]->loca_name)?$direct_purchase_master[0]->loca_name:'';  ?></span>
    </div>

    <button class="btn btn-success PrintThisNow ReprintThis pull-right" id="btnPrintNowBtn" data-print="print" data-actionurl="<?php echo base_url('/purchase_receive/direct_purchase/direct_receive_reprint') ?>" data-viewdiv="FormDiv_Reprint" data-id="<?php echo !empty($req_detail_list[0]->recd_receivedmasterid)?$req_detail_list[0]->recd_receivedmasterid:''; ?>"><?php echo $this->lang->line('reprint'); ?></button>
</div>
    ...
    <table style="width:100%;" class="table dataTable con_ttl dt_alt purs_table">
        <thead>
            <tr>
                ...
                <th width="30%"> <?php echo $this->lang->line('item_name_np'); ?> </th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo $value->itli_itemnamenp ?></td>
            ...
            <tr class="table-footer">
                <td colspan="9">
                    <span style="float: right">
                    <label><?php echo $this->lang->line('vat_without_per'); ?></label>
                    </span>
                </td>
                <td colspan="2">
