...
<form method="post" id="FormDirectPurchase" action="<?php echo base_url('purchase_receive/direct_purchase/save_receive_order_item'); ?>" data-reloadurl='<?php echo base_url('purchase_receive/direct_purchase/index/reload'); ?>' class="form-material form-horizontal form">
    ...
    <div id="orderData">
        <div class="form-group">
            ...
            <div class="col-md-3">
                <label for="example-text">Choose Material Type <span class="required">*</span> : </label><br>
                <?php
        ...
        <div class="form-group"> -->
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <select class="table-cell form-control required_field select2" name="bugetid" id="budgetid">
                    <option value="">--- Select ---</option>
                    <?php if (!empty($budgets_list)) :
                        $db_budget = !empty($purchased_data[0]->recm_budgetid) ? $purchased_data[0]->recm_budgetid:""; 
                        foreach ($budgets_list as $kb => $buget) :
                    ?>
                            <option value="<?php echo $buget->budg_budgetid; ?>" 
                                <?php ($buget->budg_budgetid == $db_budget) ? "selected" : ''; ?>><?php echo $buget->budg_budgetname; ?></option>
                    <?php
                        endforeach;
                    endif;
                    ?>
            ...
            <div class="col-sm-3 col-md-3">
                ...
                $recm_school = !empty($purchased_data[0]->recm_school) ? $purchased_data[0]->recm_school : $this->locationid;
                ?>
            ...
            <div class="col-sm-3 col-md-3">
                ...
                <select name="recm_departmentid" id="rema_reqfromdepid" class="form-control required_field ">
                    <option value="">---select---</option>
                    <?php
                    $depid = !empty($purchased_data[0]->recm_departmentid) ? $purchased_data[0]->recm_departmentid : '';
                        ...
                        <fieldset class="pull-right bordered">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <input type="text" class="form-control float calculateextra" name="insurance" id="insurance"  value="<?php
                                        echo !empty($purchased_data[0]->recm_insurance) ? $purchased_data[0]->recm_insurance: 0 ?>" data-discount="per" />
                                </li>
                                <li>
                                    <label><?php echo $this->lang->line('carriage_freight'); ?> :</label>
                                    <input type="text" class="form-control float calculateextra" name="carriage" id="carriage"  value="<?php
                                        echo !empty($purchased_data[0]->recm_carriagefreight) ? $purchased_data[0]->recm_carriagefreight: 0 ?>" data-discount="amt" />
                                </li>
                                <li>
                                    <label><?php echo $this->lang->line('packing'); ?> :</label>
                                    <input type="text" class="form-control float calculateextra" name="packing" id="packing"  value="<?php
                                        echo !empty($purchased_data[0]->recm_packing) ? $purchased_data[0]->recm_packing: 0 ?>" />
                                </li>
                                <li>
                                    <label><?php echo $this->lang->line('transport_courier'); ?> :</label>
                                    <input type="text" class="form-control float calculateextra" name="transportamt" id="transportamt"  value="<?php
                                        echo !empty($purchased_data[0]->recm_transpostcourier) ? $purchased_data[0]->recm_transpostcourier: 0 ?>" />
                                </li>
                                <li>
                                    <label><?php echo $this->lang->line('other'); ?> :</label>
                                    <input type="text" class="form-control float calculateextra" id="otheramt" name="otheramt" value="<?php
                                        echo !empty($purchased_data[0]->recm_others) ? $purchased_data[0]->recm_others: 0 ?>" />
                                </li>
                                 <li>
                                        ...
                                        echo !empty($purchased_data[0]->recm_othersdescription) ? $purchased_data[0]->recm_othersdescription:"" ?>">
                                    </li>
                            </ul>
                        </fieldset>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '.chooseMatType,#fiscalyear', function() {
            ...
            function onSuccess(jsons) {
                ...
                let db_fyear = "<?php echo $puorfyear;?>";
                let receive_masterid = "<?php echo $receivedmasterid;?>";
                let db_mattype = "<?php echo $rema_mattype;?>";
                let db_invoice_no = "<?php echo $receivedno;?>";
                if(receive_masterid && matType == db_mattype && db_fyear == fyear){
                    $('#receivedno').val(db_invoice_no);
                }
            }
    ...
    <script type="text/javascript">
        ...
        $(document).on('change', '#mattypeid', function(e) {
            ...
            function onSuccess(jsons) {
             ...
             let db_budget = "<?php echo $db_budget; ?>";
             $('#budgetid').val(db_budget);   
            }
        });
    </script>