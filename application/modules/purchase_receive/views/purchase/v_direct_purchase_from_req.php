...
<form method="post" id="FormDirectPurchase" action="<?php echo base_url('purchase_receive/direct_purchase/save_receive_order_item'); ?>" data-reloadurl='<?php echo base_url('purchase_receive/direct_purchase/form_purchase_receive'); ?>' class="form-material form-horizontal form" >
    <?php
        ...
        //echo "<pre>"; print_r($purchased_data); die;
        ?>
    ...
    <div id="orderData">
        ...
        // }else{
            // $sama_reqnodb = !empty($purchased_data[0]->sama_requisitionno)?$purchased_data[0]->sama_requisitionno:'';
        }
         ?> 
        <label for="example-text"><?php echo $this->lang->line('req_no'); ?> <span class="required">*</span>:</label>
            <div class="dis_tab">
                <input type="text" class="form-control reqno send_after_stop number enterinput required_field " name=""  value="" placeholder="Enter Req No." id="req_no" data-targetbtn="SrchReq" autocomplete="off" autofocus="on">
        ...
        <!-- <input type="text" class="form-control" id="fiscal_year" value="<?php echo $sama_fyear; ?>" placeholder="Fiscal Year" > -->
                    ...
                    <tbody id="purchaseDataBody">
                        ...
                        <tr class="orderrow" id="orderrow_1" data-id='1'>
                          ...
                          <!--   <td>  
                            ...
                            <td><input type="text" class="form-control float calamt" name="puit_qty[]" value="1"  data-id='1' id="puit_qty_1" placeholder="Qty">
                            </td>
                            <td>
                          ...
                          <!--   <td>
                            ...
                            <td>
                                <input type="text" class="form-control float calamt eachcc" name="cc[]" id="cc_1" value="0"  data-id='1' placeholder="CC">
                            </td>
                            <td>
