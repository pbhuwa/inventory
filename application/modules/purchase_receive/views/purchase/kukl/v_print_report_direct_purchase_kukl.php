        ...
        <table  class="jo_table itemInfo" style="border-bottom: 1px solid #333; width: 100%;table-layout: fixed;">
            <thead>
                <tr>
                    ...
                    <th width="8%" rowspan="2" class="td_cell">सामानको कोड नं</th>
                    <th width="25%" rowspan="2" class="td_cell">विवरण</th>
                    ...
                    <th width="12%" colspan="1" class="td_cell">जम्मा रकम </th>
                    <th width="15%" rowspan="2" class="td_cell">कैफियत </th>
                </tr>
                <tr>
            ...
            <tbody>
              ...
              <tfoot>
            <tr>
               <td width="60%" class="td_cell" colspan="6" style="border-bottom: 1px solid">अक्षरूपी : <?php echo $this->general->number_to_word( $total);?> </td>
               <td>कुल जम्मा :</td>
                <td style="border-bottom: 1px solid">
                    <?php echo !empty($total)?number_format($total,1):''; ?>
                </td>
