    ...
    <div class="col-sm-12">
        <div class="white-box">
            ...
            <div class="ov_report_tabs pad-5 tabbable r-tabs">
                ...
                <ul class="nav nav-tabs form-tabs">
                    ...
                    <li class="tab-selector <?php if($current_stock=='purchase_orders') echo 'active';?>"><a href="<?php echo base_url('purchase_receive/purchase_orders'); ?>" <?php if($current_stock=='purchase_orders') echo' aria-expanded="true"';?>" ><?php echo $this->lang->line('purchase_order'); ?></a></li>
        ...
        <div class="ov_report_tabs page-tabs margin-top-250 pad-5 tabbable">
            <?php if($current_stock=='purchase_orders'): ?>      
            <div id="dtl_rpt" class="tab-pane fade in  <?php if($current_stock=='purchase_orders') echo "active"; ?>">
                        <div  id="FormDiv_purchase_analysis" class="formdiv frm_bdy">
                            
                            <?php $this->load->view('purchase_orders/v_purchase_order_form');?>
                        </div>
            </div>
            <?php endif; ?>
