                ...
                <tbody id="purchaseDataBody" class="requisitionOrder">
                    <?php if(!empty($orderdetails)) { 
                        ...
                        <tr class="orderrow" id="orderrow_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>'>
                            ...
                            <td>
                                <div class="dis_tab"> 
                                    <input type="text" class="form-control itemcode enterinput " id="itemcode_<?php echo $key+1; ?>" name="itemcode[]"  data-id='<?php echo $key+1; ?>' data-targetbtn='view' value="<?php echo $ord->itli_itemname; ?>">
                            ...
                            <td>  
                                <input type="text" class="form-control puit_unitid" id="puit_unitid_<?php echo $key+1; ?>" name="puit_unitid[]"  data-id='<?php echo $key+1; ?>' value="<?php echo $ord->pude_unit; ?>" >
                            </td>
                          <!--   <?php// $tot = ($ord->purd_remqty) * ($ord->itli_salesrate); ?> -->
                            ...
                            <td>
                                <input type="text" class="form-control float multiInsert calculateamt" name="puit_taxid[]" id="puit_taxid_<?php echo $key+1; ?>" value="<?php echo !empty($ord->pude_vat)?$ord->pude_vat:'0' ; ?>" data-id="<?php echo $key+1; ?>" >
                            </td>
                            <td>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="dis_tab">
                                    <label class="pr-10 table-cell width_100"><?php echo $this->lang->line('current_symbol'); ?>:</label>
                        ...
                        <fieldset class="pull-right bordered mh_init">
                          ...
                          <!--       <li>
                                ...
                                <li>
                                    ...
                                    <input type="text" class="form-control float calculateDiscount" name="puin_discountamt" id="dis_amt" value="<?php echo !empty($puordiscount)?$puordiscount:'0'; ?>" data-discount="amt" / >
                                </li>
                                ...
                                <li>
                                    ...
                                    <input type="text" class="form-control float taxtamount" name="taxtamount" id="taxtamount"  value="<?php echo !empty($puortaxtamount)?$puortaxtamount:'0'; ?>"/>
                                </li>
                                 ...
                                 <li>
                                    ...
                                    <input type="text" class="form-control float extraamount" name="extraamount" id="extraamount" value="<?php echo !empty($puorextraamount)?$puorextraamount:'0'; ?>" />
                                </li>
...
<script>
            ...
            $(document).on('keyup change','.calculateamt', function(){
                ...
                subtotal = total_amount_wo_taxdis - discount_amount;
