    ...
    <div class="jo_form organizationInfo" id="printrpt">
            ...
            <table class="table table-striped alt_table">
                <thead>
                    ...
                    <tr>
                        ...
                        <th width="5%"><?php echo $this->lang->line('receipt_no'); ?></th>
                        ...
                        <th width="3%"><?php echo $this->lang->line('cc'); ?></th>
                ...
                <?php
                    ...
                    if($supp_mrn_list):
                        foreach ($supp_mrn_list as $ksm => $supp):
                            $supp_data=$this->purchase_analysis_mdl->get_mrn_purchase_analysis(array('rm.recm_supplierid'=>$supp->supplierid));
                ...
                ?>
                    ...
                    <tr>
                        <td colspan="11"> <strong><?php echo $supp->dist_distributor;  ?></strong></td>
                    ...
                    <?php
                        if($supp_data): 
                          ...
                          ?>
                        <tr>
                            <td><?php echo !empty($mlist->recm_purchaseorderno)?$mlist->recm_purchaseorderno:''; ?></td>
                ...
                <tbody>
                    <tr>
                        <td colspan="5" align="right"><strong><?php echo $this->lang->line('grand_total'); ?></strong></td>
                    ...
                    <tr class="borderBottom">
                        <td colspan="11" class="text-center" align="center">
                            <?php
                                if(!empty($total_purchase_balance)):
                            ?>
                            <strong>
                                <?php 
                                    echo $this->lang->line("in_words");
                                ?>:
                                <?php echo $this->general->number_to_word($total_purchase_balance);?>
                            </strong>
                            <?php
                                endif; 
                            ?>
        ...
        <div class="table-responsive">
            <table class="table table-striped alt_table">
                    ...
                    <?php
                        ...
                        $total_return_vat = 0;
                         $pd_amt = 0;
                            ...
                            $pd_tax = 0;
                        if($return_data):
                            foreach($supp_mrn_list as $ret_key=>$ret_sup):
                ...
                <tbody>
                        <tr>
                             <td colspan="11"> <strong><?php echo $supp_mrn_list[0]->dist_distributor;  ?></strong></td>
                        </tr>
                        <?php
                        ...
                        <td colspan="9" class="text-center" align="center">
                            ...
                            <strong>
                                <?php 
                                    echo $this->lang->line("in_words");
                                ?>: 
                                <?php echo $this->general->number_to_word($total_return_amount);?>
                            </strong>
                            <?php
                                endif;
                            ?>
