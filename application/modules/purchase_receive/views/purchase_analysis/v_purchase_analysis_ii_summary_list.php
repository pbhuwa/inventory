<div class="searchWrapper">
    ...
    <div class="pull-right" style="margin-top:15px;">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="purchase_receive/purchase_analysis_ii/purchase_analysis_ii_list" data-location="purchase_receive/purchase_analysis_ii/exportToExcel_summary" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="purchase_receive/purchase_analysis_ii/purchase_analysis_ii_list" data-location="purchase_receive/purchase_analysis_ii/generate_pdf_summary" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataurl = base_url + "purchase_receive/purchase_analysis_ii/purchase_analysis_ii_summary_list";
