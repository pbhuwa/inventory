    ...
    <form id="purchase_supplier_search_form">
        <div class="form-group">
         ...
         <div class="dateRangeWrapper">
                ...
                <div class="col-md-2">
                     <label><?php echo $this->lang->line('items'); ?></label>
                      <select name="itemid" class="form-control select2" id="itemid">
                            <option value="">All</option>
                            <?php
                                if($item_all):
                                    foreach ($item_all as $ks => $items):
                                ?>
                            <option value="<?php echo $items->itli_itemlistid; ?>"><?php echo $items->itli_itemname; ?></option>
                            <?php
                                endforeach;
                                endif;
                                ?>
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="purchase_receive/purchase_analysis/purchase_analysis_by_item_report"><?php echo $this->lang->line('search'); ?></button>
                </div>
            </div>
        </div>
    </form>
