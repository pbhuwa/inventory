            ...
            <table class="table table-striped alt_table">
                <thead>
                    <tr>
                        ...
                        <th width="10%"><?php echo $this->lang->line('grand_total'); ?></th>
                    ...
                    <?php
                        if($item_category):
                            ...
                            foreach ($item_category as $ksm => $catid):
                                $itemcat=$this->purchase_analysis_mdl->get_purchase_by_date(array('rm.recm_supplierid'=>$catid->recm_supplierid),false,false,'recm_receiveddatead','ASC');
                                if($itemcat): 
                    ?>
                    <tr>
                        <td colspan="13" style=" text-align: left;"> <strong><?php echo $catid->dist_distributor;  ?></strong></td>
                    </tr>
                    <?php
                        if($itemcat): 
                            $i=1;
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td colspan="4"  class="header text-right" align="right">
                            <?php 
