        ...
        <div class="form-group">
            <div class="row">
             ...
             <div class="dateRangeWrapper">
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="purchase_receive/purchase_analysis/purchase_analysis_by_supplier_report"><?php echo $this->lang->line('search'); ?></button>
                </div>
            </div>
        </div>
    </form>
