...
<div class="white-box pad-5" id="detailListBox">
    <?php $this->load->view('purchase/v_pur_requisition_detail_modal_quot');?>
</div> 
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var dataurl = base_url+"purchase_receive/purchase_requisition/get_pur_requisition_list_quot";
