                    ...
                    ?>
                        ...
                        ?>
                         ...
                         <?php 
                            ...
                            // echo 'a'.$account_verification;
                            // echo 'b'.$account_verification_div_id;
                            // echo 'c'.$previous_account_verification_flow;
                        ?>
                            <?php 
                                if($count != '' && empty($account_verification) && $previous_account_verification_flow == "F" && $this->usergroup == 'AO'): 
                            ?>
                                ...
                                <tr>
                                    <td colspan="12">
                                        <div id="">
                                            <span>
                                                Remarks (कैफियत):
                                                <input type="text" id="" class="form-control account_verifcation_comment_<?php echo $mat->maty_materialtypeid; ?>" placeholder="Please write your verification comment" /> <br/>
                                                <a href="javascript:void(0)" data-status="A" class="btn btn-sm btn-primary procced_to_next_accountant" id="" data-materialtype = "<?php echo $mat->maty_materialtypeid; ?>">
                                                    Proceed Ahead
                                                </a>
                                                <a href="javascript:void(0)" data-status="D" class="btn btn-sm btn-danger accountDeclineBtn" data-materialtype = "<?php echo $mat->maty_materialtypeid; ?>">
                                                    Decline
                                                </a>
                            ...
                            <?php 
                                elseif($count != '' && $account_verification == "0" && $previous_account_verification_flow == 'B' && $this->usergroup == 'AO'): 
...
<script type="text/javascript">
    ...
    $(document).on('click','.procced_to_next_accountant',function(){
        ...
        var account_verification_comment = $('.account_verifcation_comment_'+materialtype).val();
        ...
        var submitData = { masterid:masterid, req_no:req_no, account_verification_level:account_verification_level, account_verification_comment:account_verification_comment, materialtype:materialtype, itemlist:itemlist };
