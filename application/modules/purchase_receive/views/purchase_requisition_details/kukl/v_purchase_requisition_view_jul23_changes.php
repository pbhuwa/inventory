                    ...
                    <?php
                        if(in_array($this->usergroup, $show_estimate_amt_group)):
                            ...
                            <td>
                                ...
                                ?>
                                <input type="text" value="<?php echo !empty($odr->purd_estimatecost)?$odr->purd_estimatecost:0; ?>" class="form-control estimate_cost arrow_keypress float" data-fieldid="estimate_cost" id="estimate_cost_<?php echo $i; ?>" data-id='<?php echo $i; ?>' <?php echo $readonly; ?>/>
                            </td>

                            <td>
                                <input type="text" value="0" class="form-control estimate_item_total arrow_keypress float" data-fieldid="estimate_item_total" id="estimate_item_total_<?php echo $i; ?>" data-id='<?php echo $i; ?>' readonly />
                            </td>
                            <?php
                        endif;
                    ?>
