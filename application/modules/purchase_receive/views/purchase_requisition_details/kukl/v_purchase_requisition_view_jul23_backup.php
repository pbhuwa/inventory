...
<div class="form-group">
    <div class="row">
                ...
                <tr class="orderrow" id="orderrow_1" data-id='1'>
                    ...
                    <?php
                        if(in_array($this->usergroup, $show_estimate_amt_group)):
                            ...
                            <td>
                                <input type="text" value="0" class="form-control estimate_item_total arrow_keypress float" data-fieldid="estimate_item_total" id="estimate_item_total_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>' readonly />
                            </td>
                            <?php
                        endif;
                    ?>
               <!--      <td>
                ...
                <tr class="orderrow" id="orderrow_1" data-id='1'>
                    ...
                    ?>
                        ...
                        <?php 
                            if($count != '0' && $purchase_proceed_log_status == 'Y'):
                        ?>
                            <tr id="processPurchaseDiv" style="display: none;">
                                <td colspan="12">
                                    <div class="">
                        ...
                        <?php
                            ...
                            if($unverified_count != 0 && $account_verification == "0" && $previous_account_verification_flow == 'B' && $this->usergroup == 'AO'): 

                                // echo $purchase_proceed_log_status;
                       
                                // if(empty($purchase_proceed_log_status)):
                            ?>
                            <tbody id="processPurchaseDiv_noBudget" style="display: none;">
                                <tr>
                                    <td colspan="12">
                                        <div class="">
                                            <a href="javascript:void(0)" class="btn btn-sm btn-info proceed_to_purchase_order" id="proceed_to_purchase_order" data-materialtype="<?php echo $mat->maty_materialtypeid; ?>">Proceed to Purchase Order</a>
                            ...
                            <?php
                                ...
                                <!-- after proceed to prcourement -->
                                <div class="text-info">
                                <?php
                                    if($mat->maty_materialtypeid == '1'):

                                        if(($count != '' && $account_verification == "0" && $previous_account_verification_flow == 'B') || ($count != '' && $budget_status== 'Y')):
                                ?>
                                   <!--  <span class="text-success">
                                        ...
                                        <div class="btn-group pull-left">
                                            ...
                                            if(in_array($this->usergroup, $view_order_approval_button_group)):
                                                if($purchase_proceed_log_status=='M'){ ?>
                                                    ...
                                                    <?php
                                                }else if($purchase_proceed_log_status=='Y' || $purchase_proceed_log_status=='D' || $purchase_proceed_log_status=='P'){
                                            ?>
                                            ...
                                            if(in_array($this->usergroup, $view_proc_supervisor_button_group)):
                                                if($purchase_proceed_log_status=='S'){ ?>
                                                    ...
                                                    <a href="javascript:void(0)" class="btn btn-danger btnPurchaseApproval" data-val="R" data-materialtype="<?php echo $mat->maty_materialtypeid; ?>" style="margin-right:5px;">Reject</a>
                                            <?php
                                        }else if($purchase_proceed_log_status=='D' || $purchase_proceed_log_status=='P'){
                                            ?>
                                            <span class="text-info">Already Approved.</span>
                                            <?php
                                        }
                                    ...
                                    if(in_array($this->usergroup, $view_proc_head_button_group)):
                                        if($purchase_proceed_log_status=='D'){ ?>
                                            ...
                                            <a href="javascript:void(0)" class="btn btn-danger btnPurchaseApproval" data-val="R" data-materialtype="<?php echo $mat->maty_materialtypeid; ?>" style="margin-right:5px;">Reject</a>
                                            <?php
                                        }else if($purchase_proceed_log_status=='M'){
                                            ?>
                                            <span class="text-info">Already Approved.</span>
                                            <?php
                                        }
                                    ...
                                    if(in_array($this->usergroup, $view_order_button_group)):
                                        if($purchase_proceed_log_status=='P'){ ?>
                                            <a href="javascript:void(0)" class="btn btn-primary btnPurchaseApproval" data-val="S" data-materialtype="<?php echo $mat->maty_materialtypeid; ?>" data-materialtype="<?php echo $mat->maty_materialtypeid; ?>">Send For Approval</a> &nbsp;

                                    <?php
                                        }else if($purchase_proceed_log_status=='S' || $purchase_proceed_log_status=='M' || $purchase_proceed_log_status=='D' || $purchase_proceed_log_status=='P'){
                                            ?>
                                ...
                                <?php
                                    $pude_requsitionid = !empty($purchase_requisition[0]->purd_reqdetid)?$purchase_requisition[0]->purd_reqdetid:0;

                                    $check_order_item = $this->purchase_requisition_mdl->check_purchase_order_items($pude_requsitionid);

                                    $total_cnt = !empty($check_order_item[0]->totalcnt)?$check_order_item[0]->totalcnt:0;
                                ?>

                                <div class="btn-group pull-left">
                                    <?php
                                        if(in_array($this->usergroup, $view_order_button_group)):
                                            if($purchase_proceed_log_status=='Y' && $total_cnt == 0){ ?>
                                                <hr/>
                                                <strong>Select Purchase Type: </strong><br/>
                                                <input type="radio" name="select_purchase_type" id="type_order" class="select_purchase_type" data-pur_type="type_order" data-mat_type="<?php echo $mat->maty_materialtypeid; ?>"/>Purchase Order &nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="select_purchase_type" id="type_tender" class="select_purchase_type" data-pur_type="type_tender" data-mat_type="<?php echo $mat->maty_materialtypeid; ?>" />Tender &nbsp;&nbsp;&nbsp;
                                                <input type="radio" name="select_purchase_type" id="type_direct" class="select_purchase_type" data-pur_type="type_direct" data-mat_type="<?php echo $mat->maty_materialtypeid; ?>" />Direct Purchase


                                                <div class="div_order_<?php echo $mat->maty_materialtypeid; ?>" style="display: none;">
                                                ...
                                                <div class="div_tender_<?php echo $mat->maty_materialtypeid; ?>" style="display: none;">
                                                ...
                                                <div class="div_direct_<?php echo $mat->maty_materialtypeid; ?>" style="display: none;">
                        ...
                        <?php
                            // if budget available, show purchase order button directly
                            if($count != '0' && empty($purchase_proceed_log_status)):
                        ?>
                            <tbody id="processCapitalPurchaseDiv" class="showIfBudgetAvailable" style="display: none;">
                                <tr>
                                    <td colspan="12">
                                        <div class="">
                        ...
                        <div class="text-info">
                            <?php   
                                ...
                                if(($count == 0 && $account_verification == "0" && $previous_account_verification_flow == 'B') || $account_verification == "0" && $previous_account_verification_flow == 'B' || ($count != '' && $budget_status== 'Y')):
                            ?>
                                <!-- <span class="text-success">
                                Request verification has been completed from all level.
                                </span> -->
        ...
        <?php
            if(in_array($this->usergroup, array('AO')) && $odr->purd_accountverify != '1'):
        ?>
        <tfoot>
        ...
        <!-- if budget not available, show the 4 level account verfication steps -->
        <?php 
            // echo $count;
            // echo $account_verification;
            // echo $previous_account_verification_flow;
            ...
            if(empty($account_verification) && $previous_account_verification_flow == "F" && $this->usergroup == 'AO'): 
                ...
                <?php 
                    elseif($unverified_count != 0 && $account_verification == "0" && $previous_account_verification_flow == 'B' && $this->usergroup == 'AO'): 

                        // if(empty($purchase_proceed_log_status)):
                ?>
                <tbody id="processCapitalPurchaseDiv_noBudget" style="display: none;">
                    <tr>
                        <td colspan="12">
                            <div class="">
                                <a href="javascript:void(0)" class="btn btn-sm btn-info proceed_to_purchase_order" id="proceed_to_purchase_order_capital" data-materialtype="<?php echo $mat->maty_materialtypeid; ?>">Proceed to Purchase Order (Capital)</a>
                ...
                ?>
                <!-- <tbody id="nextAccountDiv_Capital" style="display: none;"> -->
                    <tbody id="nextAccountDiv_Capital" >
                    <tr>
                        <td colspan="12">
                            <div id="">
                                <span>
