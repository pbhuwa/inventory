                        ...
                        ?>
                                <tr id="row_<?php echo $i; ?> receivedOrderItem_<?php echo $i; ?>" class="receivedItems">
                                    ...
                                    <td>
                                        ...
                                        <input type="text" class="form-control float calamt recqty arrow_keypress" name="received_qty[]" data-fieldid="recqty" value="<?php  echo sprintf('%g',$rdd->recd_purchasedqty); ?>" data-id="<?php echo $i; ?>" id="recqty_<?php echo $i; ?>">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <input type="text" class="form-control float calamt discount discountpc arrow_keypress" name="discount[]" data-fieldid="discount" id="discount_<?php echo $i; ?>" value="<?php echo sprintf('%g',$rdd->recd_discountpc); ?>" data-id="<?php echo $i; ?>">
                                        <input type="hidden" name="disamt[]" value="<?php echo $rdd->recd_discountamt; ?>" id="disamt_<?php echo $i; ?>" class="disamt calamt">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control float calamt vat arrow_keypress" name="vat[]" id="vat_<?php echo $i; ?>" data-fieldid="vat" value="<?php echo sprintf('%g',$rdd->recd_vatpc); ?>" data-id="<?php echo $i; ?>">
