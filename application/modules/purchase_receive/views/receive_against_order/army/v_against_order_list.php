    ...
    <div class="">
        <form>
          ...
          <div class="col-md-2">
               ...
               <div class="col-md-1">
                    <label>Filter</label>
                    <input type="text" class="form-control enterinput" placeholder="Invoice No" 
        ...
        <div class="col-sm-4">
            <div class="white-box noborder">
                <ul class="index_chart chart_tab" style="margin: 9px 0 6px 6px;">
     ...
     var supplier = '';
        ...
        $(document).on('click', '#searchByDate', function() {
           ...
           pur_type = $('#pur_type').val();
            ...
            dtablelist.fnDraw();
            get_other_ajax_data(otherlinkdata, frmDate, toDate, false, locationid, mattypeid,pur_type);
        });
        ...
        function get_other_ajax_data(action, frmdate = false, todate = false, othertype = false, locid = false, mattypeid = false, pur_type = false) {
            var returndata = [];
            $.ajax({
                type: "POST",
                url: action,
