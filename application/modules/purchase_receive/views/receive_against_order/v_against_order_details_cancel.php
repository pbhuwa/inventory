            ...
            <form method="post" id="FormIssueCancel" action="<?php echo base_url('purchase_receive/receive_against_order/save_new_issue'); ?>" data-reloadurl="<?php echo base_url('purchase_receive/receive_against_order/form_new_issue'); ?>" class="form-material form-horizontal form">
                ...
                <div id="issueDetails"> 
                    ...
                    <div class="form-group">
                        ...
                        <?php if (ORGANIZATION_NAME == 'KU' || ORGANIZATION_NAME == 'ARMY'  ) : ?>
                            <div class="col-md-2 col-sm-3">
                                <label for="mattypeid">Choose Material Type : </label><br>
                                <select name="recm_mattypeid" id="mattypeid" class="form-control required_field">
                                    <?php
...
<script type="text/javascript">
    ...
    $(document).on('click', '#btnSearchReceive', function() {
        ...
        var submiturl = base_url + 'purchase_receive/receive_against_order/receivelist_by_receive_no';
        ...
        function onSuccess(jsons) {
            ...
            if (data.status == 'success') {
                ...
                $('#displayReportDiv').html('<span class="text-danger">' + data.message + '</span>');
            }
            $('.overlay').modal('hide');
        }
    });
