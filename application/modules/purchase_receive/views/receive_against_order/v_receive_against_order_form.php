...
<form method="post" id="FormReceiveOrderItem" action="<?php echo base_url('purchase_receive/receive_against_order/save_received_items'); ?>" class="form-material form-horizontal form" data-reloadurl="<?php echo base_url('purchase_receive/receive_against_order/form_direct_received_items'); ?>" enctype="multipart/form-data"  accept-charset="utf-8" >
    <div id="orderData">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3">
                <?php $orderno=!empty($order_details[0]->puor_order_for)?$order_details[0]->puor_order_for:$order_no; ?>
                <label for="example-text"><?php echo $this->lang->line('order_no'); ?><span class="required">*</span>:</label>
                <div class="dis_tab">
                    <input type="text" class="form-control required_field enterinput"  name="orderno"  value="<?php echo $orderno; ?>" placeholder="Enter Order Number" id="orderno" data-targetbtn='btnSearchOrderno'>
...
<script type="text/javascript">
    $(document).off('change','#fiscalyear');
    $(document).on('change','#fiscalyear',function(e){
        var fyrs=$(this).val();
        var action=base_url+'purchase_receive/receive_against_order/gen_receive_invoice';
    $.ajax({
      type: "POST",
      url: action,
      data:{fyrs:fyrs},
