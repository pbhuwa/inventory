    ...
    <div id="orderData">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <select name="supplierid" class="form-control required_field select2" disabled="disabled" id="supplierid" >
                    <option value="">---select---</option>
                    <?php
                        if($supplier_all):
                        ...
                        ?>
                           <tr id="row_<?php echo $i; ?> receivedOrderItem_<?php echo $i;?>" class="receivedItems">
                               ...
                               <td>
                                ...
                                <input type="hidden" name="disamt[]" value="<?php echo $rdd->recd_discountamt; ?>" id="disamt_<?php echo $i; ?>" class="disamt calamt"></td>
                                <td>
                            ...
                            <fieldset class="pull-right mtop_10 pad-top-14">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <input type="text" class="form-control float" name="discountamt_overall" id="overall_discount" value="<?php echo $recm_taxamount; ?>" data-discount="amt" / >
                                    </li>

                                    <li>
                                        <label><?php echo $this->lang->line('sub_total'); ?></label>
                                        <input type="text" class="form-control float" name="subtotalamt" id="subtotalamt" value="<?php echo $recm_taxamount; ?>" readonly="true" />
                                    </li>
                                    <li>
...
<script type="text/javascript">
    $(document).ready(function(e){
       ...
       $(document).off('change','.chooseMatType,#fiscalyear');
        ...
        var submitdata = {mattype:matType,fyrs:fyear};
