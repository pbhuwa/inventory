...
<!-- data-reloadurl="<? php // echo base_url('purchase_receive/receive_against_order/form_received_form'); 
                        ?>" -->
<form method="post" id="FormReceiveOrderItem" action="<?php echo base_url('purchase_receive/receive_against_order/save_received_items'); ?>" class="form-material form-horizontal form" data-reloadurl="<?php echo base_url('purchase_receive/receive_against_order/index/reload'); ?>" enctype="multipart/form-data" accept-charset="utf-8">
    <div id="orderData">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <select class="table-cell form-control select2 required_field" name="bugetid" id="budgetid">
                    <option value="">--- Select ---</option>
            ...
            <div class="col-sm-3 col-md-3">
                ...
                $recm_school = !empty($req_data[0]->recm_school) ? $req_data[0]->recm_school : $this->locationid;
                ?>
                ...
                <table style="width:100%;" class="table purs_table dataTable">
                    <thead>
                        <tr>
                            ...
                            <th width="6%"><?php echo $this->lang->line('vat'); ?><input type="text" class="form-control allvat" style="width:35px;height:20px" value="13"></th>
