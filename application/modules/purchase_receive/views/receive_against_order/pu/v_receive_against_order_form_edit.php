...
<form method="post" id="FormReceiveOrderItem" action="<?php echo base_url('purchase_receive/receive_against_order/update_received_items'); ?>" class="form-material form-horizontal form" enctype="multipart/form-data" accept-charset="utf-8" data-reloadurl="<?php echo base_url('purchase_receive/receive_against_order/received_order_item_list'); ?>" data-isredirect="true">
    <div id="orderData">
        <input type="hidden" name="id" value="" />
        <input type="hidden" name="receivedmasterid" id="receivedmasterid" value="<?php echo !empty($receive_data_master[0]->recm_receivedmasterid) ? $receive_data_master[0]->recm_receivedmasterid : ''; ?>" />
        <div class="form-group row">
            <div class="col-md-2 col-sm-2">
                ...
                <select name="fiscalyear" class="form-control select2" id="fiscalyear" disabled="disabled">
                    ...
                    ?>
                            <option value="<?php echo $fy->fiye_name; ?>" <?php if ($fiscalyear == $fy->fiye_name) echo "selected=selected"; ?>><?php echo $fy->fiye_name; ?></option>
                    <?php
                        endforeach;
                    endif;
                    ?>
            ...
            <div class="col-md-3 col-sm-3">
                ...
                ?>
                <select name="recm_mattypeid" id="mattypeid" class="form-control chooseMatType required_field" disabled="disabled">
                    <?php
            ...
            <div class="col-md-1 col-sm-1">
                ...
                <div class="dis_tab">
                    <a href="javascript:void(0)" title="View" data-id="<?php echo !empty($receive_data_master[0]->recm_purchaseordermasterid) ? $receive_data_master[0]->recm_purchaseordermasterid : ''; ?>" data-displaydiv="orderDetails" data-viewurl="<?php echo base_url('purchase_receive/purchase_order/details_order_views'); ?>" class="view btn-primary btn-xxs" data-heading="Order Detail"><span><?php echo $orderno  ?></span> </a>
                </div>
            </div>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-3 col-sm-3">
                <label for="example-text"><?php echo $this->lang->line('received_date'); ?><span class="required">*</span>:</label>
                <?php
                if (DEFAULT_DATEPICKER == 'NP') {
                ...
                ?>
                <input type="text" name="received_date" class="form-control required_field <?php echo DATEPICKER_CLASS; ?> date" placeholder="<?php echo $this->lang->line('received_date'); ?>" value="<?php echo $received_date; ?>" id="ReceivedDate">
                <span class="errmsg"></span>
            </div>
            <div class="col-md-3 col-sm-3">
                ...
                <input type="text" class="form-control required_field" name="suplier_bill_no" value="<?php echo $suplier_bill_nodb; ?>" placeholder="Supplier Bill No. ">
            </div>
            <div class="col-md-3 col-sm-3">
                <?php
                if (DEFAULT_DATEPICKER == 'NP') {
                ...
                <input type="text" name="suplier_bill_date" class="form-control required_field <?php echo DATEPICKER_CLASS; ?> date" placeholder="<?php echo $this->lang->line('supplier_bill_date'); ?>" value="<?php echo $sup_bill_date; ?>" id="SupBillDate">
                <span class="errmsg"></span>
            </div>
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <select class="table-cell form-control select2 required_field" name="bugetid">
                    ...
                    ?>
                            <option value="<?php echo $buget->budg_budgetid; ?>" <?php if ($bugetid == $buget->budg_budgetid) echo "selected=selected"; ?>><?php echo $buget->budg_budgetname; ?></option>
                    <?php
                        endforeach;
                    endif;
                    ?>
            ...
            <div class="col-md-3 col-sm-3" style="display: none" id="received_by_div">
                ...
                <select class="form-control select2" name="recm_receivedby">
                    ...
                    $staff_info = $this->general->get_tbl_data('*', 'stin_staffinfo', array(
                        'stin_jobstatus' => 'Y',
                    ));
                    if (!empty($staff_info)) :
                        foreach ($staff_info as $ks => $sta) {
                    ?>
                            <option value="<?php echo $sta->stin_staffinfoid . ',' . $sta->stin_fname . ' ' . $sta->stin_mname . ' ' . $sta->stin_lname ?>" <?php if ($staff_id == $sta->stin_staffinfoid) echo "selected=selected"; ?>>
            ...
            <div class="col-sm-3 col-md-3">
                ...
                $recm_school = !empty($receive_data_master[0]->recm_school) ? $receive_data_master[0]->recm_school : $this->locationid;
                ?>
                <select class="form-control required_field" name="recm_school" id="locationid">
                    <?php
                    if (!empty($locationlist)) :
                        foreach ($locationlist as $kl => $loc) {
                    ?>
                            <option value="<?php echo $loc->loca_locationid; ?>" <?php if ($recm_school == $loc->loca_locationid) echo "selected=selected"; ?>><?php echo $loc->loca_name; ?></option>
                        <?php
                        }
                        ?>
                    <?php
            ...
            <div class="col-sm-3 col-md-3">
                ...
                <select name="recm_departmentid" id="rema_reqfromdepid" class="form-control required_field ">
                    <?php
                    $depid = !empty($receive_data_master[0]->recm_departmentid) ? $receive_data_master[0]->recm_departmentid : '';
                    $get_dept_data =  $this->general->get_tbl_data('*', 'dept_department', ['dept_depid' => $depid]);
                    // var_dump('department_data:', $get_dept_data);
                    if (count($get_dept_data) == 1) {
                        ...
                        // var_dump('sub_department', $main_dep_data);
                        // die();
                        if ($main_dep_data) {
                    ...
                    ?>
                            <option value="<?php echo $dep->dept_depid; ?>" <?php if ($main_depid == $dep->dept_depid) echo "selected=selected"; ?>><?php echo $dep->dept_depname; ?></option>
                    <?php
                        endforeach;
                    endif;
                    ?>
            ...
            ?>
                <div class="col-md-3" id="subdepdiv" style="<?php echo $displayblock; 
                    ...
                    <select name="recm_subdepartmentid" id="subdepid" class="form-control">

                        <?php 
                           if ($depid != $main_depid) :
                        if (!empty($department)) : ?>
                            <option value="">--select--</option>
                            <?php foreach ($department as $ksd => $sdep) :
                            ?>
                                <option value="<?php echo $sdep->dept_depid; ?>" <?php if ($sdep->dept_depid == $depid) echo "selected=selected"; ?>><?php echo $sdep->dept_depname; ?></option>
                        <?php endforeach;
                        endif; 
                        endif;
                        ?>
                ...
                <table style="width:100%;" class="table purs_table dataTable">
                    <thead>
                        <tr>
                            ...
                            <th width="8%"><?php echo $this->lang->line('vat'); ?>
                                <input type="text" class="form-control allvat" style="width:35px;height:20px" value="13">
                            </th>
                            <th width="10%"><?php echo $this->lang->line('amount'); ?></th>
                            <?php if (ORGANIZATION_NAME == 'NPHL') : ?>
                                <th width="12%"><?php echo $this->lang->line('exp_datebs'); ?>Expiry Date</th>
                    ...
                    <tbody id="purchaseOrderDataBody">
                        ...
                        ?>
                                <tr id="row_<?php echo $i; ?> receivedOrderItem_<?php echo $i; ?>" class="receivedItems">
                                    <input type="hidden" name="recd_receiveddetailid[]" value="<?php echo $rdd->recd_receiveddetailid; ?>">
                                    <input type="hidden" class="itemsid" name="itemsid[]" value="<?php echo $rdd->recd_itemsid; ?>" id="itemsid_<?php echo $i; ?>" />
                                    <input type="hidden" class="order_qty" name="order_qty[]" value="<?php echo $rdd->orderqty; ?>" id="order_qty_<?php echo $i; ?>">

                                    <td><?php echo $i ?></td>
                                    <td><?php echo $rdd->itli_itemcode; ?></td>
                                    <td><?php echo $rdd->itli_itemname ?></td>
                                    <td><?php echo $rdd->unit_unitname ?></td>
                                    <td><?php echo $rdd->recd_purchasedqty ?></td>
                                    <td>
                                        <?php $rdd->recd_purchasedqty; ?>
                                        <input type="text" class="form-control float calamt recqty arrow_keypress" name="received_qty[]" data-fieldid="recqty" value="<?php echo $rdd->recd_purchasedqty ?>" data-id="<?php echo $i; ?>" id="recqty_<?php echo $i; ?>">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control float calamt rate" name="rate[]" id="rate_<?php echo $i; ?>" value="<?php echo $rdd->recd_unitprice ?>" data-id="<?php echo $i; ?>">
                                        <input type="hidden" class="form-control float calamt purchase_rate[]" name="purchase_rate[]" id="purchase_rate_<?php echo $i; ?>" value="<?php echo $rdd->recd_unitprice ?>" data-id="<?php echo $i; ?>">
                                    </td>
                                    <td><input type="text" class="form-control number calamt cc" name="cc[]" id="cc_<?php echo $i; ?>" value="0" data-id="<?php echo $i; ?>"></td>
                                    <td>
                                        <input type="text" class="form-control float calamt discount discountpc arrow_keypress" name="discount[]" data-fieldid="discount" id="discount_<?php echo $i; ?>" value="<?php echo $rdd->recd_discountpc; ?>" data-id="<?php echo $i; ?>">
                                        <input type="hidden" name="disamt[]" value="<?php echo $rdd->recd_discountamt; ?>" id="disamt_<?php echo $i; ?>" class="disamt calamt">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control float calamt vat arrow_keypress" name="vat[]" id="vat_<?php echo $i; ?>" data-fieldid="vat" value="<?php echo $rdd->recd_vatpc; ?>" data-id="<?php echo $i; ?>">
                                        <input type="hidden" name="vatamt[]" value="<?php echo $rdd->recd_vatamt; ?>" id="vatamt_<?php echo $i; ?>" class="vatamt calamt">
                                    </td>
                                    <td>
                                        <input type="text" class="form-control eachtotalamt amt" name="amount[]" value="<?php echo $rdd->recd_amount; ?>" readonly="readonly" id="amt_<?php echo $i; ?>">
                                        <input type="hidden" class="form-control eachratexqty ratexqty" name="ratexqty[]" value="<?php echo $rdd->recd_purchasedqty * $rdd->recd_unitprice; ?>" id="ratexqty_<?php echo $i; ?>">
                                    </td>
                                    </td>
                                    <?php if (ORGANIZATION_NAME == 'NPHL') : ?>
                                        <td>
                                            <input type="text" class="form-control <?php echo DATEPICKER_CLASS; ?> expiry_date " name="expiry_date[]" id="expiry_date_<?php echo $i; ?>" data-id='expiry_date_<?php echo $i; ?>'>
                                        </td>
                                        <?php
                                        if ($this->db->table_exists('xw_temp_temperature')) :
                                            $temperature = $this->general->get_tbl_data('*', 'temp_temperature', false, 'temp_temperatureid', 'ASC');
                                        else :
                                            $temperature = array();
                                        endif;
                                        ?>
                                        <td>
                                            ...
                                            <select class="form-control  temperature" name="temperature[]" id="temperature_<?php echo $i; ?>" data-id='<?php echo $i; ?>'>

                                                <?php
                                                if (!empty($temperature)) :
                                                    foreach ($temperature as $km => $temp) :
                                                ?>
                                                        <option value="<?php echo $temp->temp_temperatureid; ?>"><?php echo $temp->temp_name; ?></option>
                                                <?php
                                                    endforeach;
                                                endif;
                                                ?>
                                    ...
                                    <td>
                                        ...
                                        <textarea class="form-control description" name="description[]" style="margin: 0px; width: 261px; height: 76px; line-height: 18px;" id="description_<?php echo $i; ?>" data-id="<?php echo $i; ?>"><?php echo $recd_descriptiondb; ?></textarea>

                                    </td>
                                    <td><a href="javascript:void(0)" class="btn btn-sm btn-danger btnRemove" id="btnRemove_<?php echo $i; ?>" data-id="<?php echo $i; ?>">
                            ...
                            <fieldset class="pull-right mtop_10 pad-top-14">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <input type="text" class="form-control float totalamount" name="totalamount" value="<?php echo $recm_amount; ?>" id="totalamount" readonly="true" />
                                    </li>
                                    <li>
                                        <label><?php echo $this->lang->line('discount_in_amount'); ?></label>
                                        <input type="text" class="form-control float discountpc" name="discountamt" id="discountamt" value="<?php echo $recm_discount; ?>" readonly="true" />
                                    </li>
                                    ...
                                    <li>
                                        ...
                                        <input type="text" class="form-control float" name="discountamt_overall" id="overall_discount" value="<?php echo $recm_discount; ?>" data-discount="amt" />
                                    </li>

                                    <li>
                                        <label><?php echo $this->lang->line('sub_total'); ?></label>
                                        <input type="text" class="form-control float" name="subtotalamt" id="subtotalamt" value="<?php echo $recm_amount; ?>" readonly="true" />
                                    </li>
                                    <li>
                                        <label><?php echo $this->lang->line('total_tax'); ?> </label>
                                        <input type="text" class="form-control float" name="taxamt" id="taxamt" value="<?php echo $recm_taxamount; ?>" readonly="true" />
                                    ...
                                    <li>
                                        ...
                                        <input type="text" class="form-control float calculaterefund" name="refund" id="refund" value="<?php echo $recm_refund; ?>" placeholder="" />
                                    </li>
                                    <li>
                                        <label><?php echo $this->lang->line('clearance_amt'); ?></label>
                                        <input type="text" class="form-control" name="clearanceamt" id="clearanceamt" value="<?php echo $recm_clearanceamount; ?>">
                                    </li>
                                </ul>
                            </fieldset>
                            ...
                            <fieldset class="pull-right bordered">
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <input type="text" class="form-control float calculateextra" name="insurance" id="insurance" value="<?php echo $recm_insurance; ?>" data-discount="per" />
                                    </li>
                                    <li>
                                        <label><?php echo $this->lang->line('carriage_freight'); ?> :</label>
                                        <input type="text" class="form-control float calculateextra" name="carriage" id="carriage" value="<?php echo $recm_carriagefreight; ?>" data-discount="amt" />
                                    </li>
                                    <li>
                                        <label><?php echo $this->lang->line('packing'); ?> :</label>
                                        <input type="text" class="form-control float calculateextra" name="packing" id="packing" value="<?php echo $recm_packing; ?>" />
                                    </li>
                                    <li>
                                        <label><?php echo $this->lang->line('transport_courier'); ?> :</label>
                                        <input type="text" class="form-control float calculateextra" name="transportamt" id="transportamt" value="<?php echo $recm_transportcourier; ?>" />
                                    </li>
                                    <li>
                                        <label><?php echo $this->lang->line('other'); ?> :</label>
                                        <input type="text" class="form-control float calculateextra" id="otheramt" name="otheramt" value="<?php echo $recm_others; ?>" />

                                    </li>
                                    <li>
                                        <label>&nbsp;</label><input type="text" name="other_description" class="form-control" placeholder="Other Description" value="<?php echo  $recm_othersdescription; ?>">
                                    </li>
                                </ul>
                            </fieldset>
                        </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            <button type="submit" class="btn btn-info  save" data-operation='<?php echo !empty($receive_data_master) ? 'update' : 'save' ?>' id="btnSubmit"><?php echo !empty($receive_data_master) ? 'Update' : 'Save' ?></button>
            <button type="submit" class="btn btn-info savePrint" data-operation='<?php echo !empty($receive_data_master) ? 'update' : 'save ' ?>' id="btnSubmit" data-print="print"><?php echo !empty($receive_data_master) ? 'Update & Print' : 'Save & Print' ?></button>
        </div>
        <div class="col-sm-12">
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        $(document).on('click', '#addAttachments', function() {
            $(".addAttachmentRow").append('<div class="dis_tab mtop_5"><input type="file" name="recm_attachments[]" "/><input type="hidden" name="recm_attach[]"><a class="btn btn-danger table-cell width_30 btnminus"><span class="fa fa-trash"></span></a></div>');
        });
