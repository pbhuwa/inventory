...
<tr id="row_<?php echo $i; ?> receivedOrderItem_<?php echo $i; ?>" class="receivedItems">
    ...
    <?php if (REPORT_SUFFIX == 'star') : ?>
    <td>
        <input type="text" class="form-control batchno" name="batchno[]" value="" id="batch_no_<?php echo $i; ?>">
    </td>
    <td>
        <input type="text" class="form-control <?php echo DATEPICKER_CLASS; ?> expiry_date " name="expiry_date[]"
            id="expiry_date_<?php echo $i; ?>" data-id='expiry_date_<?php echo $i; ?>'>
    </td>
    <?php endif; ?>
    ...
    <td>
        ...
        <select class="form-control  temperature" name="temperature[]" id="temperature_<?php echo $i; ?>"
            data-id='<?php echo $i; ?>'>
    ...
    <td>
        <textarea class="form-control description" name="description[]"
            style="margin: 0px; width: 261px; height: 76px; line-height: 18px;" id="description_<?php echo $i; ?>"
