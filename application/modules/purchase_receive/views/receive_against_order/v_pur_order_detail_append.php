    ...
    <table style="width:100%;" class="table purs_table dataTable">
        ...
        <tbody id="purchaseOrderDataBody">
            ...
            <tr id="row_<?php echo $i; ?> receivedOrderItem_<?php echo $i;?>" class="receivedItems">
                ...
                <td>
                    <input type="text" class="form-control number calamt recqty arrow_keypress" data-fieldid="recqty" name="received_qty[]" value="0"  data-id='<?php echo $i; ?>' id="recqty_<?php echo $i; ?>" autocomplete="off"> 
                </td>
               <!--  <td>
                  ...
                  <?php if(ORGANIZATION_NAME == 'NPHL'): ?>
                    ...
                    <?php 
                        if($this->db->table_exists('xw_temp_temperature')):
                            $temperature=$this->general->get_tbl_data('*','xw_temp_temperature',false,'temp_temperatureid','ASC');
                        else:
                            $temperature = array();
                        endif;
                    ?>
