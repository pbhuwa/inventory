	...
	<div class="headerWrapper">
		...
		<table class="jo_tbl_head">
			<tr>
				...
				?>
					<td>
						<span style="font-size: 12px;" class="<?php echo FONT_CLASS; ?>"> चलान न </span> :
						<span class="bb"> 
						<?php 
							$challanno = array();
							foreach($challan_no as $ch){
								$challanno[] = $ch->chma_challanrecno;
							}
	...
	<table width="100%" class="amount-table">
		<tbody>
			<tr>
				...
				?>
				<td style="border-right: 1px solid #000;"><?php echo !empty($overall_discount)?number_format($overall_discount,2):''; ?></td>
			</tr>
			...
			<tr>
				...
				<?php
					$overall_vat = !empty($direct_purchase_master[0]->recm_taxamount)?$direct_purchase_master[0]->recm_taxamount:0;
				?>
				<td style="border-right: 1px solid #000;"><?php echo !empty($overall_vat)?number_format($overall_vat,2):''; ?></td>
			</tr>
