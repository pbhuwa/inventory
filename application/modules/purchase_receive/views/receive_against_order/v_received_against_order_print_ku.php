...
<style> 
  ...
  h5 {
    ...
    .ku_table td,
        ...
        /*.ku_table tbody tr:not(:last-child):not(.no_border){
            border-bottom: 1px solid !important;
        }*/
        /*.ku_table tbody tr:not(:nth-last-child(-n+5)):not(.no_border){
            border-bottom: 1px solid !important;
        }*/
        .ku_table tbody tr:not(.no_border){
            border-bottom: 1px solid !important;
        }
        /*
...
<div class="jo_form organizationInfo">
    ...
    <table class="ku_table table table-borderless" width="100%" style="margin:5px 0 1.5rem; overflow-x:auto !important;">
        <thead>
            <tr>
                ...
                <th style="text-align: center !important;" width="5%">VAT</th>
            ...
            <?php 
             $sum_totalAmt=0;
                if($req_detail_list){
                    ...
                    foreach ($req_detail_list as $key => $direct) { 
                        if ($key == ($row_count - 1)) {
                            $no_border_class = "no_border";
                        }
                        ?>
                        <tr class="<?php echo $no_border_class; ?>">
                            <td class="td_cell">
                                <?php echo !empty($direct->itli_itemcode)?$direct->itli_itemcode:''; ?>
                            </td>
                            <td style="width:30%;">
                        ...
                        if($row_count < 11): ?>
                            <tr style="border-top: none !important" class="no_border">
                                <td class="td_empty"></td>
                                <td class="td_empty"></td>
                                <td class="td_empty"></td>
                                <td class="td_empty"></td>
                ...
                <tr class="no_border">
                    <th class="border0" colspan="4"></th>
                    <th class="border0" align="center" class=""><h6 class="ku_double-border" style="padding:0 !important;margin:0 auto !important">Total Amount :</h6></th>

                    <th style="border-top:1px solid #000 !important;border-bottom:1px solid #000 !important;padding:0 !important;margin:0 auto !important"> <?php echo !empty($sum_totalAmt)?number_format($sum_totalAmt,2):'0.00'; ?></th>

                    <th style="text-align: center !important;border-top:1px solid #000 !important;border-bottom:1px solid #000 !important;padding:0 !important;margin:0 auto !important"><?php echo !empty($vatsum)?number_format($vatsum,2):'0.00'; ?></th>
                    <th class="border0" colspan="2"></th>
                </tr>
                <tr class="no_border">
                ...
                ?>
                    <th class="border0" colspan="4"></th>
                    <th  class="border0" align="center" class=""><h6 style="margin:0 auto!important;padding:0 !important;">Transportation Fee :</h6></th>
                    <th colspan="2"><?php echo !empty($direct_purchase_master[0]->recm_transportcourier)? number_format($direct_purchase_master[0]->recm_transportcourier,2):'0.00'; ?></th>
                    <th class="border0" colspan="2"></th>
                <?php endif; ?>
                </tr>
                <tr class="no_border">
                    <?php if (!empty($direct->recm_discount) && $direct->recm_discount != '0'): ?>
                    <th class="border0" colspan="4"></th>
                    <th class="border0" align="center">
                        <h6 style="margin:0 auto!important;padding:0 !important;">Discount :</h6></th>
                    
                    <th colspan="2">
                        <?php echo !empty($direct->recm_discount)?number_format($direct->recm_discount,2):'0.00'; ?></th>
                    <th class="border0" colspan="2"></th>
                    <?php endif;?>
                </tr>
                <tr class="no_border">
                     ...
                     <?php  if(!empty($direct->recm_others) && $direct->recm_others != '0.00'): ?>
                    <th class="border0" colspan="4"></th>
                    <th class="border0" align="center"><h6 style="font-size: 11px !important;margin:0 auto!important;padding:0 !important;"><?php $other_desc= !empty($direct->recm_othersdescription)?$direct->recm_othersdescription:''; 
                        if(!empty($other_desc)){
                          echo $other_desc;
                        }else{
                            echo "Others";
                        ...
                        ?>:</h6></th>
                   <th colspan="2"><?php echo !empty($direct->recm_others)?number_format($direct->recm_others,2):'0.00'; ?></th>
                   <th class="border0" colspan="2"></th>
                ...
                <tr class="no_border">
                    <th class="border0" colspan="4"></th>
                    <th class="border0" align="center" class=""><h6 style="padding:0 !important;margin:0 auto !important" class="ku_double-border">Grand Total :</h6></th>
                    <th colspan="2"><h6  class="ku_double-border" style="padding:0 !important;margin:0 auto !important"><?php echo !empty($total)?number_format($total,2):'0.00'; ?></h6></th>
                    <th class="border0" colspan="2"></th>
                </tr>
            </tbody>
    </table>
