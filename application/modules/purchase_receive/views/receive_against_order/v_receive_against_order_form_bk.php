...
<form method="post" id="FormReceiveOrderItem" action="<?php echo base_url('purchase_receive/receive_against_order/save_received_items'); ?>" class="form-material form-horizontal form" data-reloadurl="<?php echo base_url('purchase_receive/receive_against_order/form_direct_received_items'); ?>" enctype="multipart/form-data"  accept-charset="utf-8" >
    <div id="orderData">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <div class="dis_tab">
                    ...
                    <!-- <a href="javascript:void(0)" class="table-cell frm_add_btn width_30" id="btnSearchOrderno" ><i class="fa fa-search"></i></a> -->
                    <a href="javascript:void(0)" class="table-cell width_30 btn btn-success" id="btnSearchOrderno" ><i class="fa fa-search"></i></a>
                    &nbsp;
                 <!--    <a href="javascript:void(0)" data-id="0" data-displaydiv="Issue" data-viewurl="<?php echo base_url('purchase_receive/receive_against_order/load_order_list'); ?>" class="view table-cell frm_add_btn width_30" data-heading="Load Order list" id="orderload"><i class="fa fa-upload"></i></a> -->
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <select name="supplierid" class="form-control required_field select2" readonly="readonly" id="supplierid" >
                    <option value="">---select---</option>
                    <?php
                        if($supplier_all):
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <input type="text" name="order_date" class="form-control <?php echo DATEPICKER_CLASS;?> date"  placeholder="Order Date" id="OrderDate" value="" readonly>
        ...
        <div class="form-group">
            <div class="col-md-3 col-sm-3">
                ...
                <input type="text" name="received_no" class="form-control"  placeholder="Received No." value="<?php echo !empty($received_no)?$received_no:''; ?>" id="receivedno">
                <span class="errmsg"></span>
            </div>
            <div class="col-md-3 col-sm-3">
                            ...
                            <fieldset class="pull-right mtop_10 pad-top-14">
                                <ul>
                                    ...
                                    <li>
                                        ...
                                        <input type="text" class="form-control float vatpc" name="taxamt" id="taxamt" value="0" readonly="true" />

                                    </li>
                                    <li>
                                        <label>
                                            <?php echo !empty($this->lang->line('overall_vatamount'))?$this->lang->line('overall_vatamount'):'Overall vatamount'; ?>
                                        </label>
                                        <input type="text" class="form-control float" name="taxamt" id="overall_vatamount" value="0" data-discount="amt" / >
                                    </li>
                                    <li>
...
<script type="text/javascript">
    ...
    $(document).on('keyup change','.calamt',function(){
        ...
        var clearanceamt = subtotal+stotalvat+extra+refund-overall_discount +overall_vatamount;
        ...
        $('#discountamt').val(stotoaldis.toFixed(2));
        $('#subtotalamt').val(subtotal.toFixed(2));
        // $('#overall_vatamount').val(subtotal.toFixed(2));
        // $('#totalamount').val(stotal.toFixed(2));
    ...
    $(document).on('keyup change','#overall_vatamount',function(){
        var vatamount = $('#overall_vatamount').val();
...
<script type="text/javascript">
    ...
    $(document).on('change keyup','.discountpc',function(){
        ...
        valid_total = checkValidValue(total);
            ...
            console.log('valid total Discount: ' +valid_total);
...
<script type="text/javascript">
    $(document).off('change keyup','.vatpc');
    $(document).on('change keyup','.vatpc',function(){
        var disArray = [];
        i = 0;
        total = 0;
        $('.vatpc').each(function(i){  
            field_discount = this.value;
        ...
        valid_total = checkValidValue(total);
            ...
            console.log('valid total VAT: ' +valid_total);
