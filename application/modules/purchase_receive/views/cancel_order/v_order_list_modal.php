...
<div class="white-box pad-5" id="detailListBox">
    <?php $this->load->view('cancel_order/v_order_detail_modal');?>
</div> 
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var dataurl = base_url+"purchase_receive/cancel_order/get_order_list_for_cancel";
            ...
            return (function() {
                ...
                return function(e) {
                    if (alreadyclicked) {
                        ...
                        $('input#orderNumber').val(order_no);
                        getDetailList(masterid, 'main_form');

                        setTimeout(function(){
                            $('#srchCancelOrder').click();
                        },100);
        ...
        $(document).off('click','.serverDatatable tbody tr', $.singleDoubleClick);
