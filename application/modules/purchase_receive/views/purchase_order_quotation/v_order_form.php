<div class="form-group">
    ...
    <div class="container row p-row">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <div class="dis_tab">
                <input type="text" name="req_no" class="form-control number enterinput required_field"  placeholder="Enter Requistion Number" value="<?php echo $puor_requno; ?>" id="requisitionNumber" data-targetbtn="btnSearchReqno">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <div class="dis_tab">
            <select name="supplier" class="form-control select2 required_field changeSupplier" id="supplierid">
        ...
        <div class="col-md-3 col-sm-4"><!-- puor_order_for -->
            ...
            <input type="text" class="form-control required_field"  name="order_number"  value="<?php echo !empty($orderno)?$orderno:$order_no[0]->ordnumb+1;?>" placeholder="Enter Order Number" readonly>
        </div>
