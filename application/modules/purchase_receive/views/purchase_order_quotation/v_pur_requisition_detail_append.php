        ...
        <tbody id="purchaseDataBody" class="requisitionOrder loadedItems">
            ...
            ?>
                 <tr class="stockBdy" id="stockBdy_1" data-id='1'>
                    ...
                    <td>
                        <input type="text" name="discountpc[]" class="form-control float calculateamt discountpc"  placeholder="Discount Pc" value="<?php echo !empty($prd->discount)?$prd->discount:0; ?>" id="discountpc_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>">
                    </td>
                    <td>
                        <input type="text" class="form-control float multiInsert calculateamt vatpc" name="puit_taxid[]" id="puit_taxid_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" value="<?php echo !empty($prd->vatpc)?$prd->vatpc:0; ?>">
                    </td>
                    <td>
                    ...
                    <td>
                        <input type="text" name="tender_no[]" class="form-control float"  placeholder="Tender Number" value="<?php echo !empty($prd->qude_quotationmasterid)?$prd->qude_quotationmasterid:0; ?>" id="tender_no_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>">
                    </td>
                    <td>
