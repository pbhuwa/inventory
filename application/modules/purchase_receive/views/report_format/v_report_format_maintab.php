...
<div class="row wb_form">
    <div class="col-sm-12">
        <div class="white-box">
            <h3 class="box-title">Report Format</h3>
            <div class="ov_report_tabs pad-5 tabbable">
                ...
                <div class="ov_report_tabs page-tabs margin-top-270 pad-5 tabbable">
                    <?php if($report_type==$report_type): ?>      
                        <div id="dtl_rpt" class="tab-pane fade in  <?php if($report_type==$report_type) echo "active"; ?>">
                            <div  id="FormDiv_report_type" class="formdiv frm_bdy">
                                <?php $this->load->view('report_format/v_'.$report_type);?>
                            </div>
                        </div>
                    <?php endif; ?>
