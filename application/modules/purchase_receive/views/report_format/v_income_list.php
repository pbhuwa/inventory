            ...
            <table class="table table-striped alt_table">
                 <thead>
                    ...
                    <tr>
                         ...
                         <td rowspan="1"><a href="javascript:void(0)" data-viewreport='<?php echo $fiscalyrs.'@'.$rpt->yrs.'-'.$rpt->mnth.'@'.$branch_id ?>' class="view_detail_rpt" data-displayid='displayReportDiv' data-url='<?php echo ('/purchase_receive/report_format/monthly_income_only'); ?>' style="font-weight: bold; color: black;"><?php echo $rpt->yrs.'-'.$this->general->get_monthname($rpt->mnth,'np'); ?></a></td> 
