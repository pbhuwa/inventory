<div class="searchWrapper">
    ...
    <div class="pull-right" style="margin-top:15px;">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="purchase_receive/purchase_order_details/purchase_order_details_list" data-location="purchase_receive/purchase_order_details/exportToExcel" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="purchase_receive/purchase_order_details/purchase_order_details_list" data-location="purchase_receive/purchase_order_details/generate_pdf" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
    <div class="clear"></div>
</div>
...
<div class="pad-5 mtop_10">
    <h3 class="box-title"><?php echo $this->lang->line('purchase_order_detail_list'); ?></h3>
        ...
        <table id="myTable" class="table table-striped ">
            <thead>
                <tr>
                    ...
                    <th width="4%"><?php echo $this->lang->line('net_amount'); ?></th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataurl = base_url + "purchase_receive/purchase_order_details/purchase_order_details_list";
        var message = '';
