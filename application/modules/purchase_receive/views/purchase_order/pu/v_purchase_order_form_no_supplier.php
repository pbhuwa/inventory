...
<form method="post" id="FormReceiveOrderItem" action="<?php echo base_url('purchase_receive/purchase_order/save_order_item'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('purchase_receive/purchase_order/index/reload'); ?>'>
    <div id="orderData">
        <?php $this->load->view('v_order_form_no_supplier');?>
    </div>
                ...
                <table style="width:100%;" class="table dataTable dt_alt purs_table">
                    ...
                    <tbody id="purchaseDataBody" class="requisitionOrder">
                        <?php if(!empty($orderdetails)) { 
                            ...
                            <tr class="orderrow orderrow_<?php echo $ord->pure_purchasereqid; ?>" id="orderrow_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>'>
                                <td>
                                ...
                                <td>
                                    <div class="dis_tab"> 
                                        ...
                                        <input type="hidden" class="purd_reqdetid" name="purd_reqdetid[]" data-id='<?php echo $key+1; ?>' value="<?php echo $ord->pude_puordeid; ?>" id="purd_reqdetid_<?php echo $key+1; ?>">
                                         ...
                                         <input type="hidden" class="pude_orderid" name="pude_orderid[]" data-id='<?php echo $key+1; ?>' value="<?php echo $ord->pude_puordeid; ?>" id="pude_orderid_<?php echo $key+1; ?>">
                                ...
                                <td>  
                                    <input type="text" class="form-control puit_unitid" id="puit_unitid_<?php echo $key+1; ?>" name="puit_unitid[]"  data-id='<?php echo $key+1; ?>' value="<?php echo $ord->unit_unitname; ?>" readonly="readonly" />
                                </td>
                              <!--   <?php// $tot = ($ord->purd_remqty) * ($ord->itli_salesrate); ?> -->
                                <td>
                                    <input type="text" class="form-control multiInsert float stock_qty" name="stock_qty[]" id="stock_qty_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" placeholder="Stock Qty" readonly="true" value="<?php echo $ord->pude_stockqty; ?>">
                                </td>
                                <td>
                                    <input type="text" class="form-control multiInsert float calculateamt puit_qty required_field" name="puit_qty[]" id="puit_qty_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" value="<?php echo $ord->pude_quantity; ?>">
                                </td>
                                <td>
                                ...
                                <td>
                                    <input type="text" class="form-control float multiInsert calculateamt puit_taxid vatpc" name="puit_taxid[]" id="puit_taxid_<?php echo $key+1; ?>" value="<?php echo !empty($ord->pude_vat)?$ord->pude_vat:'0' ; ?>" data-id="<?php echo $key+1; ?>" >
                                </td>
                                <td>
                        ...
                        <?php } }else{ 
                           ...
                           foreach ($purchase_requisition as $key => $pur) { ?>
                            <tr class="orderrow" id="orderrow_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>'>
                                <td>
                                    <input type="text" class="form-control s_no" id="s_no_<?php echo $key+1; ?>" value="<?php echo $key+1; ?>" readonly/>
                                </td>
                                <td>
                                    <input type="text" class="form-control itemscode" id="itemscode_<?php echo $key+1; ?>"  data-id='<?php echo $key+1; ?>' value="<?php echo $pur->itli_itemcode; ?>" readonly />
                                </td>
                                <td>
                                    <div class="dis_tab"> 

                                        <input type="text" class="form-control itemname enterinput " id="itemname_<?php echo $key+1; ?>" name="itemname[]"  data-id='<?php echo $key+1; ?>' data-targetbtn='view' value="<?php echo $pur->itli_itemname; ?>" readonly />

                                        <input type="hidden" class="qude_itemsid" name="qude_itemsid[]" data-id='<?php echo $key+1; ?>' id="qude_itemsid_<?php echo $key+1; ?>" value="<?php echo $pur->purd_itemsid; ?>">
                                        
                                        <input type="hidden" class="purd_reqdetid" name="purd_reqdetid[]" data-id='<?php echo $key+1; ?>' value="<?php echo $pur->purd_reqdetid; ?>" id="purd_reqdetid_<?php echo $key+1; ?>">
                                        <input type="hidden" class="pude_orderid" name="pude_orderid[]" data-id='<?php echo $key+1; ?>' value="<?php echo !empty($ord->pude_puordeid)?$ord->pude_puordeid:''; ?>" id="pude_orderid_<?php echo $key+1; ?>">

                                        <a href="javascript:void(0)" class="btn btn-sm btn-default table-cell width_30 view" data-heading='Item List' data-viewurl='<?php echo base_url('stock_inventory/item/list_item_with_stock_requisition'); ?>' data-id='<?php echo $key+1; ?>' id="view_<?php echo $key+1; ?>"><strong>...</strong></a>
                                    </div>
                                </td>
                                <td>  
                                    <input type="text" class="form-control puit_unitid" id="puit_unitid_<?php echo $key+1; ?>" name="puit_unitid[]"  data-id='<?php echo $key+1; ?>' value="<?php echo $pur->purd_unit; ?>" readonly="readonly" />
                                </td>
                              <!--   <?php// $tot = ($ord->purd_remqty) * ($ord->itli_salesrate); ?> -->
                                <td>
                                    <input type="text" class="form-control multiInsert float stock_qty" name="stock_qty[]" id="stock_qty_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" placeholder="Stock Qty" readonly="true" value="<?php echo $pur->purd_stock; ?>">
                                </td>
                                <td>
                                    <input type="text" class="form-control multiInsert float calculateamt puit_qty required_field" name="puit_qty[]" id="puit_qty_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" value="<?php echo $pur->purd_qty; ?>">
                                </td>
                                <td>
                                    <input type="text" class="form-control puit_unitprice float multiInsert calculateamt puit_unitprice" name="puit_unitprice[]" id="puit_unitprice_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>"  value="<?php echo $pur->itli_purchaserate; ?>">
                                </td>
                                <td>
                                    <input type="text" name="discountpc[]" class="form-control float calculateamt"  placeholder="Discount Pc" id="discountpc_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" value="0.00">
                                </td>
                                <td>
                                    <input type="text" class="form-control float multiInsert calculateamt puit_taxid vatpc" name="puit_taxid[]" id="puit_taxid_<?php echo $key+1; ?>" value="13" data-id="<?php echo $key+1; ?>" >
                                </td>
                                <td>
                                    <?php $total_amt=($pur->itli_purchaserate)*1.13; ?>
                                    <input type="text" class="form-control totalamount float multiInsert puit_total calculateamt" name="puit_total[]" id="puit_total_<?php echo $key+1; ?>" value="<?php echo $total_amt; ?>" data-id="<?php echo $key+1; ?>" readonly>
                                </td>
                                <!--<td>
                                    <input type="text" class="form-control   multiInsert " name="free[]" id="free_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" value="<?php echo $ord->pude_free; ?>" >
                                </td> -->
                                <td>
                                    <input type="text" name="tender_no[]" class="form-control float"  placeholder="Tender Number"  id="tender_no_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>"  value="">
                                </td>
                                <td>
                                    <input type="text" class="form-control multiInsert jump_to_add" name="description[]" id="description_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>" placeholder="Remarks" value="<?php echo $pur->purd_remarks; ?>">
                                </td>
                                 <td>
                                    <a href="javascript:void(0)" class="btn btn-sm btn-danger btnRemove" id="btnRemove_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>'>
                                        <i class="fa fa-remove"></i>
    ...
    <div class="form-group">
        <div class="col-md-12"> 
            ...
            <button type="submit" class="btn btn-info  save" data-operation='<?php echo !empty($purchase_order_book_list[0])?'update':'save' ?>' id="btnSubmit" ><?php echo !empty($purchase_order_book_list[0])?'':'Save' ?></button>
             <button type="submit" class="btn btn-info savePrint" data-operation='<?php echo !empty($requisition_approved)?'update':'save ' ?>' id="btnSubmit" data-print="print"><?php echo !empty($requisition_approved)?'Approve & Print':'Save & Print' ?></button>
            <?php //} ?>
        </div>
        <div class="col-sm-12">
        ...
        $.ajax({
            ...
            success: function(jsons){
                ...
                if(main_form == 'main_form'){
                    ...
                    if(data.status == 'success'){
                        $(displaydiv).empty().html(data.tempform);
                        $('#purchasereqmasterid').val(masterid);
                        $('.calculateamt').change();
                        // alert('test');
                    }
                }
...
<script type="text/javascript">
    $(document).off('blur','.vatpc');
    $(document).on('blur','.vatpc',function(){
        var id = $(this).data('id');
