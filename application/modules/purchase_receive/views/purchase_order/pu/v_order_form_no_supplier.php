...
<div class="form-group">
    ...
    <div class="container row p-row">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <input type="hidden" name="has_no_supplier" value="Y">
        </div>
        <?php
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <div class="dis_tab" style="display: flex;">
                ...
                <input style="width: 60px" type="text" name="req_no" class="form-control number enterinput required_field"  placeholder="Enter Requistion Number" value="" id="requisitionNumber" data-targetbtn="btnSearchReqno">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <div class="dis_tab">
            <select name="supplier" id="order_supplierid" class="form-control select2" >
