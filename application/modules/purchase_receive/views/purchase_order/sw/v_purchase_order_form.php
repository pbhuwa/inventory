                ...
                <table style="width:100%;" class="table dataTable dt_alt purs_table">
                    <thead>
                        <tr>
                            ...
                            <th width="5%"> <?php echo $this->lang->line('select_vat'); ?> (%)<input type="text" class="form-control allvat" style="width: 48px;height:20px;"> </th>
                            ...
                            <tr class="orderrow orderrow_<?php echo $ord->pure_purchasereqid; ?>" id="orderrow_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>'>
                                ...
                                <td>
                                    <div class="dis_tab"> 
                                        ...
                                        <input type="text" class="form-control itemname enterinput " id="itemname_<?php echo $key+1; ?>" name="itemname[]"  data-id='<?php echo $key+1; ?>' data-targetbtn='view' value="<?php echo htmlspecialchars($ord->itli_itemname, ENT_QUOTES); ?>" readonly />
                              ...
                              <!--   <?php// $tot = ($ord->purd_remqty) * ($ord->itli_salesrate); ?> -->
                                ...
                                <td>
                                    <input type="text" class="form-control float multiInsert calculateamt puit_taxid vatpc" name="puit_taxid[]" id="puit_taxid_<?php echo $key+1; ?>" value="<?php echo !empty($ord->pude_vat)?sprintf('%g',$ord->pude_vat):'0' ; ?>" data-id="<?php echo $key+1; ?>" >
                                </td>
                                <td>
                            ...
                            <tr class="orderrow" id="orderrow_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>'>
                                ...
                                <td>
                                    <div class="dis_tab"> 
                                        ...
                                        <input type="text" class="form-control itemname enterinput " id="itemname_<?php echo $key+1; ?>" name="itemname[]"  data-id='<?php echo $key+1; ?>' data-targetbtn='view' value="<?php echo htmlspecialchars($pur->itli_itemname,ENT_QUOTES); ?>" readonly />
...
$(document).off('keyup blur', '.allvat');
    $(document).on('keyup blur', '.allvat', function(e) {
        // $('.vat')
        var allvat = $(this).val();
        // alert(allvat);
        // return false;
