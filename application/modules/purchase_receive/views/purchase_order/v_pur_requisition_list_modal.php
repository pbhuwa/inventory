                ...
                <table class="table table-striped dt_alt dataTable serverDatatable" id="myitemListTable" tabindex="1" data-tableid="#myitemListTable" data-type="<?php echo $this->input->post('type');?>">
                    <thead>
                        <tr>
                            ...
                            <th width="10%">PR.<?php echo $this->lang->line('req_no'); ?></th>
...
<div class="white-box pad-5" id="detailListBox">
    <?php $this->load->view('purchase_order/v_pur_requisition_detail_modal');?>
</div> 
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var materialtypeid = $('#material_type').val();
        ...
        var dataurl = base_url+"purchase_receive/purchase_order/get_pur_requisition_list";
        ...
        var dtablelist = $(tableid).dataTable({
            ...
            "fnServerParams": function (aoData) {
                ...
                aoData.push({ "name": "materialtypeid", "value": materialtypeid });
            },
