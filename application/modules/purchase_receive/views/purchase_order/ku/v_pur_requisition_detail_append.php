<?php
            ...
            ?>
                 <tr class="orderrow orderrow_<?php echo $purchasereqid; ?>" id="orderrow_<?php echo $key+1; ?>" data-id='<?php echo $key+1; ?>'>
                    ...
                    <td>
                        <input type="text" class="form-control puit_unitprice float multiInsert calculateamt puit_unitprice arrow_keypress" data-fieldid="puit_unitprice" name="puit_unitprice[]" id="puit_unitprice_<?php echo $key+1; ?>" data-id="<?php echo $key+1; ?>"  value="<?php echo $prd->itli_purchaserate; ?>">
                    </td>
                    <td>
