...
<div class="form-group">
    ...
    <?php 
    $pur_reqmaster=!empty($purreqmasterid)?$purreqmasterid:''; 
    ...
    <div id="purmasteriddiv">
        ...
        if(!empty($purreqid)):
                        ...
                        $pur_reqarr=$this->db->select('pure_purchasereqid,pure_streqno as pure_reqno')
    ...
    <div class="container row p-row">
        ...
        <div class="col-md-3 col-sm-4">
            ...
            <div class="dis_tab" style="display: flex;">
                ...
                <input style="width: 60px" type="text" name="req_no" class="form-control number enterinput required_field"  placeholder="Enter Requistion Number" value="<?php echo $reqval; ?>" id="requisitionNumber" data-targetbtn="btnSearchReqno">
