...
<div class="jo_form organizationInfo">
	...
	<div class="footerWrapper">
		<table class="jo_footer" style="width: 100%;  padding-left: 15px;" border= "1">
			<tfoot>
				<tr>
					<td>
						<table style="width: 100%;" class="inner-table" style="padding:5px !important; margin: 5px !important;">
							...
							<tr>
								...
								<td style="text-align: left;font-size: 11px;padding-top: 25px;">शाखा प्रमुखको दस्तखत: 
									<!-- <span class="dateDashedLine"></span></span> -->
									<span class="dateDashedLine" style="display: inline-block !important;"></span></span></td>
								<td style="text-align: left;font-size: 11px;padding-top: 25px;">कार्यालय प्रमुखको दस्तखत: 
									<!-- <span class="dateDashedLine"></span></span> -->
