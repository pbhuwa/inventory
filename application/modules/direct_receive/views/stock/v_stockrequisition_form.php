...
<form method="post" id="FormStockRequisition" action="<?php echo base_url('stock_inventory/stock_requisition/save_requisition'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('stock_inventory/stock_requisition'); ?>' >
    <input type="hidden" name="id" value="<?php //echo!empty($item_data[0]->itli_itemlistid)?$item_data[0]->itli_itemlistid:'';  ?>">
        <div class="form-group">
            <div class="col-md-4">
                <?php $itemcode=!empty($item_data[0]->rema_reqno)?$item_data[0]->rema_reqno:''; ?>
                <label for="example-text">REQ NO :<span class="required">*</span>:</label>
                <input type="text" class="form-control" name="rema_reqno"  value="<?php echo $itemcode; ?>" placeholder="Enter REQ Number">
            </div>
            <div class="col-md-4">
