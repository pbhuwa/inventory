...
class Direct_issue_mdl extends CI_Model
{
	...
	public function save_direct_issue()
	{
		...
		$issue_no = $this->general->generate_invoiceno('sama_invoiceno','sama_invoiceno','sama_salemaster',$invoice_no_hand_prefix,DIRECT_ISSUE_NO_LENGTH, array('sama_ishandover'=>'Y'),'sama_locationid');
		...
		if(!empty($cur_fiscalyrs_invoiceno)){
			...
			$invoice_no_prefix=INVOICE_NO_PREFIX.CUR_FISCALYEAR;
				...
				// $this->general->generate_invoiceno('sama_invoiceno','sama_invoiceno','sama_salemaster',$invoice_no_prefix,INVOICE_NO_LENGTH);

				 $issue_no = $this->general->generate_invoiceno('sama_invoiceno','sama_invoiceno','sama_salemaster',$invoice_no_prefix,INVOICE_NO_LENGTH,false,'sama_locationid','sama_salemasterid','S','DESC');
