...
<form id="FormConsumption"  action=""  class="form-material form-horizontal form">
	<div class="form-group">
		...
		<div class="col-md-3">
			...
			<button type="submit" class="btn btn-info searchReport mtop_0" data-url="issue_consumption/consumption_report/search_consumption"><?php echo $this->lang->line('search'); ?></button>
		</div>
	</div>
</form>
</div>
