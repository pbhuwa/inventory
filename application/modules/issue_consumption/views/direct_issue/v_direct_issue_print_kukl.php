...
<div class="jo_form organizationInfo">
	...
	<!-- <div class="footerWrapper"> -->
		<table class="jo_footer" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #000;border-top: 0px;">
		    ...
		    <tr>
		        <td width="10%"></td>
		        <td width="40%" style="white-space: nowrap;" style="padding-top: 0px;">नाम: 
		        	<?php 
		    ...
		    <tr>
		        <td width="10%"></td>
		        <td width="40%" style="white-space: nowrap;" style="padding-top: 0px;">मिति: 
		...
		<table class="jo_footer" style="padding-top: 0px;padding-bottom: 0px;border: 1px solid #000;border-top: 0px;">
			<tr>
				<td colspan="4">
		...
		<table class="jo_footer" style="padding-top: 0px;padding-bottom: 0px;border: 1px solid #000;border-top: 0px;page-break-inside: avoid;">
			<tr>
				<td colspan="4">
