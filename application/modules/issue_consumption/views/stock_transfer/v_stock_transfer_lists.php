...
<div class="searchWrapper">
    ...
    <div class="">
        <form class="col-sm-8">
                ...
                <?php $frm= $this->lang->line('from'); ?>
            
            <?php echo $this->general->location_option(2,'locationid','locationid',false,$frm); ?>
            <?php $to= $this->lang->line('to'); ?>
         
             <?php echo $this->general->location_option(2,'locationid2','locationid2',false,$to); ?>
            <div class="col-md-2">
        ...
        <div class="col-sm-4">
            <div class="white-box pad-5">
                <ul class="index_chart">
                    ...
                    <li>
                        <div class="warning"></div><a href="javascript:void(0)" data-approvedtype='approved' class="approvetype"> <?php echo $this->lang->line('transfer'); ?></a> 
        ...
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="issue_consumption/stock_transfer/stock_transfer_list" data-location="issue_consumption/stock_transfer/search_stock_transfer_excel" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="issue_consumption/stock_transfer/stock_transfer_list" data-location="issue_consumption/stock_transfer/search_stock_transfer_pdf" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
    </div>
    <div class="clear"></div>
</div>
        ...
        <table id="myTable" class="table table-striped">
            <thead>
                <tr class="tr_issue">
                    ...
                    <th width="7%"><?php echo $this->lang->line('transfer_date'); ?></th>
                    ...
                    <th width="13%"><?php echo $this->lang->line('remarks'); ?></th>
                    <th width="6%"><?php echo $this->lang->line('action'); ?></th> 
                </tr>
            </thead>
            <tbody>
            </tbody>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var locationid2=$('#locationid2').val();
        var apptype='';
        var dataurl = base_url+"issue_consumption/stock_transfer/stock_transfer_list";
        var message='';
        ...
        "fnServerParams": function (aoData) {
            ...
            aoData.push({ "name": "locationid2", "value": locationid2 });
        ...
        $(document).on('click', '#searchByDate', function() {
            ...
            dtablelist.fnDraw();
            get_other_ajax_data(otherlinkdata,frmDate,toDate,locationid,locationid2);  
        });
        ...
        function get_other_ajax_data(action,frmdate=false,todate=false,othertype=false,othertype1=false){
            var returndata=[];   
            $.ajax({
                type: "POST",
                url: action,
                ...
                dataType: 'html',
                data:{frmdate:frmdate,todate:todate,othertype:othertype,othertype1:othertype1} ,
