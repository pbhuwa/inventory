    ...
    <div id="issueDetails">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3">
                ...
                $sama_mattype = !empty($new_issue[0]->sama_mattypeid) ? $new_issue[0]->sama_mattypeid : 1;
                ...
                <select name="sama_mattypeid" id="mattypeid" class="form-control chooseMatType required_field">
                    ...
                    ?>
                            ...
                            <option value="<?php echo $mat->maty_materialtypeid; ?>" <?php if ($sama_mattype == $mat->maty_materialtypeid) echo "selected=selected"; ?>> <?php echo $mat->maty_material; ?></option>
                                ...
                                if ($new_issue) :
                                    ...
                                    foreach ($new_issue as $key => $isu) { ?>
                                        ...
                                        <td data-label="Items Code">
                                            ...
                                            <input type="text" class="form-control float rede_code calculateamt" id="rede_code_1" name="rede_code[]" value="<?php //echo $isu->rede_itemsid;
                                                                                                                                                            ?>" data-id='1' readonly>
