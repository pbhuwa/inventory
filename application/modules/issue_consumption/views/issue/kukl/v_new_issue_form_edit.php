...
<form method="post" id="FormIssueNew" action="<?php echo base_url('issue_consumption/new_issue/save_new_issue'); ?>" data-reloadurl="<?php echo base_url('issue_consumption/new_issue/form_new_issue');?>" class="form-material form-horizontal form">
    ...
    <div id="issueDetails">
        ...
        <?php $departmentid=!empty($issue_master[0]->sama_depid)?$issue_master[0]->sama_depid:''; ?>
        <select id="depnme" name="sama_depid"  class="form-control required_field" disabled="disabled" >
    ...
    <div class="col-md-3 col-sm-4">
       ...
       <select name="sama_fyear" class="form-control required_field" id="fyear" disabled="disabled" >
           <?php
             if($fiscal_year): 
        ...
        <table style="width:100%;" class="table purs_table dt_alt dataTable">
            <thead>
                <tr>
                    ...
                    <th scope="col" width="10%"> <?php echo $this->lang->line('avl_qtys'); ?></th>
                ...
                <tbody id="orderBody">
                        ...
                        <input type="hidden" name="sade_saledetailid[]" value="<?php echo $isu->sade_saledetailid ?>">
                         <input type="hidden" name="sade_mattransdetailid[]" value="<?php echo $isu->sade_mattransdetailid ?>">
                          ...
                          <input type="hidden" name="stockqty[]" value="<?php echo $stockqty; ?>" id="stockqty_<?php echo $i; ?>">
                           <!-- <input type="hidden" name="issueavl[]" value="<?php echo $stockqty; ?>" id="stockqty_<?php echo $i; ?>"> -->
                        ...
                        <td data-label="Unit"> 
                                <input type="text" class="form-control unit" name="unit[]" value="<?php echo $isu->unit_unitname;?>"  id="rede_unit_<?php echo $i; ?>" data-id='<?php echo $i; ?>' > 
                        </td>
                        <td data-label="Volume"> 
                                <input type="text" class="form-control" name="volume[]" value=""  id="volume_<?php echo $i; ?>" data-id='<?php echo $i; ?>' > 
                        </td>
                          <td data-label="Avl Qty.">
