...
<form method="post" id="FormIssueNew" action="<?php echo base_url('issue_consumption/new_issue/save_new_issue'); ?>" data-reloadurl="<?php echo base_url('issue_consumption/new_issue/form_new_issue');?>" class="form-material form-horizontal form">
    ...
    <div class="col-md-3 col-sm-4">
        ...
        <div class="dis_tab">
            <input type="text" class="form-control reqno send_after_stop number enterinput required_field " name="sama_requisitionno"  value="<?php echo $sama_reqnodb; ?>" placeholder="Enter Demand No." id="req_no" data-targetbtn="SrchReq" autocomplete="off" autofocus="on">
...
<div class="clearfix"></div>
    ...
    <div class="col-md-3 col-sm-4">
        ...
        <input type="text" class="form-control issueno_gen" name="sama_invoiceno" id="issue_no"  value="<?php echo !empty($sama_invoiceno)?$sama_invoiceno:$issue_no; ?>" placeholder="Enter Issue Number" readonly>
    </div>
...
<div class="clearfix"></div>
    ...
    <div class="form-group">
        ...
        ?>
            ...
            <button type="submit" class="btn btn-info savePrint" data-operation='<?php echo !empty($item_data)?'update':'save ' ?>' id="btnSubmit" data-print="print"><?php echo !empty($item_data)?'Update & Print':$this->lang->line('issue_and_print') ?></button>
        </div>
          <div class="col-sm-12">
