    ...
    <div id="issueDetails">
        ...
        <div class="form-group">
            <div class="col-md-2 col-sm-3">
                ...
                <input type="text" class="form-control enterinput" name="rema_issueno" id="issue_no"  value="<?php echo !empty($this->input->post('id'))?$this->input->post('id'):''; ?>" placeholder="Issue Number" data-targetbtn='btnSearchreturn' readonly>
            </div>
        ...
        <div class="form-group">
            <div class="col-md-2 col-sm-3">
                <label for="example-text">Credit Note No:</label>
                <input type="text" class="form-control " name="rema_invoiceno" value="<?php echo $return_issue_no; ?>"  id="return_invoice"  >
            </div>
       
            <div class="col-md-2 col-sm-3">
                <label for="example-text">Work Location:</label>
                <input type="text" class="form-control " name="rema_workplace" value=""  id="work_loc"  >
            </div>
       
            <div class="col-md-2 col-sm-3">
                <label for="example-text">Work Description:</label>
                <textarea name="rema_workdesc" id="work_des" cols="30" rows="2" class="form-control "></textarea>
    ...
    function onSuccess(jsons){
        ...
        if(data.status=='success')
        {
            if(issue_data)
            {
                ...
                var work_loc=loc_data[0].rema_workplace;
                var work_des=loc_data[0].rema_workdesc;
                ...
                $('#work_loc').val(work_loc);
                $('#work_des').val(work_des);     
