...
<div class="searchWrapper">
    ...
    <div class="">
        ...
        <?php endif; ?>
             ...
             <div class="col-md-1">
                <label>Filter</label>
                <input type="text" class="form-control" placeholder="Req. No/Bill No." 
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var otherdata = get_other_ajax_data(otherlinkdata, frmDate, toDate, false, locationid, mattypeid);
        ...
        $(document).on('click', '#searchByDate', function() {
            ...
            get_other_ajax_data(otherlinkdata, frmDate, toDate, false, locationid, mattypeid);
        ...
        function get_other_ajax_data(action, frmdate = false, todate = false, othertype = false, locid = false, mattypeid = false) {
