		...
		<table class="jo_tbl_head" width="100%" style="border-collapse: collapse;">
			<tr>
				...
				<td width="40%" style="text-align: right;" class="text-center magh_faram">
						...
						माग मिति:<strong><span class="borderbottom" style="min-width:80px;display: inline-block;margin: 0px;padding: 0px; "><?php echo !empty($issue_master[0]->sama_requisitiondatebs) ? $issue_master[0]->sama_requisitiondatebs : ''; ?></span></strong>
