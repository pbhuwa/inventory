            ...
            <table class="table table-bordered dataTable dt_alt res_vert_table" id="Dttable">
                <thead>
                    <tr>
                        ...
                        <th scope="col" width="20%"><?php echo $this->lang->line('item_name'); ?></th>
                        <th scope="col" width="8%"><?php echo $this->lang->line('unit'); ?></th>
                        <th scope="col" width="8%"><?php echo $this->lang->line('volume'); ?></th>
                    ...
                    ?>
                        <tr class="orderrow <?php echo $limited_stockClass .' '.  $stk_zero; ?>" id="orderrow_<?php echo $i;?>" data-id="<?php echo $i; ?>">
                            ...
                            <td data-label="Items Name">
                                <input type="text" class="form-control itemname" id="itemname_<?php echo $i; ?>" name="sade_itemsname[]" data-id='<?php echo $i; ?>' value="<?php echo htmlspecialchars($req_itemname);?>" readonly/>
                            </td>
                            <td data-label="Unit">
                            ...
                            <td data-label="Req. Qty">
                                <input type="text" class="form-control required_field remqty" id="remqty_<?php echo $i; ?>" name="remqty[]" data-id='<?php echo $i; ?>' value="<?php echo !empty($list->rede_remqty)? sprintf('%g',$list->rede_remqty):'';?>" readonly/>
                            </td>
                            <td data-label="Qty">
                                <input type="text" class="form-control required_field float sade_qty" id="sade_qty_<?php echo $i; ?>" name="sade_qty[]" data-id="<?php echo $i;?>" value="<?php echo sprintf('%g',$issue_qty); ?>"/>
                            </td>
