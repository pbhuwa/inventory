		...
		<table class="jo_table itemInfo" style="border-bottom: 1px solid #333;">
			...
			<thead>
				...
				<!-- <tr >
					...
					<th colspan="4" >
						...
						if ($issue_details) {
							...
							echo !empty($issue_master[0]->sama_receivedby) ? $issue_master[0]->sama_receivedby : '';
						} else {
							echo !empty($report_data['sama_receivedby']) ? $report_data['sama_receivedby'] : '';
						}
				...
				<tr>
					...
					<td colspan="2">मागको प्रकारः<br> जिम्मेवारी/हस्तेवारी/बालगीरी</td>

					<td colspan="2" rowspan="2">माग पेश गर्नेः
						<?php
						echo $location;
						echo !empty($issue_master[0]->sama_depname) ? $issue_master[0]->sama_depname : '';
						?>
					</td>
					<td rowspan="2" colspan="3">निकासी गर्नेेः
						...
						?>
						<br>
						मितिः <?php echo !empty($issue_master[0]->sama_billdatebs) ? $issue_master[0]->sama_billdatebs : ''; ?> गते ।
					</td>
					<td colspan="4">निकाशी नं.<br> <?php echo !empty($issue_master[0]->sama_invoiceno) ? $issue_master[0]->sama_invoiceno : ''; ?>
					</td>

				</tr>

				<tr>
					<td colspan="2">माग नम्बर : <?php echo !empty($issue_master[0]->sama_requisitionno) ? $issue_master[0]->sama_requisitionno : ''; ?></td>
				...
				<tr>
					...
					<td colspan="4">अख्तियारीः त्यस कलेजको माग फारमको श्री कार्यकारी निर्देशक ज्युबाट स्वीकृती भए बमोजिम</td>
				...
				<tr>
					...
					<th width="10%" class="td_cell" style="text-align: center">निकाशी गरेको</th>

					<th width="10%" class="td_cell" style="text-align: center">पछि दिने</th>
				...
				?>
						...
						<tr>
							...
							<td class="td_cell">
								...
								<?php $order_qty = !empty($products->totaldemandqty) ? $products->totaldemandqty : ''; ?>
	                    ...
	                    <?php $qty = !empty($products->totalqty) ? $products->totalqty : ''; ?> 
							...
							<td class="td_cell" style="text-align: right;">
								...
								<?php $rem_qty = !empty($products->rede_remqty) ? $products->rede_remqty : ''; ?>
