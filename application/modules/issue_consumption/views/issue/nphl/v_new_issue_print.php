		...
		<table  class="jo_table itemInfo" style="border-bottom: 1px solid #333;">
			<thead>
				<tr>
					...
					<th width="10%" class="td_cell" style="text-align: center">जी. सि. खा. पा. नं</th>
					<th width="30%" class="td_cell" style="text-align: center">विवरण </th>
					<th width="10%" class="td_cell" style="text-align: center"> माग गरेको माल सामान को परिमाण  </th>
		...
		<table class="jo_footer" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #000;border-top: 0px;page-break-inside: avoid;">
			<tr>
				...
				<td style="padding-top: 40px;">माग गर्नेको दस्तखत :
					<span class="signatureDashedLine" style="position: relative;top: 0px;"></span>
				</td>
			</tr>
			<tr>
