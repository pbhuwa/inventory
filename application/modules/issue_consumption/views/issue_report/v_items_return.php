...
<div class="searchWrapper">
  <form id="FormIssueReturn"  action=""  class="form-material form-horizontal form">
    <div class="row">
	<div class="form-group">
     ...
     <div class="dateRangeWrapper">
		...
		<div class="col-md-3">
		 ...
		 <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="/issue_consumption/issue_analysis/search_return_item"><?php echo $this->lang->line('search'); ?></button>
    </div>
	</div>
</div>
</form>
