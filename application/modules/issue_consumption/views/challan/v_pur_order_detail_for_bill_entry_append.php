<div class="table-responsive">
    <input type="hidden" class="chde_chmaid" name="chde_chmaid" value="<?php echo !empty($order_list[0]->chde_challanmasterid)?$order_list[0]->chde_challanmasterid:''; ?>" id="chde_chmaid" />
    <table style="width:100%;" class="table purs_table dataTable">
        <thead>
            <tr>
                ...
                <th width="5%"><?php echo $this->lang->line('received_bill_qty'); ?></th>
        ...
        <tbody id="purchaseDataBody">
            <?php
                if(!empty($order_list)):
                    $i=1;
                    foreach ($order_list as $ko => $ord_det):
            ...
            <tr id="row_<?php echo $i; ?> receivedOrderItem_<?php echo $i;?>" class="receivedItems">
                ...
                <td>
                    ...
                    <input type="hidden" class="pude_quantity" name="order_qty[]" value="<?php echo $ord_det->pude_quantity; ?>" id="order_qty_<?php echo $i; ?>" >
                </td>
               ...
               <!--  <td>
                ...
                <td>
                    <input type="text" class="form-control float calamt discount discountpc arrow_keypress" data-fieldid="discount" name="discount[]" id="discount_<?php echo $i; ?>"  value="<?php echo $ord_det->discount; ?>"  data-id='<?php echo $i; ?>'>
                    <input type="hidden" name="disamt[]" value="" id="disamt_<?php echo $i; ?>" class="disamt calamt">
                </td>
                <td>
                    <input type="text" class="form-control float calamt vat arrow_keypress" name="vat[]" id="vat_<?php echo $i; ?>" data-fieldid="vat" value="<?php echo $ord_det->vat; ?>"  data-id='<?php echo $i; ?>'>
...
<script>
    ...
    $(document).on('keyup change','.recqty',function(){
        var id=$(this).data('id');
        var reqqty=$(this).val();
        var availqty=$('#order_qty_'+id).val();
