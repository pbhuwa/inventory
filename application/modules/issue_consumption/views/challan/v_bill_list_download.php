...
<?php echo $this->load->view('common/v_pdf_excel_header'); ?>
    ...
    <tr>
    <td style="width:45%">
    <td class="text-center"><b style="font-size:15px;"> <u><?php echo $this->lang->line('bill_details'); ?>  </u></b> </td>
            </table>
...
<table id="" class="format_pdf" width="100%">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td style="border: 1px solid;"><?php echo !empty($row->orderno)?$row->orderno:'';?></td>
