...
<form method="post" id="FormDirectPurchase" action="<?php echo base_url('issue_consumption/challan/save_receive_order_item'); ?>" data-reloadurl='<?php echo base_url('issue_consumption/challan/form_purchase_receive'); ?>' class="form-material form-horizontal form" >
    <?php
    ...
    <div id="orderData">
        <div class="form-group">
            <div class="col-md-3 col-sm-4">
                ...
                <?php $receivedno=!empty($purchased_data[0]->chma_challannumber)?$purchased_data[0]->chma_challannumber:''; ?>
                <div class="dis_tab">
                    <input type="text" class="form-control required_field enterinput"  name="receipt_no"  value="<?php echo !empty($receivedno)?$receivedno:''; ?>" placeholder="" id="receipt_no">
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-4">
                ...
                <select name="supplier" class="form-control required_field select2" >
        ...
        <div class="col-md-3 col-sm-4">
          ...
          <input type="text" name="suplier_bill_date" class="form-control <?php echo DATEPICKER_CLASS; ?> date"  placeholder="Sup.Bill No" id="receivedno" value="<?php echo !empty($purchased_data[0]->recm_supbilldatebs)?$purchased_data[0]->recm_supbilldatebs:DISPLAY_DATE; ?>" id="suplier_bill_date">
          <span class="errmsg"></span>
        </div>
      
        <!-- <div class="col-md-3 col-sm-4">
            <?php $order_number_nodb=!empty($purchased_data[0]->order_number)?$purchased_data[0]->order_number:'0'; ?>
            <label for="example-text">Order No:</label>
            <input type="text" class="form-control" name="order_number" value="<?php echo $order_number_nodb; ?>" placeholder="Order No ">
        </div> -->
        <div class="col-md-3 col-sm-4">
            <?php 
            ...
            <select name="fiscalyearid" class="form-control select2" >
                <option value="">---select---</option>
                <?php
                    if($fiscal):
                ...
                <table style="width:100%;" class="table purs_table dataTable">
                    ...
                    <tbody id="purchaseDataBody">
                        <?php if($challan_details){
                            ...
                            <td><input type="text" class="form-control number calamt" name="puit_qty[]" value="<?php echo !empty($pd->chde_qty)?$pd->chde_qty:'0'; ?>" data-id='<?php echo $key+1; ?>' id="puit_qty_<?php echo $key+1; ?>" placeholder="Qty">
                            </td>
                            <td>
                       ...
                       <script>
                        ...
                        <tr class="orderrow" id="orderrow_1" data-id='1'>
                          ...
                          <!--   <td>  
                            ...
                            <td><input type="text" class="form-control number calamt" name="puit_qty[]" value="1"  data-id='1' id="puit_qty_1" placeholder="Qty">
                            </td>
                            <td>
                                <input type="text" class="form-control puit_unitprice float calamt" name="puit_unitprice[]" id="puit_unitprice_1" value="0"  data-id='1' placeholder="Rate">
                                <input type="hidden" class="form-control unitprice float" name="unitprice[]" id="unitprice_1" value="0"  data-id='1' placeholder="Rate">
                            </td>
                          <!--   <td>
                            ...
                            <td>
                                <input type="text" class="form-control number calamt eachcc" name="cc[]" id="cc_1" value="0"  data-id='1' placeholder="CC">
                            </td>
                            <td>
                                <input type="text" class="form-control discount float calamt " name="discount[]" id="discount_1"  value="0"  data-id='1' placeholder="Dis">

                            </td>
                            <td>
                                <input type="text" class="form-control float calamt vat" name="vat[]" id="vat_1" value="0"  data-id='1' placeholder="Vat">
                         ...
                         <!--    <td><input type="text" class="form-control <?php echo DATEPICKER_CLASS; ?>" name="trde_expdate[]" id="expiry_date_1"  data-id='1' placeholder="Exp Date"> </td> -->
                            <td>
                                <input type="text" class="form-control description" name="description[]" value="" data-id='1' id="description_1" placeholder="Description"> 
                            </td>
                            <td>
                                <div class="actionDiv acDiv2"></div>
                            </td>
