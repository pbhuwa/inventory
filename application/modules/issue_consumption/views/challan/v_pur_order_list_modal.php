...
<div class="white-box pad-5" id="detailListBox">
    <?php $this->load->view('challan/v_pur_order_detail_modal');?>
</div> 
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var is_challan = '<?php echo $is_challan;?>';
        ...
        if(is_challan == 'challan'){
            var dataurl = base_url+"issue_consumption/challan/get_order_list_for_challan"+'/'+is_challan;
        }else{
            var dataurl = base_url+"issue_consumption/challan/get_order_list_for_challan";
        }
            ...
            return (function() {
                ...
                return function(e) {
                    if (alreadyclicked) {
                        ...
                        $('#suppliername').val(supplierid).trigger('change.select2');
        ...
        $('#myView').on('keydown', function(event){
            ...
            if(keypressed == '13'){
                ...
                var supplierid = selectedTR.data('supplierid');
