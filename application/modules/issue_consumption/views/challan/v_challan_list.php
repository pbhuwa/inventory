...
<div class="pad-5">
    <div class="width-300 pull-right">
      <div class="white-box pad-5 noborder">
          <ul class="index_chart">
              <li>
                  <div class="pending"></div> <a href="javascript:void(0)" data-approvedtype='N' class="approvetype"><?php echo $this->lang->line('pending'); ?></a>
                  <span id="pending"><?php echo !empty($status_count[0]->pending)?$status_count[0]->pending:'';?></span>
              </li>

              <li>
                  <div class="complete"></div><a href="javascript:void(0)" data-approvedtype='Y' class="approvetype"> <?php echo $this->lang->line('completed'); ?></a> 
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    $(document).on('click','.approvetype',function(){
      ...
      function get_other_ajax_data(action,frmdate=false,todate=false,apptype=false){
        var returndata=[];   
        $.ajax({
            type: "POST",
            url: action,
            ...
            dataType: 'html',
            data:{frmdate:frmdate,todate:todate,apptype:apptype} ,
