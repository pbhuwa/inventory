...
<div class="jo_form organizationInfo">
		...
		<table  class="jo_table itemInfo" style="border-bottom: 1px solid #333;">
			<thead>
				<tr>
					...
					<th width="10%" class="td_cell">जिन्सी खातापन न. </th>
					<th width="45%" class="td_cell">विवरण  </th>
					<th width="10%" class="td_cell">मालसामानको परिमाण </th>
					<th width="10%" class="td_cell">एकाइ </th>
					<th width="10%" class="td_cell">निकासा गरेको मालसामानका परिमाण </th>
	...
	<div class="footerWrapper">
		<table class="jo_footer" style="padding-top: 10px;padding-bottom: 10px;border: 1px solid #000;border-top: 0px;page-break-inside: avoid;">
			<tr>
				<td width="60%" style="padding-top: 30px;"> बजारबाट खरिद गरिदिनु   </td>
				<td style="padding-top: 40px;">माग गर्नेको सही :
					<span class="signatureDashedLine"></span>
				</td>
			</tr>
			<tr>
				<td>मौज्दातबाट दिनु</td>
			...
			<tr>
					<td style="padding-top: 25px;">आदेश दिनेको सही :
			...
			<tr>
				<td style="padding-top: 25px;">मालसामान बुझ्नेको सही 
