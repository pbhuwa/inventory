...
<div class="jo_form organizationInfo">
	...
	<div class="headerWrapper" style="padding-bottom: 1px">
		...
		if($show_material_type=='Y'){
			...
			$header['report_title'] = 'माग फाराम';
		}
		
		$session_locationid=$this->session->userdata(LOCATION_ID);

		$header['locationid']=!empty($stock_requisition_details[0]->rema_locationid) ? $stock_requisition_details[0]->rema_locationid:$session_locationid;
		...
		<table class="jo_tbl_head" width="100%" style="border-collapse: collapse;">
			<tr>
				<td width="40%">
					...
					<span style="font-size: 12px; margin-bottom: 5px;" class="<?php echo FONT_CLASS; ?>"> श्री प्रमुक भण्डार :- </span> <span class="borderbottom">
					</span>
