...
// print_r(PROCEED_PURCHASE);

// die();

$proceed_purchase_db=PROCEED_PURCHASE;

$proceed_purchase =explode(',', $proceed_purchase_db);

$verify_demand_db=VERIFY_DEMAND;

$verify_demand =explode(',', $verify_demand_db);

$approved_demand_db=APPROVE_DEMAND ;

$approved_demand =explode(',', $approved_demand_db);
    ...
    <div class="form-group row resp_xs">
      ...
      <div class="white-box pad-5">
        ...
        <div class="row">
          ...
          <div class="col-sm-4 col-xs-6">
            ...
            $reqdepartment=!empty($requistion_data[0]->rema_reqfromdepid)?$requistion_data[0]->rema_reqfromdepid:'';
              ...
              <table style="width:100%;" class="table dataTable con_ttl dt_alt purs_table">
                  ...
                  <tbody>
                   ...
                   <tr class="orderrow <?php 
                        ...
                        if($value->cur_stock_qty <=$value->itli_reorderlevel && !empty($value->cur_stock_qty) ){ 

                          echo "warning";

                        }

                        else if($value->cur_stock_qty=='0.00' || empty($value->cur_stock_qty)){
                       ...
                       <td> <input type="checkbox" name="itemsid[]" value="<?php echo $value->rede_itemsid; ?>" class="itemcheck <?php if($value->rede_qtyinstock<='0.00') echo 'stockzero'?>"></td>
                      ...
                      <td><?php echo $value->rede_qtyinstock ?></td>
                  ...
                  <?php
                    ...
                    if(in_array($this->usergroup, $proceed_purchase)):

                  ?>

                  <tfoot>

                     <?php  if($purchasereqid!=''): ?>
      ...
      <div class="list_c2 label_mw125">
        ...
        <form id="FormChangeStatus" action="<?php echo base_url('issue_consumption/stock_requisition/change_status');?>" method="POST">
            ...
            <input type="hidden" name="masterid" value="<?php echo !empty($requistion_data[0]->rema_reqmasterid)?$requistion_data[0]->rema_reqmasterid:'';  ?>" id="reqmasterid">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        <?php
                          ...
                          if(in_array($this->usergroup, $verify_demand)):
                        ...
                        <?php
                          ...
                          if(in_array($this->usergroup, $approved_demand)):
                        ...
                        <?php
                          ...
                          endif; // end approve permission check
 ...
 $(document).off('change','.itemcheck');
  ...
  var itemlist = [];
   ...
   var redirecturl=base_url+'purchase_receive/purchase_requisition';
     ...
     $.redirectPost(redirecturl, {itemlist:itemlist,req_no:req_no,fyear:fyear,reqmasterid:reqmasterid});
