    ...
    <div class="form-group">
        ...
        <div class="col-md-3">
           ...
           <div class="col-md-3 col-sm-4">
                ...
                <?php $rema_fyear = !empty($req_data[0]->rema_fyear) ? $req_data[0]->rema_fyear : CUR_FISCALYEAR; ?>

                <label for="example-text"><?php echo $this->lang->line('fiscal_year'); ?><span class="required">*</span> :</label>

                <select name="rema_fyear" class="form-control required_field" id="fyear">
                    ...
                    ?>
                            ...
                            <option value="<?php echo $fyrs->fiye_name; ?>" <?php if ($rema_fyear==$fyrs->fiye_name) echo "selected=selected"; ?>><?php echo $fyrs->fiye_name; ?></option>
        ...
        <div class="col-md-3">
            ...
            $rema_school = !empty($req_data[0]->rema_school) ? $req_data[0]->rema_school : $this->locationid;

            ?>

            <select class="form-control required_field" name="rema_school" id="locationid">
                ...
                ?>
                        ...
                        <option value="<?php echo $loc->loca_locationid; ?>" <?php if ($rema_school == $loc->loca_locationid) echo "selected=selected"; ?>><?php echo $loc->loca_name; ?></option>
        ...
        <div class="col-md-3">
            ...
            <div class="dis_tab">
                ...
                <select name="rema_reqfromdepid" id="rema_reqfromdepid" class="form-control required_field ">
