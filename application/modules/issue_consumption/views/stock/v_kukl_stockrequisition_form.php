                    ...
                    <tbody id="orderBody">
                        ...
                        <tr class="orderrow" id="orderrow_<?php echo !empty($req_value->rede_reqdetailid)?$req_value->rede_reqdetailid:''; ?>" data-id='<?php echo $j; ?>'>
                            ...
                            <td data-label="Req. Quantity"> 
                                <input type="text" class="form-control float rede_qty calamt rede_qty" name="rede_qty[]" id="rede_qty_<?php echo $j;?>" data-id='<?php echo $j;?>' value="<?php echo !empty($req_value->rede_qty)?$req_value->rede_qty:''; ?>"/ > 
                            </td>
                            <td>

                                 <input type="text" class="form-control float rede_unitprice calamt" name="rede_unitprice[]" id="rede_unitprice_<?php echo $j;?>" data-id='<?php echo $j;?>' value="<?php echo !empty($req_value->itli_purchaserate)?$req_value->itli_purchaserate:''; ?>"> 
                                <input type="hidden" class="unitamtid" name="rede_unitprice[]" id="unitamtid_<?php echo $j;?>" data-id='<?php echo $j;?>' value="<?php echo !empty($req_value->rede_unitprice)?$req_value->rede_unitprice:''; ?>"id='unitamtid_<?php echo $j; ?> '/>

                               
                            </td>
                             <td>
                                <?php $subtotal = ($req_value->rede_qty)*($req_value->itli_purchaserate); ?>
                                <input type="text" name="rede_totalamt[]" class="form-control eachtotalamt" value="<?php echo !empty($subtotal)?$subtotal:'0'; ?>"  id="rede_totalamt_<?php echo $req_key+1; ?>" readonly="true"> 
                            </td>
                        ...
                        <tr class="orderrow" id="orderrow_1" data-id='1'>
                            ...
                            <td data-label="Req. Quantity"> 
                                <input type="text" class="form-control float rede_qty calamt rede_qty" name="rede_qty[]"   id="rede_qty_1" data-id='1' > 
                            </td>
                              <td>
                                <input type="text" class="form-control rede_unitprice float calamt" name="rede_unitprice[]" id="rede_unitprice_1" value="0"  data-id='1' placeholder="Rate">
                    ...
                    <div class="row">
                        <div class="col-sm-4">
                            ...
                            <div>
                                ...
                                <textarea name="rema_remarks" class="form-control" rows="4" placeholder=""></textarea>
                            </div>
...
<script>
    ...
    $(document).on('keyup change','.calamt',function(){
        ...
        var rede_totalamt=0;
        var rede_qty=parseFloat(qty)*parseFloat(rate);
        $('#eachsubtotal_'+id).val(rede_qty);
        // if(rate>0)
        // {
        //     $('#free_'+id).val(0);
        // }
      ...
      $('#rede_totalamt_'+id).val(toFixed(2));
        // $('#totalamt_1').val(500);
