...
<div class="searchWrapper">
 ...
 <div class="col-md-1">
                <label>Filter</label>
                <input type="text" class="form-control required_field enterinput" placeholder="Req. No/Manual No." 
        ...
        <table id="myTable" class="table table-striped serverDatatable keypresstable" data-tableid="#myTable">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th width="6%"><?php echo $this->lang->line('manual_no'); ?></th>
...
<script type="text/javascript">
    function get_other_ajax_data(action, frmdate = false, todate = false, othertype = false, locationid = false, mattype = false) {
    ...
    $(document).ready(function() {
     ...
     var srchtext = $('#srchtext').val();
        ...
        var otherdata = get_other_ajax_data(otherlinkdata, frmDate, toDate, type, locationid, mattype);
        ...
        $(document).on('click', '#searchByDate', function() {
         srchtext = $('#srchtext').val();
            ...
            get_other_ajax_data(otherlinkdata, frmDate, toDate, type, locationid, mattype);
