...
$location_for_accode = $this->location_ismain != 'Y' ? $this->locationid : $rema_locationid;
$loca_irdcode = '';
if ($location_for_accode) {
    $location_row = $this->db->select('loca_irdcode')->from('loca_location')->where('loca_locationid', $location_for_accode)->get()->row();
    $loca_irdcode = $location_row->loca_irdcode;
}
...
<div class="list_c2 label_mw125">
    ...
    <div class="form-group row resp_xs">
            ...
            <div class="row">
                ...
                <div class="col-sm-4 col-xs-6">
                    ...
                    <span class="inline_block">
                        ...
                        <?php echo !empty($requistion_data[0]->rema_reqdatebs) ? $requistion_data[0]->rema_reqdatebs : ''; ?>(BS),
                        <?php echo !empty($requistion_data[0]->rema_reqdatead) ? $requistion_data[0]->rema_reqdatead : ''; ?>(AD)
                ...
                <div class="btn-group pull-right">
                    ...
                    <button class="btn btn-info" id="btnHistory"
                        data-actionurl="<?php echo base_url('/issue_consumption/stock_requisition/stock_requisition_reprint') ?>"
                        data-id="<?php echo $rede_reqmasterid; ?>" data-reqno="<?php echo $rema_reqno; ?>"
                        data-fyear="<?php echo $rema_fyear ?>" data-heading="History">
        ...
        <div>
            ...
            <a href="javascript:void(0)" class="btnSelectNotAvailable btn btn-xs btn-danger">Select Unavailable
                Stock</a>
        ...
        <table style="width:100%;" class="table dataTable con_ttl dt_alt purs_table">
            ...
            <thead>
                ...
                <tr>
                    ...
                    <th width="5%">
                        Rem. Demand Qty.
                        <?php //echo $this->lang->line('rem_qty'); 
                            ?> </th>
                    ...
                    <th width="5%">Est.Total Amt </th>

                    <th width="5%">Avl.Budget </th>
                    ...
                    <!--  <th width="5%"><? php // echo $this->lang->line('remarks'); 
                                                ?></th> -->
            ...
            <?php
                ...
                foreach ($mat_type as $km => $mat) :
                    ...
                    $this->db->select('acty_id as catid, acty_accode as eqca_code, acty_acname as eqca_category, buhe_code, acty_code');
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <select name="" class="form-control bcheckall" id="cat_id_all" width="120px" data-id="cat_id">
                            ...
                            <option value="<?php echo $ctype->catid; ?>">
                                <?php
                                                        $real_code = $ctype->acty_code . $ctype->buhe_code . $loca_irdcode;
                                                        echo "$ctype->eqca_code - $ctype->eqca_category - $real_code";
                                                        ?>
                            </option>
                        ...
                        <select name="" class="form-control bcheckall" id="subsidiary_all" width="120px" data-id="subs_cat" style="display: none;">
                        </select>
                        ...
                        <select name="" class="form-control bcheckall" id="bhead_id_all" width="120px" data-id="bhead">
                            ...
                            <option value="<?php echo $bh->buhe_bugetheadid; ?>"><?php echo $bh->buhe_headtitle; ?>
                            </option>
                ...
                <tr class="orderrow <?php
                    ...
                    <td>
                        ...
                        <input type="checkbox" name="itemsid[]" value="<?php echo $value->rede_itemsid; ?>"
                            class="itemcheck <?php echo $stock_class; ?> <?php echo $item_avail_class; ?>"
                            data-itemcode="<?php echo $value->itli_itemcode ?>"
                            data-itemname="<?php echo $value->itli_itemname ?>"
                            data-itemstypeid="<?php echo $mat->maty_materialtypeid ?>"
                            data-unitname="<?php echo $value->unit_unitname ?>"
                            data-qty="<?php echo $value->rede_qty ?>" data-remqty="<?php echo $value->rede_remqty ?>"
                            data-unitprice="<?php echo $value->itli_purchaserate ?>"
                            data-stockqty="<?php echo $value->cur_stock_qty; ?>"
                            data-totalamt="<?php echo $value->rede_totalamt; ?>"
                            data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                            data-my_rem_qty="<?php echo $my_rem_qty; ?>"
                            data-proceedpurchase="<?php echo $value->rede_proceedpurchase; ?>" />
                    ...
                    <td>
                        ...
                        <a href="javascript:void(0)" data-id='<?php echo  $value->rede_reqdetailid ?>'
                            data-displaydiv="ItemDetails"
                            data-viewurl="<?php echo base_url('issue_consumption/stock_requisition/add_item_code'); ?>"
                            title="Add Code" class="view btn-primary btn-xxs"
                            data-heading="Enter Item code if demanded item is identified">
                    ...
                    <td><?php echo $value->itli_itemcode ?>
                        ...
                        <input type="hidden" value="<?php echo $value->rede_itemsid; ?>" name="items_id[]"
                            class="items_id" />
                    ...
                    <td>
                        ...
                        <select name="cat_id[]" data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                            id="cat_id_<?php echo $key + 1; ?>" class="form-control bcheck" width="120px"
                            data-id="<?php echo $key + 1; ?>" <?php echo $disabled_catid; ?>>
                            ...
                            <option value="<?php echo $ctype->catid; ?>"
                                <?php if ($save_cat_id == $ctype->catid) echo "selected=selected"; ?>>
                                <?php
                                                            $real_code = $ctype->acty_code . $ctype->buhe_code . $loca_irdcode;
                                                            echo "$ctype->eqca_code - $ctype->eqca_category - $real_code";
                                                            // echo "$ctype->eqca_code - $ctype->eqca_category"; 
                                                            ?>
                        ...
                        <select name="subs_cat_id[]" data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                            id="subs_cat_<?php echo $key + 1; ?>" class="form-control bcheck subcatopt"  width="120px"
                            style="display: none;"
                            data-id="<?php echo $key + 1; ?>" <?php echo  $disabled_buhead; ?>>
                        </select>  
                        ...
                        <select name="bhead[]" data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                            id="bhead_<?php echo $key + 1; ?>" class="form-control budgethead_ids" width="120px"
                            data-id="<?php echo $key + 1; ?>" <?php echo  $disabled_buhead; ?>>
                            ...
                            <option value="<?php echo $bh->buhe_bugetheadid; ?>"
                                <?php if ($save_budgethead == $bh->buhe_bugetheadid) echo "selected=selected"; ?>>
                                <?php echo $bh->buhe_headtitle; ?></option>
                        ...
                        <input type="hidden" name="isisbug_avl[]" id="isisbug_avl_<?php echo $key + 1; ?>"
                            data-id="<?php echo $key + 1; ?>">
                        <input type="hidden" name="api_expense_id[]" id="api_expense_id_<?php echo $key + 1; ?>"
                            data-id="<?php echo $key + 1; ?>">
                        ...
                        <span id="savediv_<?php echo $key + 1; ?>">
                            ...
                            <a href="javascript:void(0)" data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                                class="btn btn-sm btn-success btnsave_buget" title="Click here for Save"
                                id="btnsave<?php echo $key + 1; ?>" data-id="<?php echo $key + 1; ?>"><i
                    ...
                    <td>
                        ...
                        <select name="issue_cat_id[]" data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                            id="issue_cat_id_<?php echo $value->rede_itemsid; ?>" class="form-control " width="120px"
                            data-id="<?php echo $value->rede_itemsid; ?>" <?php echo $disabled_issue_catid; ?>>
                        ...
                        <?php $save_budgethead = !empty($value->rede_budgetheadid) ? $value->rede_budgetheadid : '';
                                            ...
                                            ?>
                        <select name="subs_cat_id[]" data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                            id="subs_cat_<?php echo $value->rede_itemsid; ?>" class="form-control bcheck subcatopt" width="120px"
                            style="display: none;"
                            data-id="<?php echo $key + 1; ?>">
                        </select>   

                        <select name="issue_bhead[]" data-reqdetailid="<?php echo $value->rede_reqdetailid; ?>"
                            id="issue_bhead_<?php echo $value->rede_itemsid; ?>"
                            class="form-control issue_budgethead_ids" width="120px"
                            data-id="<?php echo $value->rede_itemsid; ?>" <?php echo  $disabled_issue_buhead; ?>>
                    ...
                    <td>
                        ...
                        <input type="text" name="recommend_qty[]"
                            class="form-control float recommend_qty arrow_keypress" data-fieldid="recommend_qty"
                            id="recommend_qty_<?php echo $key + 1; ?>" data-id=""
                            value="<?php echo sprintf('%g', $remqty); ?>" <?php echo $readonly; ?> />
                    ...
                    <td><span
                            id="budget_amount_<?php echo $key + 1; ?>"><?php echo number_format($value->budg_availableamt, 2) ?></span>
                    </td>
                    ...
                    <td>
                        ...
                        <input type="radio" name="rede_itrecommend_<?php echo $i . '_' . $j; ?>"
                            class="rede_itrecommend" value="1"
                            <?php echo ($value->rede_itrecommend == '1') ? "checked" : ""; ?>
                            <?php echo $it_status_disabled; ?> /><?php echo $this->lang->line('recommend'); ?> <br />

                        <input type="radio" name="rede_itrecommend_<?php echo $i . '_' . $j; ?>"
                            class="rede_itrecommend" value="2"
                            <?php echo ($value->rede_itrecommend == '2') ? "checked" : ""; ?>
                            <?php echo $it_status_disabled; ?> /><?php echo $this->lang->line('not_recommend'); ?>
                        <br />

                        <input type="radio" name="rede_itrecommend_<?php echo $i . '_' . $j; ?>"
                            class="rede_itrecommend" value="3"
                            <?php echo ($value->rede_itrecommend == '3') ? "checked" : ""; ?>
                            <?php echo $it_status_disabled; ?> /> <?php echo $this->lang->line('partial'); ?>

                    </td>

                    <td>

                        <input type="text" name="rede_itcomment" class="form-control rede_itcomment"
                            value="<?php echo $value->rede_itcomment; ?>" <?php echo $it_status_readonly; ?> />
                ...
                <tr id="processdiv" style="display: none;">
                    ...
                    <td colspan="12">
                        ...
                        <div class="">
                            ...
                            <a href="javascript:void(0)" class="btn btn-sm btn-danger process_procurement" id="">Process
                                To Procurement</a>
                            ...
                            <a href="javascript:void(0)" class="btn btn-sm btn-info" id="central_request">Request To
                                Central Office </a>
                            ...
                            <a href="javascript:void(0)" class="btn btn-sm btn-primary" id="btnOtherStock"
                                data-heading="Other Branch Stock">Other Branch Stock</a>
                            ...
                            <a href="javascript:void(0)" class="btn btn-sm btn-danger process_procurement" id=""
                                data-proctype="D">Process To Procurement</a>
                    ...
                    <td colspan="12">
                        ...
                        <div class="mbtm_10">
                            ...
                            <div>
                                ...
                                <a href="javascript:void(0)" class="btnSelectAvailableAfter btn btn-xs btn-info">Select
                                    Available Stock After Purchase</a>

                                <a href="javascript:void(0)"
                                    class="btnSelectAvailableBefore btn btn-xs btn-primary">Select Available Stock
                                    Before Purchase</a>
                            ...
                            justify-content: start;">
                                    <div class="col-md-3">
                                        ...
                                        <input type="text" name="issue_date" id="issue_datebs_direct"
                                            class="form-control <?php echo DATEPICKER_CLASS; ?>" maxlength="10"
                                            value="<?php echo $issue_date; ?>">
                                    </div>

                                    <div class="col-md-3">
                                        <label for="issue_attachment_direct">Attachment:</label>
                                        <input type="file" name="issue_file_direct" id="issue_attachment_direct"
                                            class="form-control">
                                    </div>

                                    <a href="javascript:void(0)" class="btn btn-sm btn-success"
                                        id="proceed_to_issue_items" data-type="direct">Issue</a>
                                </div>
                            ...
                            <div class="stock_available_after_procurement" style="display: none;">
                                ...
                                <a href="javascript:void(0)" class="btn btn-sm btn-success"
                                    id="inform_item_available">Inform</a>
                    ...
                    <td colspan="12">
                        ...
                        justify-content: start;">
                            <div class="col-md-3">
                                ...
                                <input type="text" name="issue_date" id="issue_datebs"
                                    class="form-control <?php echo DATEPICKER_CLASS; ?>"
                                    value="<?php echo $issue_date; ?>" maxlength="10">
                            </div>
                            <div class="col-md-3">
                                <label for="issue_attachment">Attachment:</label>
                                <input type="file" name="issue_file" id="issue_attachment" class="form-control">
                            </div>

                            <a href="javascript:void(0)" class="btn btn-sm btn-success"
                                id="proceed_to_issue_items">Issue</a>
                        </div>
        ...
        <div class="mbtm_10">
            ...
            <a href="javascript:void(0)" class="btn btn-sm btn-info approve_issue" data-respondtype="approve">Approve
                Issue </a>

            <a href="javascript:void(0)" class="btn btn-sm btn-danger approve_issue" data-respondtype="decline">Decline
                Issue </a>
        ...
        <a id="btnSubmitITRecommend" href="javascript:void(0)" class="btn btn-info pull-right">Submit IT Recommendation
        </a>
        ...
        <div class="list_c2 label_mw125">
            ...
            <form id="FormChangeStatus"
                action="<?php echo base_url('issue_consumption/stock_requisition/change_status'); ?>" method="POST">
                    ...
                    <div class="col-ms-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <a id="btnRecommend" href="javascript:void(0)"
                                    class="btn btn-primary pull-right">Recommend</a>
                            ...
                            <div class="col-sm-12 mbtm_15">
                                ...
                                <span>If there are IT items in demand, it will be automatically proceeded to IT
                                    Department after Verification.</span>
                            ...
                            <div class="col-sm-3">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <input type="radio" class="mbtm_13 cancel" name="approve_status" value="4"
                                        id="verified">
                            ...
                            <div class="col-sm-9">
                                ...
                                <div class="col-md-6 showCancel" id="cancelReason">
                                    ...
                                    <label for="example-text"><?php echo $this->lang->line('cancel_reason'); ?>:
                                    </label><br>
                                ...
                                <div class="col-md-6 showUnapproved" id="cancelReason">
                                    ...
                                    <label for="example-text"><?php echo $this->lang->line('unapproved_reason'); ?>:
                                    </label><br>
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-info  savelist" data-operation="save" id="btnDeptment"
                                data-isdismiss="Y" data-isrefresh="Y">
...
$(document).on('click', '#btnRecommend', function() {
    ...
    var submitData = {
        all_recommend_qty: all_recommend_qty,
        all_items_id: all_items_id,
        rema_reqmasterid: rema_reqmasterid,
...
$(document).on('click', '#proceed_to_issue_items', function() {
...

    {
        ...
        formData.append('masterid', rema_reqmasterid);
        formData.append('rema_reqby', rema_reqby);
        formData.append('rema_fyear', rema_fyear);
        formData.append('rema_reqno', rema_reqno);
        formData.append('proctype', proctype);
        formData.append('rema_issuedate', rema_issuedate);
        for (var i = 0; i < itemlist.length; i++) {
            formData.append('itemlist[]', itemlist[i]);
            formData.append('itemcode[]', itemcode[i]);
            formData.append('itemname[]', itemname[i]);
            formData.append('unitname[]', unitname[i]);
            formData.append('qty[]', qty[i]);
            formData.append('remqty[]', remqty[i]);
            formData.append('unitprice[]', unitprice[i]);
            formData.append('totalamt[]', totalamt[i]);
            formData.append('reqdetailid[]', reqdetailid[i]);
            formData.append('itemtypeid[]', itemtypeid[i]);
            formData.append('stockqty[]', stockqty[i]);
            formData.append('my_rem_qty[]', my_rem_qty[i]);
            formData.append('issue_budgethead[]', issue_budgethead[i]);
            formData.append('issue_category[]', issue_budgethead[i]);
        }

        // var submitData = { masterid:rema_reqmasterid, itemlist:itemlist, itemcode:itemcode, itemname:itemname, unitname:unitname, qty:qty, remqty:remqty, unitprice:unitprice, totalamt:totalamt, rema_reqby:rema_reqby,  rema_fyear:rema_fyear, rema_reqno:rema_reqno, proctype:proctype, reqdetailid: reqdetailid, itemtypeid:itemtypeid, stockqty:stockqty, my_rem_qty:my_rem_qty, rema_issuedate:rema_issuedate,issue_budgethead:issue_budgethead,issue_category:issue_category};
        ...
        if (type == 'direct') {
            ...
            formData.append('issue_attachment', $("input[name=issue_file_direct]")[0].files[0]);
        } else {

            formData.append('issue_attachment', $("input[name=issue_file]")[0].files[0]);
        ...
        $.ajax({
            type: "POST",
            url: base_url + 'issue_consumption/stock_requisition/proceed_to_issue_items',
            data: formData,
            contentType: false,
            processData: false,
...
$(document).on('click', '#btnOtherStock', function(e) {
    ...
    $.ajax({
        ...
        data: {
            itemlist: itemlist,
            handovermasterid: handovermasterid
        },
...
$(document).on('click', '#btnSubmitITRecommend', function() {
    ...
    var submitData = {
        all_items_id: all_items_id,
        rede_itrecommend: rede_itrecommend,
        rede_itcomment: rede_itcomment,
        rema_reqmasterid: rema_reqmasterid,
...
<script type="text/javascript">
var irdcode = '<?= $loca_irdcode; ?>';
var kvwsmb_id = '<?=KVWSMB_ID;?>';
$(document).off('change', '#bhead_id_all');
$(document).on('change', '#bhead_id_all', function(e) {

    let budgetid = $(this).val();
    let account_url = base_url + 'issue_consumption/stock_requisition/get_headwise_account';
        ...
        success: function(jsons) {
            ...
            if (data.status == 'success') {
                let accounts = data.accounts;
                  ...
                  let cost_center_id=data.cost_central_id;
                  if(cost_center_id==9){
                    $.each(accounts, function(i, value) {
                    let real_code = `${value.acCode}`;
                    options +=
                        `<option value='${value.acCode}'>${value.acCode}-${value.acName}-${real_code}</option>`;
                    });
                      $('#cat_id_all').html(options);
                        $('#cat_id_all').addClass('checkSubsidairyacc_for_all');

                  }else{
                          $.each(accounts, function(i, value) {
                    let real_code = `${value.acty_code}${value.buhe_code}${irdcode}`;
                    options +=
                        `<option value='${value.acty_id}'>${value.acty_accode}-${value.acty_acname}-${real_code}</option>`;
                    })
                    $('#cat_id_all').html(options);
                  }
...
$(document).off('change', '.budgethead_ids');
$(document).on('change', '.budgethead_ids', function(e) {
    let budgetid = $(this).val();
    var id = $(this).data('id');
        ...
        success: function(jsons) {
            ...
            if (data.status == 'success') {
                ...
                if(cost_center_id==9){
                    ...
                    $('#cat_id_' + id).addClass('checkSubsidairyacc');
                    $('#cat_id_' + id).removeClass('bcheck');
                   
                    $('#cat_id_' + id).html(options);
                    return false;
                }else{
                    ...
                    $('#cat_id_' + id).removeClass('checkSubsidairyacc');
                    $('#cat_id_' + id).addClass('bcheck');
                    $('#cat_id_' + id).html(options);
                }
...
$(document).off('change', '.issue_budgethead_ids');
$(document).on('change', '.issue_budgethead_ids', function(e) {
        ...
        success: function(jsons) {
            ...
            if (data.status == 'success') {
                ...
                if(cost_center_id==9){
                    ...
                    $('#issue_cat_id_' + id).addClass('checkSubsidairyacc');
                   
                    $('#issue_cat_id_' + id).html(options);
                }else{
                    $.each(accounts, function(i, value) {
                    let real_code = `${value.acty_code}${value.buhe_code}${irdcode}`;
                    options +=
                     ...
                     $('#issue_cat_id_' + id).removeClass('checkSubsidairyacc');
                    $('#issue_cat_id_' + id).html(options);
                }
...
function show_subsidiary_list(id){
    var cat_id = $('#cat_id_' + id).val();
    var bhead = $('#bhead_' + id).val();
    if (cat_id == '') {return false;}
    let account_url = base_url + 'issue_consumption/stock_requisition/get_subsidiary_account';
    let options = "<option value=''>--Select--</option>";
    $.ajax({
        ...
        success: function(jsons) {
            ...
            if (data.status == 'success') {
                ...
                $.each(accounts, function(i, value) {
                    ...
                    options +=
                        `<option value='${value.aC_CODE}'>${value.aC_CODE}-${value.accname}</option>`;
                })
                $('#subs_cat_' + id).html(options);
            } else {
                $('#subs_cat_' + id).html(options);
            }
            $('#subs_cat_' + id).show();
...
$(document).on('change', '.bcheck', function(e) {
    ...
    var sub_cat_id = $('#subs_cat_' + id).val();

    // if (bhead == kvwsmb_id) {
    //     show_subsidiary_list(id);
    //     return false
    // }
...
$(document).on('click', '.btnsave_buget', function(e) {
    ...
    if(bhead == kvwsmb_id && (subs_cat == "" || subs_cat == undefined || subs_cat == null) ){
        alert('Subsidiary account is requered !! ');
        return false;
    }
...
$(document).on('change', '.bcheckall', function(e) {
    ...
    var subsidiary_all=$('#subsidiary_all').val();
            ...
            success: function(jsons) {
                ...
                if (data.status == 'success') {
                    ...
                    $.each(accounts, function(i, value) {
                        ...
                        options +=
                            `<option value='${value.accno}'>${value.accno}-${value.accname}-${value.aC_CODE}</option>`;
                    })
                    $('#subsidiary_all').html(options);
                } else {
                    $('#subsidiary_all').html(options);
                }
                $('#subsidiary_all').show();
    ...
    if(id=='subs_cat'){
         $('.subcatopt').each(function(index, e) {
                    ...
                    if (isattr == false) {
                        ...
                        $('#' + id + '_' + id_index).val(subsidiary_all).trigger('change');
...
<script type="text/javascript">
    $(document).off('change','.checkSubsidairyacc');
    $(document).on('change','.checkSubsidairyacc',function(e){
        var dataid=$(this).data('id');
        var reqdetailid=$(this).data('reqdetailid');
        var data_val=$(this).val();
        // show_subsidiary_list(dataid);
                    ...
                    options = "<option value=''>--Select--</option>";
                      $.each(accounts, function(i, value) {
                        ...
                        options +=
                          ...
                          $('#subs_cat_' + dataid).html(options);
                           $('#subs_cat_' + dataid).show();
                  
            } else {
                 options='';
                $('#subs_cat_' + dataid).html(options);
                 $('#subs_cat_' + dataid).hide();
            }
...
<script type="text/javascript">
    $(document).off('change','.subcatopt');
    $(document).on('change','.subcatopt',function(e){
        var exp_id_val=$(this).val();
        var did=$(this).data('id');
        if(exp_id_val>0){
            $('#api_expense_id_'+did).val(did)    
        }else{
            $('#api_expense_id_'+did).val(0)    
        }
        return false;
