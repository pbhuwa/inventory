    ...
    <input type="hidden" name="save_type" value="<?php echo !empty($save_type)?$save_type:'';  ?>">
        <div class="form-group">
            ...
            <!--     <select name="rema_reqto" id="rema_reqto" class="form-control " >
                    ...
                    <select name="rema_reqto" id="rema_reqto" class="form-control required_field" >
                    <option value="">---select---</option>
                    <?php
                        if(!empty($supervisor_list)):
                            foreach ($supervisor_list as $ks => $sup):
                    ...
                    ?>
                     <option value="<?php echo $sup->usma_userid; ?>"  <?php if($supid==$sup->usma_userid) echo "selected=selected"; ?>><?php echo $sup->usma_fullname; ?></option>
                    <?php
                ...
                <table style="width:100%;" class="table dataTable dt_alt purs_table res_vert_table">
                    ...
                    <tbody id="orderBody">
                        ...
                        <tr class="orderrow" id="orderrow_<?php echo !empty($req_value->rede_reqdetailid)?$req_value->rede_reqdetailid:''; ?>" data-id='<?php echo $j; ?>'>
                            ...
                            ?>
                                <input type="hidden" name="rede_catid[]" value="<?php echo !empty($req_value->rede_catid)?$req_value->rede_catid:''; ?>">
                                <input type="hidden" name="rede_budgetheadid[]" value="<?php echo !empty($req_value->rede_budgetheadid)?$req_value->rede_budgetheadid:''; ?>">
                                <input type="hidden" name="rede_isbudgetavl[]" value="<?php echo !empty($req_value->rede_isbudgetavl)?$req_value->rede_isbudgetavl:''; ?>">
                            <?php endif; ?>

                            <td data-label="Code">
                                <div class="dis_tab"> 
                                    <input type="text" class="form-control itemcode enterinput required_field" id="itemcode_<?php echo $j; ?>" name="rede_code[]"  data-id='<?php echo $j; ?>' data-targetbtn='view' value="<?php echo !empty($req_value->itli_itemcode)?$req_value->itli_itemcode:''; ?>" readonly />
                            ...
                            <td data-label="Particular">  
                                ...
                                $req_itemname = !empty($req_value->itli_itemname)?htmlspecialchars($req_value->itli_itemname):'';
                            }?>
                            ...
                            <td data-label="Req. Quantity"> 
                                <input type="text" class="form-control float rede_qty calamt rede_qty arrow_keypress required_field" name="rede_qty[]"data-fieldid="rede_qty" id="rede_qty_<?php echo $j;?>" data-id='<?php echo $j;?>' value="<?php echo !empty($req_value->rede_qty)?$req_value->rede_qty:''; ?>"/ > 
                            </td>
                        ...
                        <tr class="orderrow" id="orderrow_1" data-id='1'>
                            ...
                            <td data-label="Code">
                                <div class="dis_tab"> 
                                    <input type="text" class="form-control itemcode enterinput required_field" id="itemcode_1" name="rede_code[]"  data-id='1' data-targetbtn='view' value="">
