    ...
    <div class="jo_form organizationInfo" id="printrpt">
     <?php  $this->load->view('common/v_report_header',$this->data); ?> 
                ...
                <th width="7%"><?php echo $this->lang->line('remaining_qty'); ?></th>
                    ...
                    if($get_date_wise):
                    foreach($get_date_wise as $key=>$gei): 
                        $date_wise=$this->test_mdl->get_issue_expenses_analysis(array('rn.sama_requisitiondatebs'=>$gei->sama_requisitiondatebs));
                     

                        if($date_wise):
                    ?>
                      <tr>
                        <td colspan="11"> <strong><?php echo $gei->sama_requisitiondatebs;  ?></strong></td>
