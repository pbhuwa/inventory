    ...
    <form id="purchase_mrn_search_form">
        <div class="form-group">
            ...
            <label for="example-text"><?php echo $this->lang->line('department'); ?>:<span class="required">*</span>:</label>
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="issue_consumption/test/department_wise_report"><?php echo $this->lang->line('search'); ?></button>
                </div>
            </div>
        </div>
    </form>
