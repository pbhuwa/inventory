...
<form method="post" id="FormIssueNew" action="<?php echo base_url('issue_consumption/handover/save_handover'); ?>" data-reloadurl="<?php echo base_url('issue_consumption/handover/form_handover');?>" class="form-material form-horizontal form">
    ...
    <div class="col-md-3 col-sm-4">
        ...
        <input type="text" class="form-control required_field" name="sama_requisitionno" placeholder="Enter Req. No." autocomplete="off" value="0" />
    </div>

    <div class="col-md-3 col-sm-4">
        <?php $sama_invoiceno=!empty($new_issue[0]->sama_invoiceno)?$new_issue[0]->sama_invoiceno:''; ?>
        <label for="example-text"><?php echo $this->lang->line('handover').' '.$this->lang->line('no') ; ?><span class="required">*</span> :</label>
        

        <input type="text" class="form-control handover_no" name="sama_invoiceno" id="issue_no" value="<?php echo !empty($sama_invoiceno)?$sama_invoiceno:$handover_no; ?>" placeholder="Enter Handover Number" >
    </div>
    ...
    <div class="col-md-3 col-sm-4">
        ...
        ?>
        <label for="example-text"><?php echo $this->lang->line('handover').' '.$this->lang->line('date'); ?> <span class="required">*</span>:</label>
        ...
        <table style="width:100%;" class="table purs_table dt_alt dataTable">
            <thead>
                <tr>
                    ...
                    <th scope="col" width="10%"> <?php echo $this->lang->line('handover_qty'); ?> </th>
