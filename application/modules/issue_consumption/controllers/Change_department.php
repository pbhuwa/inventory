...
class Change_department extends CI_Controller
{
	function __construct()
	{
		...
		parent::__construct();
		$this->load->Model('change_department_mdl');
	...
	public function index()
	{
		...
		$this->template
			...
			->build('change_department/v_change_department', $this->data);
	}
	public function save_department()
	{
		...
		try {
			...
			if($id)
			{
			$this->form_validation->set_rules($this->change_department_mdl->validate_settings_department);
			}
			else
			{
			$this->form_validation->set_rules($this->change_department_mdl->validate_settings_department);
			...
			{
		$trans = $this->change_department_mdl->department_save();
		if($trans)
		{
