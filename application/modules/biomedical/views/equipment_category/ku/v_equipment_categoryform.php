<form method="post" id="FormEquipment" action="<?php echo base_url('biomedical/equipments/save_equipment_cat'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('biomedical/equipments/equipment_cat/reload'); ?>'>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            ...
            <?php 
            $matetypeid= !empty($eqli_data[0]->eqca_mattypeid)?$eqli_data[0]->eqca_mattypeid:''; 
            // echo $eqtype;
            // die();
            ?>
             <select name="eqca_mattypeid" id="eqca_mattypeid" class="form-control required_field " >
        ...
        <div class="clearfix"></div>
         ...
         <label for="example-text"><?php echo $this->lang->line('category'); ?><span class="required">*</span>:
            ...
            <input type="text"  name="eqca_category" class="form-control required_field equdesc" placeholder="Category" value="<?php echo !empty($eqli_data[0]->eqca_category)?$eqli_data[0]->eqca_category:''; ?>" maxlength="250"  >
        </div>
