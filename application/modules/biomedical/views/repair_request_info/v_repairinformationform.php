...
<form method="post" id="FormrepairInformation" action="<?php echo base_url('biomedical/repair_information/save_repair_information'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('biomedical/repair_information/form_repair_information'); ?>'>
    ...
    <div class="form-group">
        ...
        <div class="col-md-3">
            <label for="example-text">Repairdatead Request Date:</label>
             <input type="text" name="rere_repairdatead" class="form-control" placeholder="Repairdatead Request Date" value="<?php echo !empty($repair_data[0]->rere_repairdatead)?$repair_data[0]->rere_repairdatead:''; ?>" >
        </div>
        <div class="col-md-3">
    ...
    <div class="form-group">
        <div class="col-md-3">
            <label for="example-text">Part Cost:
             ...
             <input type="text" name="rere_partcost" class="form-control" placeholder="Contact Home Phone" value="<?php echo !empty($repair_data[0]->rere_partcost)?$repair_data[0]->rere_partcost:''; ?>">
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            ...
            <input type="text" name="" class="form-control" placeholder="Rep. Email" value="<?php //echo !empty($repair_data[0]->manu_conemail)?$repair_data[0]->manu_conemail:''; ?>">
        </div>
    </div>
    <div class="form-group">
        <div class="col-md-3">
