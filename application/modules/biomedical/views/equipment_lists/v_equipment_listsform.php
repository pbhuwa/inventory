<form method="post" id="FormEquipment" action="<?php echo base_url('biomedical/equipments/save_equipment'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('biomedical/equipments/form_equipment'); ?>'>
    <input type="hidden" name="id" value="<?php echo!empty($eqli_data[0]->eqli_equipmentlistid)?$eqli_data[0]->eqli_equipmentlistid:'';  ?>">
    <div class="form-group">
         <div class="col-md-4">
            <label for="example-text"><?php echo $this->lang->line('equipment_type'); ?> <span class="required">*</span>:
            </label>
         ...
         <div class="col-md-4">
         <label for="example-text"><?php echo $this->lang->line('equipment_description'); ?> <span class="required">*</span>:
            </label>
        ...
        <div class="col-md-4">
            <label for="example-text"><?php echo $this->lang->line('equipment_code'); ?> <span class="required">*</span>:
            </label>
        ...
        <div class="col-md-4">
         <label for="example-text"><?php echo $this->lang->line('equipment_comment'); ?> :
            </label>
    ...
    <?php 
        ...
        <button type="submit" class="btn btn-info  save" data-operation='<?php echo !empty($eqli_data)?'update':'save' ?>' id="btnDeptment" ><?php echo !empty($eqli_data)?$update_var:$save_var; ?></button>
          <?php
           endif; ?>
