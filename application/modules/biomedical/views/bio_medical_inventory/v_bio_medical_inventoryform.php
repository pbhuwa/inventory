<form method="post" id="FormInventory" action="<?php echo base_url('biomedical/Bio_medical_inventory/save_biomedicalinven'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('biomedical/bio_medical_inventory/form_bio_inventory'); ?>' enctype="multipart/form-data" accept-charset="utf-8" class="resp_xs" >
  ...
  <div class="form-group resp_xs">
    <div class="col-md-4 col-sm-6 col-xs-6">
      <label for="example-text">Equip. Description <span class="required">*</span> : </label>
      ...
      <select name="bmin_descriptionid" class="form-control  equipmentdesc" autofocus="true" <?php if(!empty($equip_data)) echo 'disabled="disabled"'; ?>>
       <option value="">---select----</option>
      </select>
    </div>
    ...
    <div class="col-md-4 col-sm-6 col-xs-6">
      <label for="example-text">Model No : </label>
    ...
    <div class="col-md-4 col-sm-6 col-xs-6">
      <label for="example-text">Serial No : </label>
    ...
    <div class="col-md-4 col-sm-6 col-xs-6">
      ...
      <select name="bmin_departmentid" class="form-control " id="departmentid">
        <option value="">---select---</option>
...
<script type="text/javascript">
    ...
    {
      setTimeout(function(){
             // $(".equipmentdesc").find('option[value="' + descriptionid + '"]').attr("selected", "selected");
              $(".equipmentdesc").val(descriptionid);
         },1200);
    }
    if(roomid)
    {
