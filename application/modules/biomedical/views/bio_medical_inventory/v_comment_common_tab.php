<div class="row wb_form">
    <div class="col-sm-12">
        <div class="white-box">
        <h3 class="box-title">Equipment Assignment and Handover</h3>
             ...
             <div class="margin-bottom-30">
                ...
                <ul class="nav nav-tabs form-tabs">
                    <li class="tab-selector <?php if($tab_type=='equipment_assignment') echo 'active';?>">
                        <a href="<?php echo base_url('assign_equipement'); ?>" <?php if($tab_type=='equipment_assignment') echo' aria-expanded="true"';?>" >Equipment Comment</a>
                    </li>
                    <<li class="tab-selector <?php if($tab_type=='equipment_assign_list') echo 'active';?>">
                        <a href="<?php echo base_url('assign_equipement'); ?>" <?php if($tab_type=='equipment_assign_list') echo' aria-expanded="true"';?>" >Equipment Comment</a>
                    </li>
                    <li class="tab-selector <?php if($tab_type=='equipment_handover') echo 'active';?>">
                        <a href="<?php echo base_url('assign_equipement/handover'); ?>" <?php if($tab_type=='equipment_handover') echo' aria-expanded="true"';?>" >Equipment Comment</a>
                    </li>
