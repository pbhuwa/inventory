      ...
      <div class="col-sm-12">
        <div class="white-box pad-sides-10" id="printrpt">
          ...
          <table id="myTable" class="table table-striped dataTable tbl_pdf">
            ...
            <tbody>
              <?php
                if($biomedical_repair_request_report):
                $i=1;
                foreach ($biomedical_repair_request_report as $kb => $pmr):
               if(DEFAULT_DATEPICKER=='NP')
                {
                  $servicedate=$pmr->rere_postdatebs ;
                  $end_warrenty=$pmr->bmin_endwarrantydatebs;
                }
                else
                {
                  $servicedate=$pmr->rere_postdatead ;
              ...
              <tr>
                ...
                <td><?php echo $pmr->manu_manlst ?></td>
