    ...
    <div class="row">
      ...
      <div class="form-group mbtm_0">
        <div class="col-md-1 mtop_5">
          ...
          <div class="col-sm-6">
            <?php $uri_eqkey = !empty($this->uri->segment('4'))?$this->uri->segment('4'):'';
              $equipkey=!empty($this->input->post('equipkey'))?$this->input->post('equipkey'):$uri_eqkey; ?>
              <div class="input-group">
                <input type="text" id="id" name="equid" value="<?php echo!empty($id)?$id:$equipkey;?>" class="form-control searchText" placeholder="Enter Equipment ID" data-srchurl="<?php echo base_url(); ?>/biomedical/maintenance_log/list_of_maintenance_logs"> 
                <span class="input-group-btn">
                  <button type="button" id="searchPmdata" data-viewurl='<?php echo base_url('biomedical/maintenance_log/get_overview_report') ?>' class="btn btn-success btnEdit mtop_0" data-displaydiv='PmData'>Search</button>
                </span>
              </div>
