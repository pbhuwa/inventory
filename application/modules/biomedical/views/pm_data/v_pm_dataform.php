...
<form action="" method="post" id="PmData" class="mbtm_10">
    ...
    <div class="col-md-2 col-sm-3">
        <div>
            <button type="button" id="searchPmdata" data-viewurl='<?php echo base_url('biomedical/pm_data/get_equdata') ?>' class="btn btn-success btnEdit mtop_0" data-displaydiv='PmData'>Search</button>
        </div>
    </div>
  </div>
</form>
