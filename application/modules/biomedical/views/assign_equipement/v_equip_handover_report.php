   <form method="post" id="reportGeneration" action="" class="form-material form-horizontal form" >
      ...
      <div class="white-box">
         <h3 class="box-title">Equipment Handover Report</h3>
         <div class="pad-10">
            <div class="form-group resp_xs">
               <div class="col-sm-2 col-xs-6">
                  ...
                  <select name="rpttype" class="form-control reporttype" id="rpttype">
                     ...
                     <option value="handover_from">Handover From</option>
                    <option value="handover_to">Handover To</option>
                    <option value="handover_by">Handover By</option>
               ...
               <div class="col-sm-2 col-xs-6">
                ...
                <select class="form-control" name="date" id="date">
                  ...
                  <option value="hn_date">Handover Date</option>
...
<script type="text/javascript">
    ...
    $(document).on('change','.reporttype',function() {
        ...
        var action=base_url+'/biomedical/assign_equipement/get_handover_report_type';
    $.ajax({
    type: "POST",
    url: action,
   ...
   success: function(jsons) //we're calling the response json array 'cities'
    {
     ...
     $(document).on('click','.btnSearch',function() {
        ...
        var action=base_url+'biomedical/assign_equipement/generate_handover_report';
    $.ajax({
    type: "POST",
    url: action,
