      ...
      <div class="col-sm-12">
        <div class="white-box pad-sides-10" id="printrpt">
          <table width="100%" style="font-size:12px;">
            ...
            <tr class="title_sub">
              <td></td>
              <td style="text-align:center; font-size:15px;" ><b>Handover Report</b></td>
              <td style="text-align:right; font-size:10px;">Date/Time: <?php echo CURDATE_NP ?> BS,</td>
            </tr>
            <tr class="title_sub">
              <td></td>
              <td style="text-align:center;" style="font-size:12px;"><b id="rptType"></b></td>
            ...
            <table id="myTable" class="table table-bordered dataTable tbl_pdf">
              <thead>
                <tr>
                  ...
                  <th width="8%">Handover Date</th>
                  <th width="12%">Handover From</th>
                  <th width="12%">Handover To</th>
                  <th width="10%">Handover By</th>
              ...
              <tbody>
                ...
                <?php 
                  ...
                  {
                    $handoverdate=$bil->eqas_handoverdatebs ;  
                    $postdate=$bil->eqas_postdatebs ;     
                  }
                  else
                  {
                    $handoverdate=$bil->eqas_handoverdatead ; 
                ...
                <tr>
                  ...
                  <td><?php echo $handoverdate; ?></td>
                  <td><?php echo $bil->stin_fname.' '.$bil->stin_lname; ?></td>
                   <td><?php echo $bil->hstin_fname.' '.$bil->hstin_lname; ?></td>
                  <td><?php echo $bil->husma_username; ?></td>
