            ...
            <div class="form-group resp_xs">
               ...
               <div class="col-sm-2 col-xs-6">
                ...
                <select class="form-control" name="date" id="date">
                  ...
                  <option value="se_st_date">Service Start</option>
                  <option value="sr_end_war_date">End Warrenty</option>
                </select>
               </div>
               ...
               <div class="col-sm-2 col-xs-6">
                  <label for="">&nbsp;</label>
                  <div>
                     <button type="submit" id="" class="btn btn-info btnSearch">Search</button>
                  </div>
               </div>
                <div class="clearfix"></div>
   ...
   success: function(jsons) //we're calling the response json array 'cities'
    {
     ...
     $(document).on('click','.btnSearch',function() {
        ...
        var action=base_url+'/biomedical/reports/generate_report/<?php echo $status; ?>';
    $.ajax({
    type: "POST",
    url: action,
   ...
   success: function(jsons) //we're calling the response json array 'cities'
    ...
    $(document).off('click','.btn_pdf');
     $(document).on('click','.btn_pdf',function(){
      ...
      var redirecturl=base_url+'biomedical/reports/download_bio_medical_rpt'+'?=1';
...
<script>
    ...
    $(document).on('click','.btn_excel',function(){
        ...
        var bmin_ismaintenance =$('#bmin_ismaintenance').val();
        var status=$('#status').val();
        var redirecturl=base_url+'biomedical/reports/generate_excel_biomedical'+'?=1';
