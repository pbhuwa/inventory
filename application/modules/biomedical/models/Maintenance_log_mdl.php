...
class Maintenance_log_mdl extends CI_Model 
{
...
*/	
  ...
  public function get_all_mlog($srchcol=false)
  {
    ...
    public function get_mlog_comment($srchcol = false)
    {
        $this->db->select('ma.*,el.eqli_description');
        $this->db->from('malo_maintenancelog ma');
        $this->db->join('eqli_equipmentlist el','el.eqli_equipmentlistid=ma.malo_equipid','LEFT');
        ...
        $this->db->order_by('malo_commentdatebs,malo_posttime','DESC');
    ...
    public function delete_mlog_comment($delid = false)
    {
        try
        {
            if(empty($delid))
            ...
            $this->general->save_log('malo_maintenancelog','malo_maintenancelogid',$delid,$postdata=array(),'Delete');

            $this->db->delete('malo_maintenancelog',array('malo_maintenancelogid'=>$delid));
