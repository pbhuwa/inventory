  ...
  public function get_access_details_list($cond = false)
    {
        ...
        if(!empty($get['sSearch_1'])){
            $this->db->where("loac_logindatebs like  '%".$get['sSearch_1']."%'  ");
        }

        if(!empty($get['sSearch_2'])){
            $this->db->where("loac_logindatead like  '%".$get['sSearch_2']."%'  ");
        }
        if(!empty($get['sSearch_3'])){
            $this->db->where("loac_logintime like  '%".$get['sSearch_3']."%'  ");
        }
         if(!empty($get['sSearch_4'])){
            $this->db->where("loac_loginusername like  '%".$get['sSearch_4']."%'  ");
        }
        if(!empty($get['sSearch_5'])){
            $this->db->where("loac_loginip like  '%".$get['sSearch_5']."%'  ");
        }
          if(!empty($get['sSearch_6'])){
            $this->db->where("loac_isvalidlogin like  '%".$get['sSearch_6']."%'  ");
        }
/*
