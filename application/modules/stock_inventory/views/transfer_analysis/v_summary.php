...
<form id="ReceiveAnalysis" action="" class="form-material form-horizontal form">
 ...
 <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="stock_inventory/transfer_analysis/transfer_analysis_search"><?php echo $this->lang->line('search'); ?></button>
