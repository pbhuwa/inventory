    ...
    <div class="col-md-2 col-sm-4 col-xs-12">
      ...
      <select name="store_id" class="form-control select2" id="store_id">
        ...
        <div class="col-md-2 col-sm-4 col-xs-12">
            ...
            <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="stock_inventory/receive_analysis/receive_analysis_search"><?php echo $this->lang->line('search'); ?></button>
        </div>
