                       ...
                       <!--  <div class="self-tabs">
                            <ul class="nav nav-tabs form-tabs">
                                <li class="tab-selector <?php if($tab_type=='entry') echo 'active';?>">
                                    <a href="<?php echo base_url('stock_inventory/stock_transfer'); ?>" <?php if($tab_type=='all') echo' aria-expanded="true"';?>" ><?php echo $this->lang->line('stock_transfer'); ?></a>
                                </li>
                                <li class="tab-selector <?php if($tab_type=='list') echo 'active';?>">
                                    <a href="<?php echo base_url('stock_inventory/stock_transfer/list_stocktransfer'); ?>"><?php echo $this->lang->line('stock_transfer_list'); ?></a>
                                </li>
                                <li class="tab-selector <?php if($tab_type=='detailslist') echo 'active';?>">
                                    <a href="<?php echo base_url('stock_inventory/stock_transfer/list_stock_transfer_details'); ?>"><?php echo $this->lang->line('stock_transfer_detail'); ?></a>
                                </li>
                            </ul>
                        </div> -->
                    </div>
                    ...
                    <?php if($tab_type=='list'): ?>         
                        <div id="dtl_supplier" class="tab-pane fade in <?php if($tab_type=='list') echo "active"; ?>">
                            <div  id="FormDiv_mrnbook_supplier" class="formdiv frm_bdy">
                                <?php $this->load->view('stock_transfer/v_stock_transfer_list');?>
                            </div>
                        </div>
                    <?php endif; ?>
