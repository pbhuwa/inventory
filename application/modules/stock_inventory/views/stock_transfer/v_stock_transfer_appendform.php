                ...
                <tbody id="pendinglist">
                    <?php
                        if(!empty($pending_list)):
                            ...
                            $i=1;foreach($pending_list as $list): //echo"<pre>"; print_r($pending_list);die;
                    ...
                    ?>
                        <tr class="orderrow <?php echo $limited_stockClass .' '.  $stk_zero; ?>" id="orderrow_<?php echo $i;?>" data-id="<?php echo $i; ?>">
                            ...
                            <td data-label="Stock Qty">
                                <input type="text" class="form-control qtyinstock" id="qtyinstock_<?php echo $i;?>" name="qtyinstock[]" data-id='<?php echo $i; ?>' value="<?php echo $qty_in_stock;?>" readonly />
                            </td>
                            <td data-label="Req. Qty">
                                <input type="text" class="form-control remqty" id="remqty_<?php echo $i; ?>" name="remqty[]" data-id='<?php echo $i; ?>' value="<?php echo !empty($list->rede_remqty)?$list->rede_remqty:'';?>" readonly/>
                            </td>
                            <td data-label="Qty">
                                <input type="text" class="form-control number sade_qty" id="sade_qty_<?php echo $i; ?>" name="sade_qty[]" data-id="<?php echo $i;?>" value="<?php echo $issue_qty; ?>"/>
                            </td>
