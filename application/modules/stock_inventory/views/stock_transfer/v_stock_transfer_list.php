    ...
    <div class="">
        <form>
            ...
            <div class="col-md-2">
              ...
              <select class="form-control" name="" autofocus="true" id="equipmenttypeid">
             <?php
             if($equipmnt_type): 
        ...
        <table id="myTable" class="table table-striped">
            <thead>
                ...
                <tr>
                    ...
                    <th width="7%"><?php echo $this->lang->line('from_store'); ?></th>
                    <th width="7%"><?php echo $this->lang->line('to_store'); ?></th>
                    <th width="7%"><?php echo $this->lang->line('dispatch_by'); ?></th>
                    <th width="7%"><?php echo $this->lang->line('dispatch_date'); ?><?php echo $this->lang->line('bs'); ?></th>
                    <th width="7%"><?php echo $this->lang->line('dispatch_to'); ?></th>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        var dataurl = base_url+"stock_inventory/stock_transfer/stock_transfer_list";
        var message='';
