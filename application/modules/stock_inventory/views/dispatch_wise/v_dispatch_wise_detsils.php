...
<form id="DispatchWise" action="" class="form-material form-horizontal form">
    ...
    <div class="col-md-2 col-sm-4 col-xs-12">
      ...
      <select name="eqty_equipmenttypeid" class="form-control select2" id="store_id">
        ...
        <?php
        if($equipmenttype):
            //echo "<pre>"; print_r($equipmenttype); die;
        ...
        <div class="col-md-2 col-sm-4 col-xs-12">
             ...
             <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="stock_inventory/receive_analysis/dispatch_wise_search"><?php echo $this->lang->line('search'); ?></button>
        </div>
