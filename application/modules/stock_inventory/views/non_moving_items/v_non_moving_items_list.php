<div class="searchWrapper">
    <div class="">
        <form>
            <div class="col-md-2">
                <label><?php echo $this->lang->line('item_not_moved_since'); ?></label>
    ...
    <div class="pull-right" style="margin-top:15px;">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="stock_inventory/non_moving_items/non_moving_items_list" data-location="stock_inventory/non_moving_items/exportToExcel" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="stock_inventory/non_moving_items/non_moving_items_list" data-location="stock_inventory/non_moving_items/generate_pdf" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataurl = base_url + "stock_inventory/non_moving_items/non_moving_items_list";
        var message = '';
