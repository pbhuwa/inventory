...
<div class="searchWrapper">
	<div class="row">
<form id="issueBookSearch" action="" class="form-material form-horizontal form">
       ...
       <?php echo $this->general->location_option(2,'locationid'); ?>
		...
		<div class="col-md-2 col-sm-4 col-xs-12">
			<button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="stock_inventory/purchase_sale/purchase_search"><?php echo $this->lang->line('search'); ?></button>
		</div>
 </div>
