...
<?php echo $this->load->view('common/v_pdf_excel_header'); ?>
    ...
    <td width="185px"></td>
    <td width="185px"></td>
    <td class="text-center"><b style="font-size:15px;"> <u>Stock Verification Purchase Return  </u></b> </td>
            </table>
<table id="" class="format_pdf" width="100%">
    ...
    <tbody>
        ...
        <tr>
			...
			<td><?php echo $result->rec_qty; ?></td>
      <td align="right"><?php echo number_format($result->recrate,2); ?></td>

			<td align="right"><?php echo number_format(($result->rec_qty*$result->recrate),2); ?></td>
