...
<div class="pull-right" style="margin-top:15px;">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="stock_inventory/stock_verification" data-location="stock_inventory/stock_verification/generate_issue_ExcelDirect" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>
        
        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="stock_inventory/stock_verification" data-location="stock_inventory/stock_verification/generate_issue_pdfDirect" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
</div>
     <div class="clear"></div>
</div>
...
<div class="pad-5 mtop_10">
    <h3 class="box-title"><?php echo $this->lang->line('stock_verification').' '.$this->lang->line('issue'); ?></h3>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataurl = base_url + "stock_inventory/stock_verification/issue_search";
        var message = '';
