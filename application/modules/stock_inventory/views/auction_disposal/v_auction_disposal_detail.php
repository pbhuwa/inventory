...
<div class="searchWrapper">       
    ...
    <div class="row"> 
        <form class="col-sm-12"> 
            ...
            <div class="col-md-2">
                <a class="btn btn-info" id="searchAuctionDisposalDetail" style="margin-top: 18px;"><?php echo $this->lang->line('search'); ?></a>
            </div>
    ...
    <div class="pull-right">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="ams/assets_sales_desposal/get_detail_list" data-location="stock_inventory/auction_disposal/excel_export_detail" data-tableid="#disposalDetail"><i class="fa fa-file-excel-o"></i></a>
        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="ams/assets_sales_desposal/get_detail_list" data-location="stock_inventory/auction_disposal/pdf_export_detail" data-tableid="#disposalDetail"><i class="fa fa-print"></i></a> 
    </div>
    <div class="clear"></div> 
</div>
...
<div class="pad-5">
    ...
    <div class="table-responsive">
        ...
        <table id="disposalDetail" class="table table-striped serverDatatable keypresstable"  data-tableid="#disposalDetail">
...
$(document).ready(function(){    
    ...
    var dataurl = base_url+"stock_inventory/auction_disposal/get_detail_list";
    var message='';
    ...
    var firstTR = $('#disposalDetail tbody tr:first');
    ...
    $(document).off('click','#searchAuctionDisposalDetail')

    $(document).on('click','#searchAuctionDisposalDetail',function(){
