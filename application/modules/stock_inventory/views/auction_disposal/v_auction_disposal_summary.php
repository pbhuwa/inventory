...
<div class="searchWrapper">  
    ...
    <div class="pull-right">
        ...
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="ams/assets_sales_desposal/get_summary_list" data-location="ams/assets_sales_desposal/excel_export_summary" data-tableid="#disposalSummaryTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="ams/assets_sales_desposal/get_summary_list" data-location="ams/assets_sales_desposal/pdf_export_summary" data-tableid="#disposalSummaryTable"><i class="fa fa-print"></i></a>
...
<div class="pad-5">
    <div class="table-responsive">
        <table id="disposalSummaryTable" class="table table-striped auctionDatatable keypresstable"  data-tableid="#disposalSummaryTable">
            <thead>
                <tr>
...
$(document).ready(function(){    
    ...
    // var dataurl = base_url+"ams/assets_sales_desposal/get_summary_list";
    var dataurl = base_url+"stock_inventory/auction_disposal/get_summary_list";
    var message='';
    ...
    var tableid = $('.auctionDatatable').data('tableid');
