...
<td class="text-center"><b style="font-size:15px;"><u>Auction/Disposal Detail</u></b></td>
</tr>
</table>
   ...
   <thead>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $result->asdd_purchaseqty; ?></td>
            <td><?php echo $result->asdd_disposalqty; ?></td>
