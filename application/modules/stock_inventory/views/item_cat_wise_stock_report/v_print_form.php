...
<?php if(ORGANIZATION_NAME=='army'):
				 ?>
				 <span style="text-align: right; white-space: nowrap;">सै.क.कोष.फा.नं २७</span>
				 <?php else: ?>
				<span style="text-align: right; white-space: nowrap;">म.ले.प.फा.नं ४९</span>
			<?php endif; ?>
	...
	<tr>
		...
		<tr>
			<td class="text-center"><h4 style="margin-top: 0px;"><span class="<?php echo FONT_CLASS; ?>">जिन्सी निरिक्षण फारम</span></h4></td>
		</tr>
		<tr>
			<td></td>
		...
		<table class="jo_table itemInfo" style="width: 100%;border-collapse: collapse;border: 1px solid #333;">
			<tr>
				...
				<th colspan="3">भैातिक परिक्षण गर्दा</th>
	...
	<?php  
	            ...
	            <tr style="border-bottom: 1px solid #212121;">
	                ...
	                <td class="td_cell" style="text-overflow: ellipsis;overflow: hidden; overflow-wrap: break-word;">
	                    <?php echo round($direct->balanceqty,2); ?>
	                </td>

	                <td class="td_cell" style="text-overflow: ellipsis;overflow: hidden; overflow-wrap: break-word;">
	                    <?php echo round($direct->balanceamt,2); ?>
	                </td>
					<td class="td_cell" style="text-overflow: ellipsis;overflow: hidden; overflow-wrap: break-word;">
					</td>
					<td class="td_cell" style="text-overflow: ellipsis;overflow: hidden; overflow-wrap: break-word;">
