<form method="post" id="formitem" action="<?php echo base_url('stock_inventory/item/save_item'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('stock_inventory/item/form_item'); ?>' >
    ...
    <div class="form-group">
        ...
        <div class="col-md-6"> 
            ...
            <div class="dis_tab">
                <select name="itli_materialtypeid" id="itli_materialtypeid" class="form-control required_field " >
...
<div class="col-md-6">
   <?php $itemcodemanual=!empty($item_data[0]->itli_itemcode_manual)?$item_data[0]->itli_itemcode_manual:''; ?>
<label for="example-text">Manual Code:</label>
<input type="text" class="form-control" name="itli_itemcode_manual"  value="<?php echo $itemcodemanual; ?>">
</div>
