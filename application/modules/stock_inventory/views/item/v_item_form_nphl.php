...
<div class="col-md-6"> 
        ...
        <?php if(!empty($item_data)):?>
          ...
          if($subcategory):
            foreach ($subcategory as $km => $cat):
              ?> 
      <!-- subcategory id --> 
       <option value="<?php echo $cat->eqca_equipmentcategoryid; ?>"  <?php if($catid==$cat->eqca_equipmentcategoryid) echo "selected=selected"; ?>><?php echo $cat->eqca_category; ?></option>
              <?php 
            endforeach;
          endif;
           ?>
  ...
  <a href="javascript:void(0)" class="table-cell frm_add_btn width_30 refresh_category" data-targetid='item_catid' data-viewurl='<?php echo base_url('biomedical/equipments/equipment_reload/'); ?>' ><i class="fa fa-refresh"></i></a>
        ...
        <select name="itli_branid" class="form-control select2" id="item_branid" >
          ...
          <?php
            ...
            foreach ($brand as $km => $bran):
              ?> 
              <option value="<?php echo $bran->bran_brandid; ?>" <?php if($branid==$bran->bran_brandid) echo "selected=selected"; ?>><?php echo $bran->bran_name; ?></option>
              <?php 
            endforeach;
          endif;
           ?>
...
<label for="example-text">Quality :</label>
...
<div class="col-md-12">
  <?php
    ...
    ?>
   <button type="submit" class="btn btn-info <?php echo $saveclass; ?>" data-operation='<?php echo !empty($item_data)?'update':'save' ?>' id="btnSubmit" ><?php echo !empty($item_data)?'Update':'Save' ?></button>
