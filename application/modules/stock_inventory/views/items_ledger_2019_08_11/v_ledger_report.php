        ...
        <div class="table-wrapper" id="tblwrapper">
            <table class="table_jo_header purchaseInfo">
                <tr>
                    ...
                    <td width="30%" class="text-right"><span style="text-align: right; white-space: nowrap;">म.ले.प.फा.नं ५१</span></td>
                </tr>
                <tr>
            ...
            <tr>
                ...
                <tr>
                    <td class="text-center"><h4 style="margin-top: 0px;"><u><span class="<?php echo FONT_CLASS; ?>">खप्ने जिन्सी सामानको खाता</span></u></h4></td>
                </tr>
            </table>
            ...
            <table class="jo_table itemInfo" style="width: 100%;border-collapse: collapse;margin-top: 20px;">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php
                                if(DEFAULT_DATEPICKER == 'NP'){
                                    echo !empty($report->dates)?$report->dates:'';
                                }else{
                                    echo !empty($report->datesad)?$report->datesad:'';
                                }
                            ?>    
                        </td>
                        <td><?php echo !empty($report->refno)?$report->refno:'';?></td>
                        <td></td>
                        <td><?php echo !empty($report->Depname)?$report->Depname:'';?></td>
                        <td></td>
                        <td></td>
                        <td></td>
                        <td><?php echo !empty($report->rec_purqty)?$report->rec_purqty:0;?></td>
                        ...
                        <td><?php echo !empty($report->issueQty)?$report->issueQty:0;?></td>
                        <td style="text-align: right;"><?php echo !empty($report->issuAmt)?number_format($report->issuAmt,2):0;?></td>
                        <td><?php echo !empty($blcqty)?$blcqty:0;?></td>
                        <td style="text-align: right;"><?php echo !empty($blcamt)?number_format($blcamt,2):0;?></td>
                        <td></td>
                    </tr>
                    <?php
                            endforeach;
