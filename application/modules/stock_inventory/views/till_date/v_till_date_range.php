<div class="col-md-2 col-sm-4 col-xs-12">
	<label for="example-text">Date Range <span class="required">*</span>:</label>
	<select name="clsm_csmasterid" class="form-control select2" id="masterid" data-action="<?php echo base_url('stock_inventory/stock_check/change_data');?>">
			...
			<?php
			  ...
			  ?>
			<option value="<?php echo $eq->clsm_csmasterid.':'.$eq->clsm_todatebs; ?>"><?php echo $eq->clsm_todatebs; ?></option>
			<?php
		  	endforeach;
		  	endif; ?>
	</select>
