        ...
        <table id="" class="format_pdf" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="30%" style="text-align: center;"><?php echo $this->lang->line('category'); ?> </th>
            ...
            <tbody>
                ...
                <tr>
                    <td><?php echo $i; ?></td>
                    <td><?php echo !empty($stock->maty_material)?$stock->maty_material:'';?></td>
