    ...
    <div class="jo_form organizationInfo"  id="printrpt">
        ...
        <div class="table-wrapper" id="tblwrapper">
            ...
            <tr>
                ...
                <tr>
                    <td class="text-center"><h4 style="margin-top: 0px;"><u><span class="<?php echo FONT_CLASS; ?>">खच  भएर नजाने (खप्ने मालसामानको) जिन्सी खाता</span></u></h4></td>
                </tr>
            </table>
            ...
            <table class="jo_table itemInfo" style="width: 100%;border-collapse: collapse;margin-top: 20px;">
                <thead>
                    <tr>
                        ...
                        <th rowspan="2" style="white-space: nowrap;">दाखिला न / </th>
                        <th colspan="3" style="white-space: nowrap;">आम्दानी</th>
                        <th colspan="3" style="white-space: nowrap;">निकासा(खर्च)</th>
