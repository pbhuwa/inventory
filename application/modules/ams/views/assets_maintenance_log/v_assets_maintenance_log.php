...
<div class="searchWrapper" style="padding-left: 10px;">
  ...
  <div class="form-group">
    ...
    <div class="col-md-2 col-sm-4 col-xs-12">
      ...
      <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="ams/assets_maintenance_log/search_mlog"><?php echo $this->lang->line('search'); ?></button>
    </div>
