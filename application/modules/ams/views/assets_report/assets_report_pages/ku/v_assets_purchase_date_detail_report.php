...
<div class="white-box pad-5 mtop_10 pdf-wrapper ">
    ...
    <h5 ><strong><?=$result['purchase_date']?></strong></h5>
    <?php if(count($result['purchase_details'])):?>
    <div class="table-responsive">
        <table class="table  alt_table">
            ...
            <tbody>
                ...
                foreach($result['purchase_details'] as $kd => $det):?>
                    <tr>
                    <td><?=$kd+1?></td>
                    ...
                    <td><?=$det->eqca_category?></td>
                    <td><?=$det->cnt?></td>    
                    <td><?=number_format($det->asen_purchaserate,2)?></td>
                    <td><?php 
                    $total_price=($det->cnt)*($det->asen_purchaserate); 
