...
<div class="white-box pad-5 mtop_10 pdf-wrapper">
    ...
    <?php    
			foreach ($category_wise_data as $ki => $cwd): ?>
      	<?php
        $total_purchase_rate = 0; 

        $cond_array = array('asen_assettype'=>$cwd->asen_assettype);
        ...
        if(!empty($this->input->post('asset_condition'))){ 
          $cond_array['asen_condition'] = $this->input->post('asset_condition');
        }
        ...
        ?>
				...
				<table class="jo_tbl_head">
					<tr>
						<td>
							<strong><?php echo $cwd->eqca_category; ?></strong>
						</td>
					</tr>
				</table> 
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><?php echo $result->asen_purchasedatebs; ?></td>
      			...
      			<td><?php echo $result->stin_fname.' '. $result->stin_mname.' '.$result->stin_lname; ?></td>
