<? if(!empty($status_wise_data)) : ?>
<div class="white-box pad-5 mtop_10 pdf-wrapper">
	<div class="jo_form organizationInfo" id="printrpt">
		<?php  $this->load->view('common/v_report_header',$this->data); ?>

    <?php    
			foreach ($status_wise_data as $ki => $swd): ?>
      	<?php
        $total_purchase_rate = 0; 

        $cond_array = array('asen_status'=>$swd->asst_asstid);
        ...
        ?>
				...
				<table class="jo_tbl_head">
					<tr>
						<td>
							<strong><?php echo $swd->asst_statusname; ?></strong>
						</td>
					</tr>
				</table> 
        ...
        <tr>
            ...
            <th width="8%"><?php echo $this->lang->line('department'); ?></th> 
