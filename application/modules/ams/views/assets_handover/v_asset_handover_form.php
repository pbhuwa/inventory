<form action="" method="post" id="PmData" class="mbtm_10">
    <div class="row">
        ...
        <div class="col-md-8 col-sm-6">
            <input type="text" id="id" autocomplete="off" name="equid" value="" class="form-control searchText" placeholder="Enter Asset ID" data-srchurl="<?php echo base_url(); ?>/biomedical/bio_medical_inventory/list_of_equipment_inv">
