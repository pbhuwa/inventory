 <div class="list_c2 label_mw125">
        ...
        <form id="FormChangeStatus" action="<?php echo base_url('ams/repair_request/change_status');?>" method="POST">

            <input type="hidden" name="masterid" value="<?php echo !empty($assets_repair_request_master[0]->rerm_repairrequestmasterid)?$assets_repair_request_master[0]->rerm_repairrequestmasterid:'';  ?>">
                ...
                <div class="col-ms-12">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-3">
                        ...
                        $approved_status=$assets_repair_request_master[0]->rerm_approved;
