...
<div class="searchWrapper">
    ...
    <div class="pull-right">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="ams/assets_transfer/list_asset_transfer" data-location="ams/asset_insurance/exportToExcelDirect" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>
        ...
        <table id="myTable" class="table table-striped serverDatatable keypresstable"  data-tableid="#myTable">
            <thead>
                <tr>
                    ...
                    <th width="5">No.of Assets</th>
                    <th width="5">Repair Status</th>
...
$(document).ready(function(){    
    ...
    var dataurl = base_url+"ams/repair_request/get_repair_request_summary_list";
    var message='';
