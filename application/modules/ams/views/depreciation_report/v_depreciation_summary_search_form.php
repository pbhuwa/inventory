<div class="white-box">
  <h3 class="box-title">Depreciation Summary Report</h3>
          ...
          <div class="row">
            ...
            <div class="col-sm-2 col-xs-6">
              ...
              <div class="form-group">
                ...
                <select class="form-control" name="rpt_type" id="rpt_type">
            ...
            <div class="col-md-2">
              <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="ams/depreciation_reports/search_depreciation_summary"><?php echo $this->lang->line('search'); ?></button>
            </div>
