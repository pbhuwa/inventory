                    ...
                    <?php if ($tab_type == 'entry') : ?>
                        <div id="dtl_rpt" class="tab-pane fade in  <?php if ($tab_type == 'entry') echo "active"; ?>">
                            <div id="FormDiv_stockreqform" class="formdiv frm_bdy">
                                <?php $this->load->view('repair_work_order/v_repair_work_order_form'); ?>
                            </div>
                        </div>
                    <?php endif; ?>
                    <?php if ($tab_type == 'repair_work_order_summary') : ?>
                        <div id="dtl_rpt" class="tab-pane fade in  <?php if ($tab_type == 'repair_work_order_summary') echo "active"; ?>">
                            <div id="FormDiv_stockreqform" class="formdiv frm_bdy">
                                <?php 
                                $this->load->view('repair_work_order/v_repair_work_order_summary'); ?>
                            </div>
