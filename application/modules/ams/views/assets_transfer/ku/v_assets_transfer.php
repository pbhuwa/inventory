  ...
  <label>To School</label>
    ...
    <div class="col-md-3">
      ...
      <?php
        ...
        $astm_receivedstaffid = !empty($transfer_data_rec[0]->astm_receivedstaffid)?$transfer_data_rec[0]->astm_receivedstaffid:'';
                ...
                <table style="width:100%;" class="table dataTable dt_alt purs_table res_vert_table">
                    ...
                    <thead>
                        ...
                        <tr>
                            ...
                            <th scope="col" width="10%">Cur.Received</th>
                    ...
                    <tbody id="orderBody">
                        ...
                        <tr class="orderrow" id="orderrow_1" data-id='1'>
                            ...
                            <input type="hidden" class="form-control staffid" name="staffid[]"   id="staffid_1" data-id='1' > 
                                <input type="text" class="form-control assets_prev_staffname" name="assets_prev_staffname[]"   id="assets_prev_staffname_1" data-id='1' > 
