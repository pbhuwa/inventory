<?php
  $this->locationid = $this->session->userdata(LOCATION_ID);
    ...
    $trmaid = !empty($item_details[0]->trde_trmaid)?$item_details[0]->trde_trmaid:'';

    $supplier_billno=!empty($item_details[0]->recm_supplierbillno)?$item_details[0]->recm_supplierbillno:'';
    $recm_locationid=!empty($item_details[0]->recm_locationid)?$item_details[0]->recm_locationid:'0';
    ...
    <div class="white-box pad-5 clearfix">
         ...
         <div class="form-group white-box bg-gray pad-5 clearfix">
                ...
                <div class="col-md-3">
                        ...
                        <label>Branch</label>
                          <?php
                            ...
                            if($this->location_ismain!='Y'){
                                $loca_cond['loca_locationid']=$this->locationid;
                            }
                       
                        $locationlist = $this->general->get_tbl_data('*', 'loca_location', $loca_cond);
                        ?>
                        <select class="form-control" name="schoolid" id="locationid">
                            ...
                            ?>
                                    <option value="<?php echo $loc->loca_locationid; ?>" <?php if($recm_locationid==$loc->loca_locationid): echo "selected=selected"; endif; ?> ><?php echo $loc->loca_name; ?></option>
                                <?php
                                }
                                ?>
                            <?php
                    ...
                    <div class="col-md-3">
                        ...
                        <select  id="rema_reqfromdepid" class="form-control "> 
                        </select>
                    </div>
      ...
      <a href="javascript:void(0)" class="table-cell frm_add_btn width_30 view" data-viewurl='<?php echo base_url('biomedical/manufacturers/manufacturer_popup'); ?>' data-heading=" Manufacturer Entry" ><i class="fa fa-plus"></i></a></div>
                ...
                <div class="col-md-3">
                        ...
                        <select class="form-control required_field asen_school" name="asen_schoolid[]"data-rowid = "<?php echo $j;?>"  data-id="asen_school" id="asen_school_<?php echo $j;?>">
                            <?php if($this->location_ismain=='Y'){ ?>
                              <option value="">--Select--</option>
                            <?php } ?>
                            <?php
                   ...
                   <div class="col-md-3">
                    ...
                    <div class="">
                        ...
                        <select class="form-control required_field department_asset"  id="asen_depid_<?php echo $j;?>"  name="asen_depid[]" data-id="asen_depid" data-rowid = "<?php echo $j;?>" >
...
<?php endif; ?>
 ...
 <script type="text/javascript">
        ...
        $(document).on('change', '#locationid', function(e) {
            ...
            $('.department_asset').html('');
            $('.asen_school').val(schoolid);
            ...
            function onSuccess(jsons) {
                ...
                if (data.status == 'success') {
                    ...
                    $('.department_asset').html(data.dept_list);
                } else {
                    $('#rema_reqfromdepid').html("");
                     $('.department_asset').html("");
        ...
        $(document).off('change', '.asen_school');
        $(document).on('change', '.asen_school', function(e) {
            var schoolid = $(this).val();
            var submitdata = {
                schoolid: schoolid
            };
            ...
            function onSuccess(jsons) {
                ...
                if (data.status == 'success') {
                    ...
                    $('#asen_depid_'+row_id).html(data.dept_list);
                } else {
                    $('#asen_depid_'+row_id).html("");
                }
...
<script type="text/javascript">
 ...
 setTimeout(function() {
    $('#rema_reqfromdepid').val(depid);
    $('.department_asset').val(depid);
  }, 800);   
