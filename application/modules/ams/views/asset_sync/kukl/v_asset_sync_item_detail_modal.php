<?php
	...
	$unitprice = !empty($item_details[0]->sade_unitrate)?$item_details[0]->sade_unitrate:0;

    $unit_qty = !empty($item_details[0]->sade_curqty)?$item_details[0]->sade_curqty:0;
    ...
    $trmaid = !empty($item_details[0]->trma_trmaid)?$item_details[0]->trma_trmaid:'';

    $salemasterid=!empty($item_details[0]->sama_salemasterid)?$item_details[0]->sama_salemasterid:'';

    $saledetailid=!empty($item_details[0]->sade_saledetailid)?$item_details[0]->sade_saledetailid:'';
...
<div class="white-box">
    ...
    <div class="white-box pad-5 clearfix">
        ...
        <div id="FormDiv_PmData" class="search_pm_data">
            ...
            <ul class="pm_data pad-5 pm_data_body rowtype">
                ...
                <li class="col-sm-4">
                    ...
                    <label><?php echo $this->lang->line('issue_rate_short'); ?>: </label>
                ...
                <li class="col-sm-4">
                    ...
                    <label><?php echo $this->lang->line('issue_qty'); ?>: </label>
                ...
                <li class="col-sm-4">
                 ...
                 <li class="col-sm-4">
                    ...
                    <label><?php echo $this->lang->line('service_date'); ?>: </label>
                 ...
                 <li class="col-sm-4">
                    ...
                    <?php echo !empty($item_details[0]->dept_depname)?$item_details[0]->dept_depname:'';?>



                   <?php echo $btnviewissue='&nbsp;&nbsp;<a href="javascript:void(0)" data-id='.$item_details[0]->sama_salemasterid.' data-invoiceno='.$item_details[0]->sama_invoiceno.' data-fyear='.$item_details[0]->sama_fyear.' data-displaydiv="IssueDetails" data-viewurl='.base_url('issue_consumption/new_issue/issue_details_views').' class="view btn-primary " data-heading='.$this->lang->line('issue_details').' title=View '.$this->lang->line('issue_details').'> View Issue</a>'; ?>
        ...
        <form class="form-material" method="post" id="asset_sync" action="<?php echo base_url('ams/asset_sync/save_asset_sync'); ?>" data-reloadurl='<?php echo base_url('ams/asset_sync'); ?>' data-isredirect='true'>
                ...
                <input type="hidden" name="asen_desc" value="<?php echo $itemname; ?>" />
                ...
                <input type="hidden" name="trdeid" value="<?php echo $trdeid; ?>" />
                  ...
                  <input type="hidden" name="salemasterid" value="<?php echo $salemasterid; ?>" />

                <input type="hidden" name="saledetailid" value="<?php echo $saledetailid; ?>" />
         ...
         <div class="form-group white-box bg-gray pad-5 clearfix">
                ...
                <div class="col-md-3">
                    ...
                    <label>Depreciation Rate (%):</label>
                     ...
                     <input type="text" name="asen_deppercentage" class="form-control float" value="<?php echo !empty($item_details[0]->eqca_deprate)?$item_details[0]->eqca_deprate:'0.00'; ?>">
            ...
            ?>
        		...
        		<div class="col-md-3">
                   ...
                   <div class="">
                        ...
                        <input type="text" name="asen_assetcode[]"  class="form-control required_field" id="asen_assetcode" placeholder="" value="<?php echo $new_asset_code; ?>" >
                ...
                <div class="col-md-3">
                    ...
                    <div class="">
                        ...
                        <select class="form-control replicate_data" name="asen_brand[]" id="asen_brand_<?php echo $j;?>" data-id="asen_brand" data-rowid = "<?php echo $j;?>">
                            ...
                            <option value="<?php echo $brand->bran_brandid; ?>" <?php if($db_asen_brand==$brand->bran_brandid) echo "selected=selected"; ?>> <?php echo $brand->bran_name; ?></option>
      ...
      <a href="javascript:void(0)" class="table-cell frm_add_btn width_30 view" data-viewurl='<?php echo base_url('settings/Brand/brand_popup'); ?>' data-heading=" Brand Entry" ><i class="fa fa-plus"></i></a></div>
                   ...
                   <div class="col-md-3">
                    ...
                    <div class="">
                         ...
                         <?php $depid= !empty($item_details[0]->sama_depid)?$item_details[0]->sama_depid:'';?>
                        ...
                        <select class="form-control replicate_data"  id="asen_depid_<?php echo $j;?>"  data-id="asen_depid" data-rowid = "<?php echo $j;?>" disabled>
