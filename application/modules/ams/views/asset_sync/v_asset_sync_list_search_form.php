        ...
        <table id="myTable" class="table table-striped serverDatatable keypresstable"  data-tableid="#myTable" width="100%">
            <thead>
                <tr>
                    ...
                    <th width="7%"><?php echo $this->lang->line('synch'); ?><?php echo $this->lang->line('ad'); ?></th>
                    <th width="7%"><?php echo $this->lang->line('synch'); ?><?php echo $this->lang->line('ad'); ?></th>
                    <th width="7%"><?php echo $this->lang->line('service_date'); ?><?php echo $this->lang->line('ad'); ?></th>
                    <th width="7%"><?php echo $this->lang->line('service_date'); ?><?php echo $this->lang->line('bs'); ?></th>
...
$(document).ready(function(){
    ...
    // alert(categoryid);
    var apptype='';
    var dataurl = base_url+"ams/asset_sync/synchlist_from_asset";
    var message='';
