                    ...
                    ?>
                        <tr class="orderrow <?php echo $limited_stockClass .' '.  $stk_zero; ?>" id="orderrow_<?php echo $i;?>" data-id="<?php echo $i; ?>">
                            <td data-label="S.No.">
                                ...
                                <input type="hidden" name="rede_reqdetailid[]" class="reqdetailid" id="reqdetailid_<?php echo $i;?>" value="<?php echo !empty($list->hard_handoverdetailid)?$list->hard_handoverdetailid:'';?>" data-id="<?php echo $i; ?>" />

                                <input type="hidden" name="sade_unitrate[]" class="unitrate" id="unitrate_<?php echo $i; ?>" value="<?php echo !empty($list->itli_purchaserate)?$list->itli_purchaserate:'';?>" data-id="<?php echo $i;?>" />
