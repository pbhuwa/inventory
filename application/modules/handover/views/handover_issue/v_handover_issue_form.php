...
<form method="post" id="FormIssueNew" action="<?php echo base_url('handover/handover_issue/save_new_issue'); ?>" data-reloadurl="<?php echo base_url('handover/handover_issue/form_new_issue');?>" class="form-material form-horizontal form">
    ...
    <div id="issueDetails">
      ...
      <!--   <?php if($reqno){
        ...
        <div class="dis_tab">
            <input type="text" class="form-control reqno send_after_stop number enterinput required_field " name="sama_requisitionno" value="<?php echo $handover_no; ?>" placeholder="Enter Req No." id="req_no" data-targetbtn="SrchReq" autocomplete="off" autofocus="on">
...
<script type="text/javascript">
   ...
   function getPendingList(req_masterid, main_form=false){
    if(main_form == 'main_form'){
        ...
        var submiturl = base_url+'handover/handover_issue/load_pendinglist';
