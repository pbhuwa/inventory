...
<div class="searchWrapper">
    ...
    <div class="pull-right">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="handover/handover_req/handover_requisition_lists" data-location="handover/handover_req/exportToExcelHandoverReqlistSummary" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="handover/handover_req/handover_requisition_lists" data-location="handover/handover_req/generate_pdfHandoverReqsummarylist" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
    <div class="clear"></div>
</div>
