...
?>
<form method="post" id="FormHandoverRequisition" action="<?php echo base_url('handover/handover_req/save_handover'); ?>" class="form-material form-horizontal form" data-reloadurl="<?php echo base_url('handover/handover_req/form_handover_requisition'); ?>">
    ...
    <div class="form-group">
        <div class="col-md-3 col-sm-4">
            <?php 
            $handoverno=!empty($handover_data[0]->harm_handoverreqno)?$handover_data[0]->harm_handoverreqno:1; ?>
            <label for="example-text"><?php echo $this->lang->line('handover_req_no'); ?><span class="required">*</span>:</label>
            <input type="text" class="form-control" name="harm_handoverreqno"  value="<?php echo !empty($handoverno)?$handoverno:$handover_number[0]->id + 1; ?>" placeholder="Enter Requisition Number" readonly>
        </div>
        
        <?php echo $this->general->location_option(3,'harm_fromlocationid','harm_fromlocationid',false,'From'); ?>
        ...
        <div class="col-md-3">
            ...
            ?>
            <label for="example-text"><?php echo $this->lang->line('handover_date'); ?>: </label>
        ...
        <div class="col-md-3">
            <?php $remareqby = !empty($handover_data[0]->harm_requestedby)?$handover_data[0]->harm_requestedby:''; ?>
...
if(empty($handover_data)):
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function(){
            var deptypeid='<?php echo $harm_isdep ?>';
            if(deptypeid=='N')
            {
