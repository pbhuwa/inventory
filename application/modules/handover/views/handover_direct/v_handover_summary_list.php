...
<div class="searchWrapper">
    ...
    <div class="pull-right" style="margin-top:15px;">
        <a class="btn btn-success btn_excel generate_export_file" id="excel" data-type="excel" data-dataurl="purchase_receive/receive_against_order/receive_against_order_list" data-location="handover/handover_receive/summary_exporttoexcel" data-tableid="#myTable"><i class="fa fa-file-excel-o"></i></a>

        <a class="btn btn-info btn_pdf generate_export_file" id="print" data-type="pdf" target="_blank" data-dataurl="handover/handover_receive/sumamary_exporttopdf" data-location="purchase_receive/receive_against_order/generate_pdf" data-tableid="#myTable"><i class="fa fa-print"></i></a>
    </div>
    <div class="clear"></div>
</div>
        ...
        <table id="myTable" class="table table-striped ">
            <thead>
                <tr>
                    ...
                    <th width="15%" style="white-space: -webkit-nowrap;">Source</th>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var dataurl = base_url + "/handover/handover_receive/get_handover_summary_list";
        var message = '';
        ...
        var otherlinkdata=base_url+'handover/handover_receive/get_handover_summary_list';
