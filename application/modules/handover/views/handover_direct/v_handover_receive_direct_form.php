...
<?php 
    if(!empty($handover_master_data)){
    $redirect_url=base_url('handover/handover_receive/handover_correction');    
    }else{
        $redirect_url= base_url('handover/handover_receive/received_direct/reload');    
    }

?>

<form method="post" id="FormDirectPurchase" action="<?php echo base_url('handover/handover_receive/save_handover_received_direct'); ?>" data-reloadurl='<?php echo $redirect_url; ?>' class="form-material form-horizontal form" <?php if(!empty($handover_master_data)): ?> data-isredirect="true" <?php endif; ?> >
    <?php
    $receivedmasterid = !empty($handover_master_data[0]->hrem_handoverrecmasterid) ? $handover_master_data[0]->hrem_handoverrecmasterid : '';

    ?>
    <?php
    $trmaid = !empty($handover_detail_data[0]->trma_trmaid) ? $handover_detail_data[0]->trma_trmaid : '';

    ?>
    <input type="hidden" name="id" value="<?php echo $receivedmasterid; ?>" />
    <input type="hidden" name="trmaidid" value="<?php echo $trmaid; ?>" />
    <div id="orderData">
        <div class="form-group">
            <div class="col-md-3 col-sm-4">
                <?php
                $puorfyear = !empty($handover_master_data[0]->hrem_fyear) ? $handover_master_data[0]->hrem_fyear : '';
                ?>
                <label for="fiscalyear"><?php echo $this->lang->line('fiscal_year'); ?> <span class="required">*</span>:</label>
                <select name="hrem_fyear" class="form-control required_field" id="fiscalyear">
            ...
            <div class="col-md-3 col-sm-4">
                ...
                <?php $receivedno = !empty($handover_master_data[0]->hrem_receivedno) ? $handover_master_data[0]->hrem_receivedno : ''; ?>

                <div class="dis_tab">
                    <input type="text" class="form-control required_field enterinput" name="hrem_receivedno" value="<?php echo !empty($receivedno) ? $receivedno : $received_no; ?>" placeholder="" id="receivedno" readonly>
                </div>
            </div>

           <div class="col-md-3 col-sm-4">  
            <?php $source = !empty($handover_master_data[0]->hrem_source) ? $handover_master_data[0]->hrem_source : ''; ?>
               <label>Handover Source <span class="required">*</span></label>
               <input type="text" class="form-control required_field" name="hrem_source" value="<?php echo $source; ?>">
           </div>

            <div class="col-md-3 col-sm-4 rec">
                <label for="example-text"><?php echo $this->lang->line('received_date'); ?>: </label>
                <input type="text" name="hrem_receiveddate" class="form-control <?php echo DATEPICKER_CLASS; ?> date" placeholder="Received Date" id="received_date" value="<?php echo !empty($handover_master_data[0]->hrem_receiveddatebs) ? $handover_master_data[0]->hrem_receiveddatebs : DISPLAY_DATE; ?>">
                <span class="errmsg"></span>
            </div>

            <div class="col-md-3 col-sm-4">
                <label for="example-text">Bill No: </label>
                <input type="text" name="hrem_billno" value="<?php echo !empty($handover_master_data[0]->hrem_billno) ? $handover_master_data[0]->hrem_billno : ''; ?>" class="form-control" placeholder="Bill No">
                <span class="errmsg"></span>
            </div>
            <div class="col-md-3 col-sm-4">
                <label for="example-text">Bill Date: </label>
                <input type="text" name="hrem_billdate" class="form-control required_field <?php echo DATEPICKER_CLASS; ?> date " placeholder="Sup.Bill No" id="supplier_bill_date" value="<?php echo !empty($handover_master_data[0]->hrem_billdatebs) ? $handover_master_data[0]->hrem_billdatebs : DISPLAY_DATE; ?>" id="hrem_billdate">
                <span class="errmsg"></span>
            </div>

            <div class="col-md-3 col-sm-4">
                <label>Received By:<span class="required">*</span></label>
                <input type="text" class="form-control" name="hrem_receivedby" value="<?php echo !empty($handover_master_data[0]->hrem_receivedby) ? $handover_master_data[0]->hrem_receivedby : ''; ?>">
            </div>
    ...
    <div class="form-group">
            ...
            <table style="width:100%;" class="table purs_table dataTable">
                ...
                <tbody id="purchaseDataBody">
                    <?php if (!empty($handover_detail_data)) {
                        foreach ($handover_detail_data as $key => $pd) {
                    ?>
                            <tr class="orderrow" id="orderrow_<?php echo $key + 1; ?>" data-id='<?php echo $key + 1; ?>'>
                                <td>
                                    ...
                                    <input type="hidden" class="receiveddetailid" name="receiveddetailid[]" id="receiveddetailid_<?php echo $key + 1; ?>" value="<?php echo !empty($pd->hred_handoverrecdetailid) ? $pd->hred_handoverrecdetailid : ''; ?>" />
                                     <input type="hidden" name="trdeid[]" id="trdetailid_<?php echo $key + 1; ?>" value="<?php echo !empty($pd->trde_trdeid) ? $pd->trde_trdeid : ''; ?>" />
                                </td>
                                <td>
                                    <div class="dis_tab">
                                        ...
                                        <input type="hidden" class="qude_itemsid" name="trde_itemsid[]" data-id='<?php echo $key + 1; ?>' value="<?php echo $pd->hred_itemsid; ?>" id="itemid_<?php echo $key + 1; ?>">
                                ...
                                <td><input type="text" class="form-control float calamt arrow_keypress" name="puit_qty[]" value="<?php echo !empty($pd->hred_receivedqty) ? $pd->hred_receivedqty : '0'; ?>" data-fieldid='puit_qty' data-id='<?php echo $key + 1; ?>' id="puit_qty_<?php echo $key + 1; ?>" placeholder="Qty">
                                </td>
                                <td>
                                    <input type="text" class="form-control puit_unitprice float calamt arrow_keypress" name="puit_unitprice[]" data-fieldid="puit_unitprice" id="puit_unitprice_<?php echo $key + 1; ?>" value="<?php echo !empty($pd->hred_unitprice) ? $pd->hred_unitprice : '0'; ?>" data-id='<?php echo $key + 1; ?>' placeholder="Rate">
                                ...
                                <td>
                                    <input type="text" class="form-control float calamt eachcc arrow_keypress" name="cc[]" data-fieldid="cc" id="cc_<?php echo $key + 1; ?>" value="<?php echo !empty($pd->hred_cccharge) ? $pd->hred_cccharge : '0'; ?>" data-id='<?php echo $key + 1; ?>' placeholder="CC">
                                </td>
                                <td>
                                    <input type="text" class="form-control discount float calamt arrow_keypress " name="discount[]" data-fieldid="discount" id="discount_<?php echo $key + 1; ?>" value="<?php echo !empty($pd->hred_discountpc) ? $pd->hred_discountpc : '0'; ?>" data-id='<?php echo $key + 1; ?>' placeholder="Dis">

                                </td>
                                <td>
                                    <input type="text" class="form-control vat float calamt idfornot arrow_keypress" data-fieldid="vat" name="vat[]" id="vat_<?php echo $key + 1; ?>" value="<?php echo !empty($pd->hred_vatpc) ? $pd->hred_vatpc : '0'; ?> " data-id='<?php echo $key + 1; ?>' placeholder="Vat">

                                </td>
                                <td>
                                    <?php $subtotal = $pd->hred_amount; ?>
                                ...
                                <td>
                                    <textarea class="form-control" name="description[]" data-id='<?php echo $key + 1; ?>' placeholder="Description" id="description_<?php echo $key + 1; ?>" style="margin: 0px; width: 261px; height: 76px; line-height: 18px;"><?php echo !empty($pd->hred_description) ? $pd->hred_description : ''; ?></textarea>
                                </td>
                                <td>
                                    <div class="actionDiv acDiv2">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        ...
                        <div>
                           ...
                           <?php
                            $remarks = !empty($handover_master_data[0]->hrem_remarks) ? $handover_master_data[0]->hrem_remarks : '';
                            ?>

                            <textarea name="remarks" class="form-control" rows="4" placeholder=""><?php echo $remarks; ?></textarea>
                        </div>
                    </div>
        ...
        <fieldset class="pull-right mtop_10 pad-top-14">
            <ul>
                <li>
                    <?php
                            $sub_amount = !empty($handover_master_data[0]->hrem_amount) ? $handover_master_data[0]->hrem_amount : '';
                            ?>
                    <label><?php echo $this->lang->line('sub_total'); ?></label>
                    <input type="text" class="form-control float" name="subtotalamt" id="subtotalamt" value="<?php echo $sub_amount; ?>" />
                </li>
                <li>
                 <?php
                ...
                <label><?php echo $this->lang->line('discount'); ?></label>
                    <input type="text" class="form-control float" name="discountamt" id="discountamt" value="<?php echo $discount; ?>" />
                </li>
                <!-- readonly="true" -->

                <li>
                <?php
                $taxamt = !empty($handover_master_data[0]->hrem_taxamount) ? $handover_master_data[0]->hrem_taxamount : '0';
                ?>
                    <label><?php echo $this->lang->line('tax'); ?></label>
                    <input type="text" class="form-control float" name="taxamt" id="taxamt" value="<?php echo $taxamt; ?>" />

                </li>
                <li>
                <?php
                $clearanceamt = !empty($handover_master_data[0]->hrem_clearanceamount) ? $handover_master_data[0]->hrem_clearanceamount : '0';
                ?>
                    <label><?php echo $this->lang->line('grand_total'); ?> </label>
                    <input type="text" class="form-control float" name="totalamount" id="totalamount" value="<?php echo  $clearanceamt ?>" />
                </li>
                <?php
                $insurance = !empty($handover_master_data[0]->hrem_insurance) ? $handover_master_data[0]->hrem_insurance : '0.00';
                $carriagefreight = !empty($handover_master_data[0]->hrem_carriagefreight) ? $handover_master_data[0]->hrem_carriagefreight : '0.00';
                $packing = !empty($handover_master_data[0]->hrem_packing) ? $handover_master_data[0]->hrem_packing : '0.00';
                $transportcourier = !empty($handover_master_data[0]->hrem_transportcourier) ? $handover_master_data[0]->hrem_transportcourier : '0.00';
                $others = !empty($handover_master_data[0]->hrem_others) ? $handover_master_data[0]->hrem_others : '0.00';
                $extra = $insurance + $carriagefreight + $packing + $transportcourier + $others;

                ?>
                <li>
                    <label><?php echo $this->lang->line('extra'); ?></label>
                    <input type="text" class="form-control float extra" name="extra" id="extra" value="<?php echo $extra; ?>" />
                </li>
                <li>
                <?php
                $refund = !empty($handover_master_data[0]->hrem_refund) ? $handover_master_data[0]->hrem_refund : '0';
                ?>
                    <label><?php echo $this->lang->line('rf'); ?></label>
                    <input type="text" class="form-control float" name="rf" id="rf" value="<?php echo $refund; ?>" />
                </li>
                <li>
                    <label><?php echo $this->lang->line('clearance_amt'); ?></label>
                    <input type="text" class="form-control extra" name="clearanceamt" id="clearanceamt" value="<?php echo  $clearanceamt; ?>">
        ...
        <fieldset class="pull-right bordered">
                ...
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" class="form-control float calculateextra" name="insurance" id="insurance" value="  <?php echo $insurance; ?>" data-discount="per" />
                    </li>
                    <li>
                        <label><?php echo $this->lang->line('carriage_freight'); ?> :</label>
                        <input type="text" class="form-control float calculateextra" name="carriage" id="carriage" value="<?php echo $carriagefreight; ?>" data-discount="amt" />
                    </li>
                    <li>
                        <label><?php echo $this->lang->line('packing'); ?> :</label>
                        <input type="text" class="form-control float calculateextra" name="packing" id="packing" value="<?php echo $packing ; ?>" />
                    </li>
                    <li>
                        <label><?php echo $this->lang->line('transport_courier'); ?> :</label>
                        <input type="text" class="form-control float calculateextra" name="transportamt" id="transportamt" value="<?php echo $transportcourier; ?>" />
                    </li>
                    <li>
                        <label><?php echo $this->lang->line('other'); ?> :</label>
                        <input type="text" class="form-control float calculateextra" id="otheramt" name="otheramt" value="<?php echo $others; ?>" />
                    </li>
                </ul>
            </fieldset>
            </div>
    ...
    <div class="form-group">
        <div class="col-md-12">
            ...
            <button type="submit" class="btn btn-info  save" data-operation='<?php echo !empty($handover_master_data) ? 'update' : 'save' ?>' id="btnSubmit"><?php echo !empty($handover_master_data) ? $update_var : $save_var ?></button>
            <button type="submit" class="btn btn-info savePrint" data-operation='<?php echo !empty($handover_master_data) ? 'update' : 'save ' ?>' id="btnSubmit" data-print="print"><?php echo !empty($handover_master_data) ? $update_n_print : $save_n_print ?></button>
