...
<tr id="row_<?php echo $i; ?> receivedOrderItem_<?php echo $i;?>" class="receivedItems">
   ...
   <!--  <td>
    ...
    <td>
        ...
        <input type="hidden" class="form-control unit" name="unit[]" value="<?php echo $ord_det->pude_unit; ?>" data-id="<?php echo $i; ?>" id="unit_<?php echo $i; ?>" readonly />
    </td>
    <td>
    ...
    <td>
        <input type="text" class="form-control float calamt recqty arrow_keypress" name="received_qty[]" data-fieldid="recqty" value="0"  data-id='<?php echo $i; ?>' id="recqty_<?php echo $i; ?>">
    </td>
   <!--  <td>
    ...
    <td>
        <input type="text" class="form-control float calamt rate" name="rate[]" id="rate_<?php echo $i; ?>"   value="<?php echo $ord_det->pude_rate; ?>"  data-id='<?php echo $i; ?>'>
    ...
    <td>
        <input type="text" class="form-control float calamt discount discountpc arrow_keypress" name="discount[]" data-fieldid="discount" id="discount_<?php echo $i; ?>"  value="<?php echo $ord_det->pude_discount; ?>"  data-id='<?php echo $i; ?>'>
