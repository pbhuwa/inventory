    ...
    <div id="orderData">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-sm-3">
                ...
                <label for="example-text">Handover Issue No.<span class="required">*</span>:</label>
                <div class="dis_tab">
        ...
        <div class="form-group">
            <div class="col-md-3 col-sm-3">
                <label for="example-text">Handover <?php echo $this->lang->line('received_number'); ?>:</label>
            ...
            <div class="col-md-3 col-sm-3">
                <label for="example-text">Handover <?php echo $this->lang->line('received_date'); ?><span class="required">*</span>:</label>
            ...
            <div class="col-md-3 col-sm-3">
                <label for="example-text">Handover Received By:<span class="required">*</span>: </label>
