...
<div class="table-wrapper" id="tblwrapper">
	...
	<table class="organizationInfo" width="100%" style="font-size:12px; margin-bottom: 5px;">
		...
		<tr class="title_sub">
			...
			<td width="33.33%" style="text-align:right; font-size:12px;position: relative;top: -31px;padding: 0 0 0 28px;">
				...
				<?php echo CURDATE_NP ?> BS <?php echo $this->general->get_currenttime(); ?>
		...
		?>
			...
			<tr>
				...
				<?php if (!empty($store_type)) : ?>
					...
					<td style="text-align: left;width:20%;padding-left: 0px;     " align="left">
				...
				<?php if (!empty($materialtype)) : ?>
					...
					<td style="text-align: center;width:20%;     padding-right: 206px;" align="center">
				...
				<?php if (!empty($supplier)) : ?>
					...
					<td style="text-align: left;width:20%;font-size:14px;" align="left">
				...
				<?php if (!empty($location)) : ?>
					...
					<td style="text-align: right;width:20%;font-size:14px;" align="right">
 ...
 -->
	...
	<table class="jo_tbl_head">
		...
		if (!empty($status) || !empty($condition) || !empty($depreciation) || !empty($assettype) || !empty($datefor)) :
		...
		?>
			...
			<tr>
				...
				<?php if (!empty($status)) : ?>
					...
					<td style="text-align: center;width:20%;padding-right: 180px !important;" align="center">
				...
				<?php if (!empty($datefor)) : ?>

					<td style="text-align: center;width:20%;" align="center">

						<strong><?php echo  !empty($datefor) ? $datefor : ''; ?>: </strong>

						<strong>From: </strong>

						<?php

						echo !empty($fordate) ? $fordate : '';
