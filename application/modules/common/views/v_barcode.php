...
<div class="white-box pull-right pad-5">
	<div class="printBox" id="printrpt" style="padding:4px !important; text-align: center; max-width: 2in;max-height:1in">
		<?php         
		    Zend_Barcode::render('code128', 'image', array('text'=>$codename,'barHeight'=>42,'factor'=>4, 'drawText' => false, 'font'=>4), array());
        ...
        <div style="max-width: 1.3in; width: 70%; float:left; padding-top:5px;  ">
            ...
            <p style="font-size:9px;padding: 0px; margin: 0px; font-weight: 600;"><?php echo $new_codename; ?></p>
    ...
    <a class="btn btn-xs btn_print" id="barcodePrint" style="margin-top: 5px;"><i class="fa fa-print"></i></a>
