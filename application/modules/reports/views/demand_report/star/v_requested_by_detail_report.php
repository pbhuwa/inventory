        ...
        <table class="table  alt_table">
            ...
            <tbody>
                ...
                foreach($result['details'] as $kd => $det):?>
                    ...
                    <td>
                     <?php 
                        $schoolname=!empty($det->schoolname)?$det->schoolname:'';
                        $depparent=!empty($det->deptparent)?$det->deptparent:'';
                        if(!empty($depparent)){
                           echo $schoolname.'-'.$depparent.'/'.$det->dept_depname;    
                        }else{
                            echo !empty($det->dept_depname) ? "$schoolname-$det->dept_depname" : $schoolname;
                        }?>        
                    </td>   
                    </tr>
                    <?php
