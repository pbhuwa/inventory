...
<div class="searchWrapper">
    <form id="demand_report_search_form">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <select name="rema_reqby" id="rema_reqby" class="form-control">
                        ...
                        <?php if (!empty($requested_by)) : ?>
                            ...
                            ?>
                                ...
                                <option value="<?php echo $req->rema_reqby; ?>"><?php echo $req->rema_reqby; ?></option>
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="reports/demand_report/get_search_demand_report"><?php echo $this->lang->line('search'); ?></button>
                </div>
            </div>
        </div>
    </form>
