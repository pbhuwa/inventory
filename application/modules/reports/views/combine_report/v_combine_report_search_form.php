...
<div class="searchWrapper">
    <form id="combine_report_searchForm">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="reports/combine_report/get_search_combine_report"><?php echo $this->lang->line('search'); ?></button>
                </div>
            </div>
        </div>
    </form>
