<div class="searchWrapper">
    <form id="purchase_req_report_search_form">
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <select name="pure_requser" id="pure_requser" class="form-control">

                        <?php if (!empty($requested_by)) : ?>

                            <option value="">--All--</option>

                            <?php foreach ($requested_by as $ksd => $req) :

                            ?>

                                <option value="<?php echo $req->pure_requser; ?>"><?php echo $req->pure_requser; ?></option>
                    ...
                    <select name="subdepid" id="subdepid" class="form-control">
                        ...
                        <?php if (!empty($sub_department)) : ?>
                            ...
                            <?php foreach ($sub_department as $ksd => $sdep) : ?>
                                <option value="<?php echo $sdep->dept_depid; ?>" <?php if ($sdep->dept_depid == $subdepid) echo "selected=selected"; ?>><?php echo $sdep->dept_depname; ?>
                                </option>
                ...
                <div class="col-md-2">
                    ...
                    <select name="rpt_wise" class="form-control">
                        ...
                        <option value="requisition_date">Requisition Date</option>
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="reports/purchase_req_report/get_search_purchase_req_report"><?php echo $this->lang->line('search'); ?></button>
                </div>
            </div>
        </div>
    </form>
