...
<div class="white-box pad-5 mtop_10 pdf-wrapper ">
    ...
    <h5 ><strong><?=$result['demand_date']?></strong></h5>
    <?php if(count($result['demand_date_details'])):?>
        ...
        <table class="table  alt_table">
        	<thead>
        		<tr>
                    ...
                    <th width="4%">Issue Date(B.S)</th>
                    <th width="4%">Issue Date(A.D)</th>
        	...
        	<tbody>
        		<?php 
        		$tot_amt = $tot_qty = 0;
        		foreach($result['demand_date_details'] as $kd => $sum):
                    ?>
        			<tr>
    				<td><?=$kd+1?></td>
