...
<div class="white-box pad-5 mtop_10 pdf-wrapper ">
    ...
    <h5 ><strong><?=$result['requested_by']?></strong></h5>
    <?php if(count($result['requested_by_details'])):?>
 	<div class="table-responsive">
        <table class="table  alt_table">
        	...
        	<tbody>
        		<?php 
        		$tot_amt = $tot_qty = 0;
        		foreach($result['requested_by_details'] as $kd => $sum):
                    ?>
        			<tr>
    				<td><?=$kd+1?></td>
                    ...
                    <td><?php echo number_format($sum->sade_qty,2); ?></td>           
