...
// page_orientation: P
            ...
            <tbody>
                ...
                <tr>
                    ...
                    if(!empty($sama_receivedby)): 
                        echo $sama_receivedby;
                    ?>
                      <?php else:echo 'All';endif; ?>
                  </td>
        ...
        ?>
                ...
                <tr>
                    ...
                    <?php 
                    $mattypeid=$this->input->post('sama_mattypeid');
                    if(!empty($mattypeid)){
                    ...
                    // $recm_receivedby=$this->input->post('sama_receivedby');
