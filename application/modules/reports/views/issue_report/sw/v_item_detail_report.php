        ...
        <table class="table  alt_table">
        	...
        	<tbody>
        		...
        		foreach($result['item_details'] as $kd => $itm):
                    ...
                    <td><?php echo sprintf('%g',($itm->sade_qty)); ?></td>           
                    <td><?php echo number_format($itm->sade_unitrate,2); ?></td>
                    <td><?php echo number_format($itm->issueamt,2); ?></td>
        		...
        		<?php 
                    ...
                    $tot_qty += !empty($itm->sade_qty) ? $itm->sade_qty : 0;
                    endforeach;
                ?>
    			<tr>
