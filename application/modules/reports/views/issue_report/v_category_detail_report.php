...
<div class="white-box pad-5 mtop_10 pdf-wrapper ">
    ...
    <h5 ><strong><?=$result['category_data']?></strong></h5>
    <?php if(count($result['category_details'])):?>
        ...
        <table class="table  alt_table">
        	<thead>
        		<tr>
                    ...
                    <th width="5%">Iss.Date(B.S)</th>
                    <th width="5%">Iss.Date(A.D)</th>
        	...
        	<tbody>
        		<?php 
        		$tot_amt = $tot_qty = 0;
        		foreach($result['category_details'] as $kd => $sum):
                    ?>
        			<tr>
    				<td><?=$kd+1?></td>
