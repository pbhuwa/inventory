...
<div class="white-box pad-5 mtop_10 pdf-wrapper ">
    ...
    <h5 ><strong><?=$result['invoice_no']?></strong></h5>
    <?php if(count($result['handover_detail'])):?>
    <div class="table-responsive">
        <table class="table  alt_table">
            ...
            <tbody>
                <?php 
                $tot_amt = $tot_qty = 0;
                foreach($result['handover_detail'] as $kd => $sum):
                    ?>
                    <tr>
                    <td><?=$kd+1?></td>
                     ...
                     <td style="word-wrap: normal;">
                        <?php
                            if (!empty($sum->parent_dep)) {
                                $department =$sum->parent_dep.'/'.$sum->sama_depname;
                            }else{
                                $department =$sum->sama_depname;
                            }
