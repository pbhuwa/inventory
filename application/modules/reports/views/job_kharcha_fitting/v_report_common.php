<div class="row wb_form">
    ...
    <div class="ov_report_tabs page-tabs pad-5 margin-top-220 tabbable">
        ...
        <?php if($tab_type == 'job_kharcha_fitting'):?>
        <div id="dtl_supplier" class="tab-pane fade in <?php if($tab_type=='job_kharcha_fitting') echo "active"; ?>">
            <div  id="FormDiv_mrnbook_cancel" class="formdiv frm_bdy">
              <?php $this->load->view('job_kharcha_fitting/v_job_kharcha_fitting_form');?>
            </div>
        </div>
        <?php endif; ?>
