<div class="row wb_form">
    ...
    <div class="ov_report_tabs page-tabs pad-5 margin-top-220 tabbable">
        ...
        <?php if($tab_type == 'sales_report'):?>
        <div id="dtl_supplier" class="tab-pane fade in <?php if($tab_type=='sales_report') echo "active"; ?>">
            <div  id="FormDiv_mrnbook_cancel" class="formdiv frm_bdy">
              <?php $this->load->view('sales_report/v_sales_report_form');?>
            </div>
        </div>
        <?php endif; ?>
