    ...
    <form id="purchase_mrn_search_form">
        <div class="form-group">
            ...
            <label for="example-text"><?php echo $this->lang->line('month'); ?>:</label>
                ...
                <div class="col-md-2">
                    <button type="submit" class="btn btn-info searchReport" style="margin-top: 18px;" data-url="reports/handover_income_report/handover_income_report_details"><?php echo $this->lang->line('search'); ?></button>
                </div>
            </div>
        </div>
    </form>
