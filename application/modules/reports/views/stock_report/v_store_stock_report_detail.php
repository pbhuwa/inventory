...
<div class="white-box pad-5 mtop_10 pdf-wrapper ">
    <div class="jo_form organizationInfo" id="printrpt">
      <?php 
        $header['report_no'] = 'म.ले.प.फा.नं ४१३';
        $header['old_report_no'] = 'साबिकको फारम न. ५७';
   ...
   <?php if(!empty($stock_result)){ ?>
    ...
    <table class="table alt_table">
      <thead>
        <tr>
        <th style="text-align: center" rowspan="2" width="5%">क्र. सं.</th>
        <th style="text-align: center" rowspan="2" width="10%">जिन्सी नं</th>
        <th style="text-align: center" rowspan="2" width="8%">जिन्सी वगीर्करण संकेत नं.</th>
        <th style="text-align: center" rowspan="2" width="20%">जिन्सी सामानको नाम</th>
        <th style="text-align: center" colspan="4" width="30%">माैज्दात बाँकी</th>
        <th style="text-align: center" rowspan="2" width="10%">जिन्सी सामानको भाैतिक अवस्था</th>
        <th style="text-align: center" rowspan="2" width="10%">कैफियत</th>
      </tr>
      <tr>
        <th style="text-align: center">एकइ</th>
  ...
  <?php  
        ...
        $sum += !empty($actual_balance_amt) && $actual_balance_amt > 0 ? $actual_balance_amt : '0.0';
         ...
         <tr>
          <td colspan="10"  style="text-align: center;text-overflow: ellipsis;overflow: hidden; overflow-wrap: break-word;font-size: 12px;">
