...
<div class="white-box pad-5 mtop_10 pdf-wrapper ">
    <div class="jo_form organizationInfo" id="printrpt">
        <?php 
        $header['report_no'] = 'सै.क.काेष.फा.नं २७';
   ...
   <?php if(!empty($stock_result)){ ?>
    ...
    <table class="table  alt_table">
      <thead>
        ...
        <th style="text-align: center;" rowspan="2">खा.पा.नं.</th>
        <th style="text-align: center;" rowspan="2">जिन्सी वर्गीकरण संकेत नं</th>
        <th style="text-align: center;" rowspan="2">विवरण</th>
        <th style="text-align: center;" colspan="3">जिन्सी खाता बमोजिमको माैज्दात</th>
      ...
      <tr>
        <th style="text-align: center;">एकाइ</th>
        <th style="text-align: center;">परिमाण</th>
        <th style="text-align: center;">मुल्य</th>
        <th style="text-align: center;">मिलान भएकाे संख्या</th>
        <th style="text-align: center;">मिलान नभएकाे संख्या</th>
