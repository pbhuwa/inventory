    <div class="row">
        <div class="col-sm-4">
            <div class="white-box">
                <h3 class="box-title"><?php echo $this->lang->line('group_management'); ?></h3>
                 <div id="FormDiv" class="formdiv frm_bdy">
                <?php $this->load->view('group/v_groupform') ;?>
                </div>
            </div>
        </div>
        ...
        <div class="col-sm-8">
             <a href="javascript:void(0)" class="pull-right btn btn-sm btn-success btnRefresh"><i class="fa fa-refresh" aria-hidden="true"></i></a>
              <div class="white-box">
                <h3 class="box-title"><?php echo $this->lang->line('group_list'); ?></h3>
                <div class="table-responsive dtable_pad scroll">
                    ...
                    <div id="TableDiv">
                         <?php $this->load->view('group/v_group_list') ;?>
                    </div>
                </div>
            </div>
