<form method="post" id="FormCategorySetup" action="<?php echo base_url('faq/save_faq_category'); ?>" class="form-material form-horizontal form" data-reloadurl='<?php echo base_url('faq/faq/form_faqcategory'); ?>' >
    ...
    <div class="form-group">
        <div class="col-md-4">
            ...
            <?php $itemcatname=!empty($item_data[0]->facq_catname)?$item_data[0]->facq_catname:''; ?>
            <input type="text" name="facq_catname" class="form-control" value="<?php echo $itemcatname; ?>">
        </div>
        ...
        <div class="col-md-4">
            ...
            <?php 
                $activestatus=!empty($item_data[0]->facq_isactive)?$item_data[0]->facq_isactive:''; 
