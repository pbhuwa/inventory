...
function count_bs_days(a,b)
{
	...
	function ad2bs(a)
	{
		return days_count=this.count_ad_days(this.ad_date_eq,a),this.add_bs_days(this.bs_date_eq,days_count)}ndpAttr={},calendarVisible="",ignoreMouseUp=!1,ndpData=[],
		function(a)
		{
				...
				a("body").append(calendarDivString),a(".ndp-nepali-calendar, #ndp-nepali-box").hover(function()
					{
						...
						function()
						{
							mouse_is_inside=!1}),a("html").mouseup(function(b)
							{
