...
require_once('../../../application/config/other_constant.php');
...
$base_url =BASE_URL;    // base url (only domain) of site (without final /). If you prefer relative urls leave empty
